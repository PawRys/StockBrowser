(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const s of t.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&l(s)}).observe(document,{childList:!0,subtree:!0});function i(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerpolicy&&(t.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?t.credentials="include":e.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function l(e){if(e.ep)return;e.ep=!0;const t=i(e);fetch(e.href,t)}})();function D2(a,o){const i=Object.create(null),l=a.split(",");for(let e=0;e<l.length;e++)i[l[e]]=!0;return o?e=>!!i[e.toLowerCase()]:e=>!!i[e]}const u5="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",f5=D2(u5);function Pe(a){return!!a||a===""}function fo(a){if(V(a)){const o={};for(let i=0;i<a.length;i++){const l=a[i],e=C0(l)?h5(l):fo(l);if(e)for(const t in e)o[t]=e[t]}return o}else{if(C0(a))return a;if(j0(a))return a}}const W5=/;(?![^(]*\))/g,g5=/:(.+)/;function h5(a){const o={};return a.split(W5).forEach(i=>{if(i){const l=i.split(g5);l.length>1&&(o[l[0].trim()]=l[1].trim())}}),o}function g0(a){let o="";if(C0(a))o=a;else if(V(a))for(let i=0;i<a.length;i++){const l=g0(a[i]);l&&(o+=l+" ")}else if(j0(a))for(const i in a)a[i]&&(o+=i+" ");return o.trim()}function B5(a){if(!a)return null;let{class:o,style:i}=a;return o&&!C0(o)&&(a.class=g0(o)),i&&(a.style=fo(i)),a}function y5(a,o){if(a.length!==o.length)return!1;let i=!0;for(let l=0;i&&l<a.length;l++)i=w1(a[l],o[l]);return i}function w1(a,o){if(a===o)return!0;let i=El(a),l=El(o);if(i||l)return i&&l?a.getTime()===o.getTime():!1;if(i=so(a),l=so(o),i||l)return a===o;if(i=V(a),l=V(o),i||l)return i&&l?y5(a,o):!1;if(i=j0(a),l=j0(o),i||l){if(!i||!l)return!1;const e=Object.keys(a).length,t=Object.keys(o).length;if(e!==t)return!1;for(const s in a){const n=a.hasOwnProperty(s),S=o.hasOwnProperty(s);if(n&&!S||!n&&S||!w1(a[s],o[s]))return!1}}return String(a)===String(o)}function O2(a,o){return a.findIndex(i=>w1(i,o))}const a0=a=>C0(a)?a:a==null?"":V(a)||j0(a)&&(a.toString===be||!J(a.toString))?JSON.stringify(a,ze,2):String(a),ze=(a,o)=>o&&o.__v_isRef?ze(a,o.value):E1(o)?{[`Map(${o.size})`]:[...o.entries()].reduce((i,[l,e])=>(i[`${l} =>`]=e,i),{})}:O1(o)?{[`Set(${o.size})`]:[...o.values()]}:j0(o)&&!V(o)&&!Me(o)?String(o):o,d0={},C1=[],na=()=>{},C5=()=>!1,E5=/^on[^a-z]/,wi=a=>E5.test(a),R2=a=>a.startsWith("onUpdate:"),v0=Object.assign,T2=(a,o)=>{const i=a.indexOf(o);i>-1&&a.splice(i,1)},P5=Object.prototype.hasOwnProperty,t0=(a,o)=>P5.call(a,o),V=Array.isArray,E1=a=>Wo(a)==="[object Map]",O1=a=>Wo(a)==="[object Set]",El=a=>Wo(a)==="[object Date]",J=a=>typeof a=="function",C0=a=>typeof a=="string",so=a=>typeof a=="symbol",j0=a=>a!==null&&typeof a=="object",L2=a=>j0(a)&&J(a.then)&&J(a.catch),be=Object.prototype.toString,Wo=a=>be.call(a),z5=a=>Wo(a).slice(8,-1),Me=a=>Wo(a)==="[object Object]",A2=a=>C0(a)&&a!=="NaN"&&a[0]!=="-"&&""+parseInt(a,10)===a,Ao=D2(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),mi=a=>{const o=Object.create(null);return i=>o[i]||(o[i]=a(i))},b5=/-(\w)/g,ma=mi(a=>a.replace(b5,(o,i)=>i?i.toUpperCase():"")),M5=/\B([A-Z])/g,p1=mi(a=>a.replace(M5,"-$1").toLowerCase()),ji=mi(a=>a.charAt(0).toUpperCase()+a.slice(1)),_i=mi(a=>a?`on${ji(a)}`:""),no=(a,o)=>!Object.is(a,o),Io=(a,o)=>{for(let i=0;i<a.length;i++)a[i](o)},Jo=(a,o,i)=>{Object.defineProperty(a,o,{configurable:!0,enumerable:!1,value:i})},v1=a=>{const o=parseFloat(a);return isNaN(o)?a:o};let Pl;const v5=()=>Pl||(Pl=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let ca;class _5{constructor(o=!1){this.active=!0,this.effects=[],this.cleanups=[],!o&&ca&&(this.parent=ca,this.index=(ca.scopes||(ca.scopes=[])).push(this)-1)}run(o){if(this.active){const i=ca;try{return ca=this,o()}finally{ca=i}}}on(){ca=this}off(){ca=this.parent}stop(o){if(this.active){let i,l;for(i=0,l=this.effects.length;i<l;i++)this.effects[i].stop();for(i=0,l=this.cleanups.length;i<l;i++)this.cleanups[i]();if(this.scopes)for(i=0,l=this.scopes.length;i<l;i++)this.scopes[i].stop(!0);if(this.parent&&!o){const e=this.parent.scopes.pop();e&&e!==this&&(this.parent.scopes[this.index]=e,e.index=this.index)}this.active=!1}}}function G5(a,o=ca){o&&o.active&&o.effects.push(a)}const I2=a=>{const o=new Set(a);return o.w=0,o.n=0,o},ve=a=>(a.w&Ka)>0,_e=a=>(a.n&Ka)>0,H5=({deps:a})=>{if(a.length)for(let o=0;o<a.length;o++)a[o].w|=Ka},D5=a=>{const{deps:o}=a;if(o.length){let i=0;for(let l=0;l<o.length;l++){const e=o[l];ve(e)&&!_e(e)?e.delete(a):o[i++]=e,e.w&=~Ka,e.n&=~Ka}o.length=i}},qi=new WeakMap;let Y1=0,Ka=1;const Xi=30;let sa;const k1=Symbol(""),Yi=Symbol("");class Q2{constructor(o,i=null,l){this.fn=o,this.scheduler=i,this.active=!0,this.deps=[],this.parent=void 0,G5(this,l)}run(){if(!this.active)return this.fn();let o=sa,i=Aa;for(;o;){if(o===this)return;o=o.parent}try{return this.parent=sa,sa=this,Aa=!0,Ka=1<<++Y1,Y1<=Xi?H5(this):zl(this),this.fn()}finally{Y1<=Xi&&D5(this),Ka=1<<--Y1,sa=this.parent,Aa=i,this.parent=void 0,this.deferStop&&this.stop()}}stop(){sa===this?this.deferStop=!0:this.active&&(zl(this),this.onStop&&this.onStop(),this.active=!1)}}function zl(a){const{deps:o}=a;if(o.length){for(let i=0;i<o.length;i++)o[i].delete(a);o.length=0}}let Aa=!0;const Ge=[];function R1(){Ge.push(Aa),Aa=!1}function T1(){const a=Ge.pop();Aa=a===void 0?!0:a}function X0(a,o,i){if(Aa&&sa){let l=qi.get(a);l||qi.set(a,l=new Map);let e=l.get(i);e||l.set(i,e=I2()),He(e)}}function He(a,o){let i=!1;Y1<=Xi?_e(a)||(a.n|=Ka,i=!ve(a)):i=!a.has(sa),i&&(a.add(sa),sa.deps.push(a))}function za(a,o,i,l,e,t){const s=qi.get(a);if(!s)return;let n=[];if(o==="clear")n=[...s.values()];else if(i==="length"&&V(a))s.forEach((S,k)=>{(k==="length"||k>=l)&&n.push(S)});else switch(i!==void 0&&n.push(s.get(i)),o){case"add":V(a)?A2(i)&&n.push(s.get("length")):(n.push(s.get(k1)),E1(a)&&n.push(s.get(Yi)));break;case"delete":V(a)||(n.push(s.get(k1)),E1(a)&&n.push(s.get(Yi)));break;case"set":E1(a)&&n.push(s.get(k1));break}if(n.length===1)n[0]&&Zi(n[0]);else{const S=[];for(const k of n)k&&S.push(...k);Zi(I2(S))}}function Zi(a,o){const i=V(a)?a:[...a];for(const l of i)l.computed&&bl(l);for(const l of i)l.computed||bl(l)}function bl(a,o){(a!==sa||a.allowRecurse)&&(a.scheduler?a.scheduler():a.run())}const O5=D2("__proto__,__v_isRef,__isVue"),De=new Set(Object.getOwnPropertyNames(Symbol).filter(a=>a!=="arguments"&&a!=="caller").map(a=>Symbol[a]).filter(so)),R5=K2(),T5=K2(!1,!0),L5=K2(!0),Ml=A5();function A5(){const a={};return["includes","indexOf","lastIndexOf"].forEach(o=>{a[o]=function(...i){const l=x0(this);for(let t=0,s=this.length;t<s;t++)X0(l,"get",t+"");const e=l[o](...i);return e===-1||e===!1?l[o](...i.map(x0)):e}}),["push","pop","shift","unshift","splice"].forEach(o=>{a[o]=function(...i){R1();const l=x0(this)[o].apply(this,i);return T1(),l}}),a}function K2(a=!1,o=!1){return function(l,e,t){if(e==="__v_isReactive")return!a;if(e==="__v_isReadonly")return a;if(e==="__v_isShallow")return o;if(e==="__v_raw"&&t===(a?o?ls:Ae:o?Le:Te).get(l))return l;const s=V(l);if(!a&&s&&t0(Ml,e))return Reflect.get(Ml,e,t);const n=Reflect.get(l,e,t);return(so(e)?De.has(e):O5(e))||(a||X0(l,"get",e),o)?n:z0(n)?s&&A2(e)?n:n.value:j0(n)?a?Ie(n):go(n):n}}const I5=Oe(),Q5=Oe(!0);function Oe(a=!1){return function(i,l,e,t){let s=i[l];if(_1(s)&&z0(s)&&!z0(e))return!1;if(!a&&(!ai(e)&&!_1(e)&&(s=x0(s),e=x0(e)),!V(i)&&z0(s)&&!z0(e)))return s.value=e,!0;const n=V(i)&&A2(l)?Number(l)<i.length:t0(i,l),S=Reflect.set(i,l,e,t);return i===x0(t)&&(n?no(e,s)&&za(i,"set",l,e):za(i,"add",l,e)),S}}function K5(a,o){const i=t0(a,o);a[o];const l=Reflect.deleteProperty(a,o);return l&&i&&za(a,"delete",o,void 0),l}function $5(a,o){const i=Reflect.has(a,o);return(!so(o)||!De.has(o))&&X0(a,"has",o),i}function N5(a){return X0(a,"iterate",V(a)?"length":k1),Reflect.ownKeys(a)}const Re={get:R5,set:I5,deleteProperty:K5,has:$5,ownKeys:N5},U5={get:L5,set(a,o){return!0},deleteProperty(a,o){return!0}},V5=v0({},Re,{get:T5,set:Q5}),$2=a=>a,pi=a=>Reflect.getPrototypeOf(a);function Mo(a,o,i=!1,l=!1){a=a.__v_raw;const e=x0(a),t=x0(o);i||(o!==t&&X0(e,"get",o),X0(e,"get",t));const{has:s}=pi(e),n=l?$2:i?V2:So;if(s.call(e,o))return n(a.get(o));if(s.call(e,t))return n(a.get(t));a!==e&&a.get(o)}function vo(a,o=!1){const i=this.__v_raw,l=x0(i),e=x0(a);return o||(a!==e&&X0(l,"has",a),X0(l,"has",e)),a===e?i.has(a):i.has(a)||i.has(e)}function _o(a,o=!1){return a=a.__v_raw,!o&&X0(x0(a),"iterate",k1),Reflect.get(a,"size",a)}function vl(a){a=x0(a);const o=x0(this);return pi(o).has.call(o,a)||(o.add(a),za(o,"add",a,a)),this}function _l(a,o){o=x0(o);const i=x0(this),{has:l,get:e}=pi(i);let t=l.call(i,a);t||(a=x0(a),t=l.call(i,a));const s=e.call(i,a);return i.set(a,o),t?no(o,s)&&za(i,"set",a,o):za(i,"add",a,o),this}function Gl(a){const o=x0(this),{has:i,get:l}=pi(o);let e=i.call(o,a);e||(a=x0(a),e=i.call(o,a)),l&&l.call(o,a);const t=o.delete(a);return e&&za(o,"delete",a,void 0),t}function Hl(){const a=x0(this),o=a.size!==0,i=a.clear();return o&&za(a,"clear",void 0,void 0),i}function Go(a,o){return function(l,e){const t=this,s=t.__v_raw,n=x0(s),S=o?$2:a?V2:So;return!a&&X0(n,"iterate",k1),s.forEach((k,r)=>l.call(e,S(k),S(r),t))}}function Ho(a,o,i){return function(...l){const e=this.__v_raw,t=x0(e),s=E1(t),n=a==="entries"||a===Symbol.iterator&&s,S=a==="keys"&&s,k=e[a](...l),r=i?$2:o?V2:So;return!o&&X0(t,"iterate",S?Yi:k1),{next(){const{value:x,done:c}=k.next();return c?{value:x,done:c}:{value:n?[r(x[0]),r(x[1])]:r(x),done:c}},[Symbol.iterator](){return this}}}}function _a(a){return function(...o){return a==="delete"?!1:this}}function q5(){const a={get(t){return Mo(this,t)},get size(){return _o(this)},has:vo,add:vl,set:_l,delete:Gl,clear:Hl,forEach:Go(!1,!1)},o={get(t){return Mo(this,t,!1,!0)},get size(){return _o(this)},has:vo,add:vl,set:_l,delete:Gl,clear:Hl,forEach:Go(!1,!0)},i={get(t){return Mo(this,t,!0)},get size(){return _o(this,!0)},has(t){return vo.call(this,t,!0)},add:_a("add"),set:_a("set"),delete:_a("delete"),clear:_a("clear"),forEach:Go(!0,!1)},l={get(t){return Mo(this,t,!0,!0)},get size(){return _o(this,!0)},has(t){return vo.call(this,t,!0)},add:_a("add"),set:_a("set"),delete:_a("delete"),clear:_a("clear"),forEach:Go(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(t=>{a[t]=Ho(t,!1,!1),i[t]=Ho(t,!0,!1),o[t]=Ho(t,!1,!0),l[t]=Ho(t,!0,!0)}),[a,i,o,l]}const[X5,Y5,Z5,J5]=q5();function N2(a,o){const i=o?a?J5:Z5:a?Y5:X5;return(l,e,t)=>e==="__v_isReactive"?!a:e==="__v_isReadonly"?a:e==="__v_raw"?l:Reflect.get(t0(i,e)&&e in l?i:l,e,t)}const as={get:N2(!1,!1)},os={get:N2(!1,!0)},is={get:N2(!0,!1)},Te=new WeakMap,Le=new WeakMap,Ae=new WeakMap,ls=new WeakMap;function es(a){switch(a){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function ts(a){return a.__v_skip||!Object.isExtensible(a)?0:es(z5(a))}function go(a){return _1(a)?a:U2(a,!1,Re,as,Te)}function ss(a){return U2(a,!1,V5,os,Le)}function Ie(a){return U2(a,!0,U5,is,Ae)}function U2(a,o,i,l,e){if(!j0(a)||a.__v_raw&&!(o&&a.__v_isReactive))return a;const t=e.get(a);if(t)return t;const s=ts(a);if(s===0)return a;const n=new Proxy(a,s===2?l:i);return e.set(a,n),n}function P1(a){return _1(a)?P1(a.__v_raw):!!(a&&a.__v_isReactive)}function _1(a){return!!(a&&a.__v_isReadonly)}function ai(a){return!!(a&&a.__v_isShallow)}function Qe(a){return P1(a)||_1(a)}function x0(a){const o=a&&a.__v_raw;return o?x0(o):a}function Ke(a){return Jo(a,"__v_skip",!0),a}const So=a=>j0(a)?go(a):a,V2=a=>j0(a)?Ie(a):a;function $e(a){Aa&&sa&&(a=x0(a),He(a.dep||(a.dep=I2())))}function Ne(a,o){a=x0(a),a.dep&&Zi(a.dep)}function z0(a){return!!(a&&a.__v_isRef===!0)}function s0(a){return Ue(a,!1)}function ns(a){return Ue(a,!0)}function Ue(a,o){return z0(a)?a:new Ss(a,o)}class Ss{constructor(o,i){this.__v_isShallow=i,this.dep=void 0,this.__v_isRef=!0,this._rawValue=i?o:x0(o),this._value=i?o:So(o)}get value(){return $e(this),this._value}set value(o){const i=this.__v_isShallow||ai(o)||_1(o);o=i?o:x0(o),no(o,this._rawValue)&&(this._rawValue=o,this._value=i?o:So(o),Ne(this))}}function K(a){return z0(a)?a.value:a}const ks={get:(a,o,i)=>K(Reflect.get(a,o,i)),set:(a,o,i,l)=>{const e=a[o];return z0(e)&&!z0(i)?(e.value=i,!0):Reflect.set(a,o,i,l)}};function Ve(a){return P1(a)?a:new Proxy(a,ks)}var qe;class xs{constructor(o,i,l,e){this._setter=i,this.dep=void 0,this.__v_isRef=!0,this[qe]=!1,this._dirty=!0,this.effect=new Q2(o,()=>{this._dirty||(this._dirty=!0,Ne(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!e,this.__v_isReadonly=l}get value(){const o=x0(this);return $e(o),(o._dirty||!o._cacheable)&&(o._dirty=!1,o._value=o.effect.run()),o._value}set value(o){this._setter(o)}}qe="__v_isReadonly";function rs(a,o,i=!1){let l,e;const t=J(a);return t?(l=a,e=na):(l=a.get,e=a.set),new xs(l,e,t||!e,i)}function Ia(a,o,i,l){let e;try{e=l?a(...l):a()}catch(t){ho(t,o,i)}return e}function la(a,o,i,l){if(J(a)){const t=Ia(a,o,i,l);return t&&L2(t)&&t.catch(s=>{ho(s,o,i)}),t}const e=[];for(let t=0;t<a.length;t++)e.push(la(a[t],o,i,l));return e}function ho(a,o,i,l=!0){const e=o?o.vnode:null;if(o){let t=o.parent;const s=o.proxy,n=i;for(;t;){const k=t.ec;if(k){for(let r=0;r<k.length;r++)if(k[r](a,s,n)===!1)return}t=t.parent}const S=o.appContext.config.errorHandler;if(S){Ia(S,null,10,[a,s,n]);return}}cs(a,i,e,l)}function cs(a,o,i,l=!0){console.error(a)}let oi=!1,Ji=!1;const G0=[];let da=0;const z1=[];let Wa=null,e1=0;const Xe=Promise.resolve();let q2=null;function Fs(a){const o=q2||Xe;return a?o.then(this?a.bind(this):a):o}function ds(a){let o=da+1,i=G0.length;for(;o<i;){const l=o+i>>>1;ko(G0[l])<a?o=l+1:i=l}return o}function X2(a){(!G0.length||!G0.includes(a,oi&&a.allowRecurse?da+1:da))&&(a.id==null?G0.push(a):G0.splice(ds(a.id),0,a),Ye())}function Ye(){!oi&&!Ji&&(Ji=!0,q2=Xe.then(at))}function ws(a){const o=G0.indexOf(a);o>da&&G0.splice(o,1)}function Ze(a){V(a)?z1.push(...a):(!Wa||!Wa.includes(a,a.allowRecurse?e1+1:e1))&&z1.push(a),Ye()}function Dl(a,o=da){for(;o<G0.length;o++){const i=G0[o];i&&i.pre&&(G0.splice(o,1),o--,i())}}function Je(a){if(z1.length){const o=[...new Set(z1)];if(z1.length=0,Wa){Wa.push(...o);return}for(Wa=o,Wa.sort((i,l)=>ko(i)-ko(l)),e1=0;e1<Wa.length;e1++)Wa[e1]();Wa=null,e1=0}}const ko=a=>a.id==null?1/0:a.id,ms=(a,o)=>{const i=ko(a)-ko(o);if(i===0){if(a.pre&&!o.pre)return-1;if(o.pre&&!a.pre)return 1}return i};function at(a){Ji=!1,oi=!0,G0.sort(ms);const o=na;try{for(da=0;da<G0.length;da++){const i=G0[da];i&&i.active!==!1&&Ia(i,null,14)}}finally{da=0,G0.length=0,Je(),oi=!1,q2=null,(G0.length||z1.length)&&at()}}function js(a,o,...i){if(a.isUnmounted)return;const l=a.vnode.props||d0;let e=i;const t=o.startsWith("update:"),s=t&&o.slice(7);if(s&&s in l){const r=`${s==="modelValue"?"model":s}Modifiers`,{number:x,trim:c}=l[r]||d0;c&&(e=i.map(w=>w.trim())),x&&(e=i.map(v1))}let n,S=l[n=_i(o)]||l[n=_i(ma(o))];!S&&t&&(S=l[n=_i(p1(o))]),S&&la(S,a,6,e);const k=l[n+"Once"];if(k){if(!a.emitted)a.emitted={};else if(a.emitted[n])return;a.emitted[n]=!0,la(k,a,6,e)}}function ot(a,o,i=!1){const l=o.emitsCache,e=l.get(a);if(e!==void 0)return e;const t=a.emits;let s={},n=!1;if(!J(a)){const S=k=>{const r=ot(k,o,!0);r&&(n=!0,v0(s,r))};!i&&o.mixins.length&&o.mixins.forEach(S),a.extends&&S(a.extends),a.mixins&&a.mixins.forEach(S)}return!t&&!n?(j0(a)&&l.set(a,null),null):(V(t)?t.forEach(S=>s[S]=null):v0(s,t),j0(a)&&l.set(a,s),s)}function ui(a,o){return!a||!wi(o)?!1:(o=o.slice(2).replace(/Once$/,""),t0(a,o[0].toLowerCase()+o.slice(1))||t0(a,p1(o))||t0(a,o))}let oa=null,fi=null;function ii(a){const o=oa;return oa=a,fi=a&&a.type.__scopeId||null,o}function Z0(a){fi=a}function J0(){fi=null}function ao(a,o=oa,i){if(!o||a._n)return a;const l=(...e)=>{l._d&&ql(-1);const t=ii(o),s=a(...e);return ii(t),l._d&&ql(1),s};return l._n=!0,l._c=!0,l._d=!0,l}function Gi(a){const{type:o,vnode:i,proxy:l,withProxy:e,props:t,propsOptions:[s],slots:n,attrs:S,emit:k,render:r,renderCache:x,data:c,setupState:w,ctx:F,inheritAttrs:d}=a;let u,B;const W=ii(a);try{if(i.shapeFlag&4){const h=e||l;u=ta(r.call(h,h,x,t,w,c,F)),B=S}else{const h=o;u=ta(h.length>1?h(t,{attrs:S,slots:n,emit:k}):h(t,null)),B=o.props?S:us(S)}}catch(h){oo.length=0,ho(h,a,1),u=k0(q0)}let f=u;if(B&&d!==!1){const h=Object.keys(B),{shapeFlag:g}=f;h.length&&g&7&&(s&&h.some(R2)&&(B=fs(B,s)),f=Na(f,B))}return i.dirs&&(f=Na(f),f.dirs=f.dirs?f.dirs.concat(i.dirs):i.dirs),i.transition&&(f.transition=i.transition),u=f,ii(W),u}function ps(a){let o;for(let i=0;i<a.length;i++){const l=a[i];if(ti(l)){if(l.type!==q0||l.children==="v-if"){if(o)return;o=l}}else return}return o}const us=a=>{let o;for(const i in a)(i==="class"||i==="style"||wi(i))&&((o||(o={}))[i]=a[i]);return o},fs=(a,o)=>{const i={};for(const l in a)(!R2(l)||!(l.slice(9)in o))&&(i[l]=a[l]);return i};function Ws(a,o,i){const{props:l,children:e,component:t}=a,{props:s,children:n,patchFlag:S}=o,k=t.emitsOptions;if(o.dirs||o.transition)return!0;if(i&&S>=0){if(S&1024)return!0;if(S&16)return l?Ol(l,s,k):!!s;if(S&8){const r=o.dynamicProps;for(let x=0;x<r.length;x++){const c=r[x];if(s[c]!==l[c]&&!ui(k,c))return!0}}}else return(e||n)&&(!n||!n.$stable)?!0:l===s?!1:l?s?Ol(l,s,k):!0:!!s;return!1}function Ol(a,o,i){const l=Object.keys(o);if(l.length!==Object.keys(a).length)return!0;for(let e=0;e<l.length;e++){const t=l[e];if(o[t]!==a[t]&&!ui(i,t))return!0}return!1}function Y2({vnode:a,parent:o},i){for(;o&&o.subTree===a;)(a=o.vnode).el=i,o=o.parent}const gs=a=>a.__isSuspense,hs={name:"Suspense",__isSuspense:!0,process(a,o,i,l,e,t,s,n,S,k){a==null?Bs(o,i,l,e,t,s,n,S,k):ys(a,o,i,l,e,s,n,S,k)},hydrate:Cs,create:Z2,normalize:Es},Rl=hs;function xo(a,o){const i=a.props&&a.props[o];J(i)&&i()}function Bs(a,o,i,l,e,t,s,n,S){const{p:k,o:{createElement:r}}=S,x=r("div"),c=a.suspense=Z2(a,e,l,o,x,i,t,s,n,S);k(null,c.pendingBranch=a.ssContent,x,null,l,c,t,s),c.deps>0?(xo(a,"onPending"),xo(a,"onFallback"),k(null,a.ssFallback,o,i,l,null,t,s),b1(c,a.ssFallback)):c.resolve()}function ys(a,o,i,l,e,t,s,n,{p:S,um:k,o:{createElement:r}}){const x=o.suspense=a.suspense;x.vnode=o,o.el=a.el;const c=o.ssContent,w=o.ssFallback,{activeBranch:F,pendingBranch:d,isInFallback:u,isHydrating:B}=x;if(d)x.pendingBranch=c,wa(c,d)?(S(d,c,x.hiddenContainer,null,e,x,t,s,n),x.deps<=0?x.resolve():u&&(S(F,w,i,l,e,null,t,s,n),b1(x,w))):(x.pendingId++,B?(x.isHydrating=!1,x.activeBranch=d):k(d,e,x),x.deps=0,x.effects.length=0,x.hiddenContainer=r("div"),u?(S(null,c,x.hiddenContainer,null,e,x,t,s,n),x.deps<=0?x.resolve():(S(F,w,i,l,e,null,t,s,n),b1(x,w))):F&&wa(c,F)?(S(F,c,i,l,e,x,t,s,n),x.resolve(!0)):(S(null,c,x.hiddenContainer,null,e,x,t,s,n),x.deps<=0&&x.resolve()));else if(F&&wa(c,F))S(F,c,i,l,e,x,t,s,n),b1(x,c);else if(xo(o,"onPending"),x.pendingBranch=c,x.pendingId++,S(null,c,x.hiddenContainer,null,e,x,t,s,n),x.deps<=0)x.resolve();else{const{timeout:W,pendingId:f}=x;W>0?setTimeout(()=>{x.pendingId===f&&x.fallback(w)},W):W===0&&x.fallback(w)}}function Z2(a,o,i,l,e,t,s,n,S,k,r=!1){const{p:x,m:c,um:w,n:F,o:{parentNode:d,remove:u}}=k,B=v1(a.props&&a.props.timeout),W={vnode:a,parent:o,parentComponent:i,isSVG:s,container:l,hiddenContainer:e,anchor:t,deps:0,pendingId:0,timeout:typeof B=="number"?B:-1,activeBranch:null,pendingBranch:null,isInFallback:!0,isHydrating:r,isUnmounted:!1,effects:[],resolve(f=!1){const{vnode:h,activeBranch:g,pendingBranch:E,pendingId:O,effects:y,parentComponent:v,container:D}=W;if(W.isHydrating)W.isHydrating=!1;else if(!f){const A=g&&E.transition&&E.transition.mode==="out-in";A&&(g.transition.afterLeave=()=>{O===W.pendingId&&c(E,D,n0,0)});let{anchor:n0}=W;g&&(n0=F(g),w(g,v,W,!0)),A||c(E,D,n0,0)}b1(W,E),W.pendingBranch=null,W.isInFallback=!1;let I=W.parent,M=!1;for(;I;){if(I.pendingBranch){I.effects.push(...y),M=!0;break}I=I.parent}M||Ze(y),W.effects=[],xo(h,"onResolve")},fallback(f){if(!W.pendingBranch)return;const{vnode:h,activeBranch:g,parentComponent:E,container:O,isSVG:y}=W;xo(h,"onFallback");const v=F(g),D=()=>{!W.isInFallback||(x(null,f,O,v,E,null,y,n,S),b1(W,f))},I=f.transition&&f.transition.mode==="out-in";I&&(g.transition.afterLeave=D),W.isInFallback=!0,w(g,E,null,!0),I||D()},move(f,h,g){W.activeBranch&&c(W.activeBranch,f,h,g),W.container=f},next(){return W.activeBranch&&F(W.activeBranch)},registerDep(f,h){const g=!!W.pendingBranch;g&&W.deps++;const E=f.vnode.el;f.asyncDep.catch(O=>{ho(O,f,0)}).then(O=>{if(f.isUnmounted||W.isUnmounted||W.pendingId!==f.suspenseId)return;f.asyncResolved=!0;const{vnode:y}=f;n2(f,O,!1),E&&(y.el=E);const v=!E&&f.subTree.el;h(f,y,d(E||f.subTree.el),E?null:F(f.subTree),W,s,S),v&&u(v),Y2(f,y.el),g&&--W.deps===0&&W.resolve()})},unmount(f,h){W.isUnmounted=!0,W.activeBranch&&w(W.activeBranch,i,f,h),W.pendingBranch&&w(W.pendingBranch,i,f,h)}};return W}function Cs(a,o,i,l,e,t,s,n,S){const k=o.suspense=Z2(o,l,i,a.parentNode,document.createElement("div"),null,e,t,s,n,!0),r=S(a,k.pendingBranch=o.ssContent,i,k,t,s);return k.deps===0&&k.resolve(),r}function Es(a){const{shapeFlag:o,children:i}=a,l=o&32;a.ssContent=Tl(l?i.default:i),a.ssFallback=l?Tl(i.fallback):k0(q0)}function Tl(a){let o;if(J(a)){const i=G1&&a._c;i&&(a._d=!1,Q()),a=a(),i&&(a._d=!0,o=ia,gt())}return V(a)&&(a=ps(a)),a=ta(a),o&&!a.dynamicChildren&&(a.dynamicChildren=o.filter(i=>i!==a)),a}function Ps(a,o){o&&o.pendingBranch?V(a)?o.effects.push(...a):o.effects.push(a):Ze(a)}function b1(a,o){a.activeBranch=o;const{vnode:i,parentComponent:l}=a,e=i.el=o.el;l&&l.subTree===i&&(l.vnode.el=e,Y2(l,e))}function N0(a,o){if(P0){let i=P0.provides;const l=P0.parent&&P0.parent.provides;l===i&&(i=P0.provides=Object.create(l)),i[a]=o}}function f0(a,o,i=!1){const l=P0||oa;if(l){const e=l.parent==null?l.vnode.appContext&&l.vnode.appContext.provides:l.parent.provides;if(e&&a in e)return e[a];if(arguments.length>1)return i&&J(o)?o.call(l.proxy):o}}function J2(a,o){return al(a,null,o)}const Ll={};function x1(a,o,i){return al(a,o,i)}function al(a,o,{immediate:i,deep:l,flush:e,onTrack:t,onTrigger:s}=d0){const n=P0;let S,k=!1,r=!1;if(z0(a)?(S=()=>a.value,k=ai(a)):P1(a)?(S=()=>a,l=!0):V(a)?(r=!0,k=a.some(B=>P1(B)||ai(B)),S=()=>a.map(B=>{if(z0(B))return B.value;if(P1(B))return n1(B);if(J(B))return Ia(B,n,2)})):J(a)?o?S=()=>Ia(a,n,2):S=()=>{if(!(n&&n.isUnmounted))return x&&x(),la(a,n,3,[c])}:S=na,o&&l){const B=S;S=()=>n1(B())}let x,c=B=>{x=u.onStop=()=>{Ia(B,n,4)}};if(ro)return c=na,o?i&&la(o,n,3,[S(),r?[]:void 0,c]):S(),na;let w=r?[]:Ll;const F=()=>{if(!!u.active)if(o){const B=u.run();(l||k||(r?B.some((W,f)=>no(W,w[f])):no(B,w)))&&(x&&x(),la(o,n,3,[B,w===Ll?void 0:w,c]),w=B)}else u.run()};F.allowRecurse=!!o;let d;e==="sync"?d=F:e==="post"?d=()=>$0(F,n&&n.suspense):(F.pre=!0,n&&(F.id=n.uid),d=()=>X2(F));const u=new Q2(S,d);return o?i?F():w=u.run():e==="post"?$0(u.run.bind(u),n&&n.suspense):u.run(),()=>{u.stop(),n&&n.scope&&T2(n.scope.effects,u)}}function zs(a,o,i){const l=this.proxy,e=C0(a)?a.includes(".")?it(l,a):()=>l[a]:a.bind(l,l);let t;J(o)?t=o:(t=o.handler,i=o);const s=P0;Ua(this);const n=al(e,t.bind(l),i);return s?Ua(s):Qa(),n}function it(a,o){const i=o.split(".");return()=>{let l=a;for(let e=0;e<i.length&&l;e++)l=l[i[e]];return l}}function n1(a,o){if(!j0(a)||a.__v_skip||(o=o||new Set,o.has(a)))return a;if(o.add(a),z0(a))n1(a.value,o);else if(V(a))for(let i=0;i<a.length;i++)n1(a[i],o);else if(O1(a)||E1(a))a.forEach(i=>{n1(i,o)});else if(Me(a))for(const i in a)n1(a[i],o);return a}function bs(){const a={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return nt(()=>{a.isMounted=!0}),St(()=>{a.isUnmounting=!0}),a}const aa=[Function,Array],Ms={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:aa,onEnter:aa,onAfterEnter:aa,onEnterCancelled:aa,onBeforeLeave:aa,onLeave:aa,onAfterLeave:aa,onLeaveCancelled:aa,onBeforeAppear:aa,onAppear:aa,onAfterAppear:aa,onAppearCancelled:aa},setup(a,{slots:o}){const i=Pt(),l=bs();let e;return()=>{const t=o.default&&tt(o.default(),!0);if(!t||!t.length)return;let s=t[0];if(t.length>1){for(const d of t)if(d.type!==q0){s=d;break}}const n=x0(a),{mode:S}=n;if(l.isLeaving)return Hi(s);const k=Al(s);if(!k)return Hi(s);const r=a2(k,n,l,i);o2(k,r);const x=i.subTree,c=x&&Al(x);let w=!1;const{getTransitionKey:F}=k.type;if(F){const d=F();e===void 0?e=d:d!==e&&(e=d,w=!0)}if(c&&c.type!==q0&&(!wa(k,c)||w)){const d=a2(c,n,l,i);if(o2(c,d),S==="out-in")return l.isLeaving=!0,d.afterLeave=()=>{l.isLeaving=!1,i.update()},Hi(s);S==="in-out"&&k.type!==q0&&(d.delayLeave=(u,B,W)=>{const f=et(l,c);f[String(c.key)]=c,u._leaveCb=()=>{B(),u._leaveCb=void 0,delete r.delayedLeave},r.delayedLeave=W})}return s}}},lt=Ms;function et(a,o){const{leavingVNodes:i}=a;let l=i.get(o.type);return l||(l=Object.create(null),i.set(o.type,l)),l}function a2(a,o,i,l){const{appear:e,mode:t,persisted:s=!1,onBeforeEnter:n,onEnter:S,onAfterEnter:k,onEnterCancelled:r,onBeforeLeave:x,onLeave:c,onAfterLeave:w,onLeaveCancelled:F,onBeforeAppear:d,onAppear:u,onAfterAppear:B,onAppearCancelled:W}=o,f=String(a.key),h=et(i,a),g=(y,v)=>{y&&la(y,l,9,v)},E=(y,v)=>{const D=v[1];g(y,v),V(y)?y.every(I=>I.length<=1)&&D():y.length<=1&&D()},O={mode:t,persisted:s,beforeEnter(y){let v=n;if(!i.isMounted)if(e)v=d||n;else return;y._leaveCb&&y._leaveCb(!0);const D=h[f];D&&wa(a,D)&&D.el._leaveCb&&D.el._leaveCb(),g(v,[y])},enter(y){let v=S,D=k,I=r;if(!i.isMounted)if(e)v=u||S,D=B||k,I=W||r;else return;let M=!1;const A=y._enterCb=n0=>{M||(M=!0,n0?g(I,[y]):g(D,[y]),O.delayedLeave&&O.delayedLeave(),y._enterCb=void 0)};v?E(v,[y,A]):A()},leave(y,v){const D=String(a.key);if(y._enterCb&&y._enterCb(!0),i.isUnmounting)return v();g(x,[y]);let I=!1;const M=y._leaveCb=A=>{I||(I=!0,v(),A?g(F,[y]):g(w,[y]),y._leaveCb=void 0,h[D]===a&&delete h[D])};h[D]=a,c?E(c,[y,M]):M()},clone(y){return a2(y,o,i,l)}};return O}function Hi(a){if(Wi(a))return a=Na(a),a.children=null,a}function Al(a){return Wi(a)?a.children?a.children[0]:void 0:a}function o2(a,o){a.shapeFlag&6&&a.component?o2(a.component.subTree,o):a.shapeFlag&128?(a.ssContent.transition=o.clone(a.ssContent),a.ssFallback.transition=o.clone(a.ssFallback)):a.transition=o}function tt(a,o=!1,i){let l=[],e=0;for(let t=0;t<a.length;t++){let s=a[t];const n=i==null?s.key:String(i)+String(s.key!=null?s.key:t);s.type===w0?(s.patchFlag&128&&e++,l=l.concat(tt(s.children,o,n))):(o||s.type!==q0)&&l.push(n!=null?Na(s,{key:n}):s)}if(e>1)for(let t=0;t<l.length;t++)l[t].patchFlag=-2;return l}function vs(a){return J(a)?{setup:a,name:a.name}:a}const Qo=a=>!!a.type.__asyncLoader,Wi=a=>a.type.__isKeepAlive;function _s(a,o){st(a,"a",o)}function Gs(a,o){st(a,"da",o)}function st(a,o,i=P0){const l=a.__wdc||(a.__wdc=()=>{let e=i;for(;e;){if(e.isDeactivated)return;e=e.parent}return a()});if(gi(o,l,i),i){let e=i.parent;for(;e&&e.parent;)Wi(e.parent.vnode)&&Hs(l,o,i,e),e=e.parent}}function Hs(a,o,i,l){const e=gi(o,a,l,!0);kt(()=>{T2(l[o],e)},i)}function gi(a,o,i=P0,l=!1){if(i){const e=i[a]||(i[a]=[]),t=o.__weh||(o.__weh=(...s)=>{if(i.isUnmounted)return;R1(),Ua(i);const n=la(o,i,a,s);return Qa(),T1(),n});return l?e.unshift(t):e.push(t),t}}const va=a=>(o,i=P0)=>(!ro||a==="sp")&&gi(a,o,i),Ds=va("bm"),nt=va("m"),Os=va("bu"),Rs=va("u"),St=va("bum"),kt=va("um"),Ts=va("sp"),Ls=va("rtg"),As=va("rtc");function Is(a,o=P0){gi("ec",a,o)}function Sa(a,o){const i=oa;if(i===null)return a;const l=Bi(i)||i.proxy,e=a.dirs||(a.dirs=[]);for(let t=0;t<o.length;t++){let[s,n,S,k=d0]=o[t];J(s)&&(s={mounted:s,updated:s}),s.deep&&n1(n),e.push({dir:s,instance:l,value:n,oldValue:void 0,arg:S,modifiers:k})}return a}function Ja(a,o,i,l){const e=a.dirs,t=o&&o.dirs;for(let s=0;s<e.length;s++){const n=e[s];t&&(n.oldValue=t[s].value);let S=n.dir[l];S&&(R1(),la(S,i,8,[a.el,n,a,o]),T1())}}const xt="components",rt=Symbol();function ct(a){return C0(a)?Qs(xt,a,!1)||a:a||rt}function Qs(a,o,i=!0,l=!1){const e=oa||P0;if(e){const t=e.type;if(a===xt){const n=mn(t,!1);if(n&&(n===o||n===ma(o)||n===ji(ma(o))))return t}const s=Il(e[a]||t[a],o)||Il(e.appContext[a],o);return!s&&l?t:s}}function Il(a,o){return a&&(a[o]||a[ma(o)]||a[ji(ma(o))])}function $a(a,o,i,l){let e;const t=i&&i[l];if(V(a)||C0(a)){e=new Array(a.length);for(let s=0,n=a.length;s<n;s++)e[s]=o(a[s],s,void 0,t&&t[s])}else if(typeof a=="number"){e=new Array(a);for(let s=0;s<a;s++)e[s]=o(s+1,s,void 0,t&&t[s])}else if(j0(a))if(a[Symbol.iterator])e=Array.from(a,(s,n)=>o(s,n,void 0,t&&t[n]));else{const s=Object.keys(a);e=new Array(s.length);for(let n=0,S=s.length;n<S;n++){const k=s[n];e[n]=o(a[k],k,n,t&&t[n])}}else e=[];return i&&(i[l]=e),e}const i2=a=>a?zt(a)?Bi(a)||a.proxy:i2(a.parent):null,li=v0(Object.create(null),{$:a=>a,$el:a=>a.vnode.el,$data:a=>a.data,$props:a=>a.props,$attrs:a=>a.attrs,$slots:a=>a.slots,$refs:a=>a.refs,$parent:a=>i2(a.parent),$root:a=>i2(a.root),$emit:a=>a.emit,$options:a=>dt(a),$forceUpdate:a=>a.f||(a.f=()=>X2(a.update)),$nextTick:a=>a.n||(a.n=Fs.bind(a.proxy)),$watch:a=>zs.bind(a)}),Ks={get({_:a},o){const{ctx:i,setupState:l,data:e,props:t,accessCache:s,type:n,appContext:S}=a;let k;if(o[0]!=="$"){const w=s[o];if(w!==void 0)switch(w){case 1:return l[o];case 2:return e[o];case 4:return i[o];case 3:return t[o]}else{if(l!==d0&&t0(l,o))return s[o]=1,l[o];if(e!==d0&&t0(e,o))return s[o]=2,e[o];if((k=a.propsOptions[0])&&t0(k,o))return s[o]=3,t[o];if(i!==d0&&t0(i,o))return s[o]=4,i[o];l2&&(s[o]=0)}}const r=li[o];let x,c;if(r)return o==="$attrs"&&X0(a,"get",o),r(a);if((x=n.__cssModules)&&(x=x[o]))return x;if(i!==d0&&t0(i,o))return s[o]=4,i[o];if(c=S.config.globalProperties,t0(c,o))return c[o]},set({_:a},o,i){const{data:l,setupState:e,ctx:t}=a;return e!==d0&&t0(e,o)?(e[o]=i,!0):l!==d0&&t0(l,o)?(l[o]=i,!0):t0(a.props,o)||o[0]==="$"&&o.slice(1)in a?!1:(t[o]=i,!0)},has({_:{data:a,setupState:o,accessCache:i,ctx:l,appContext:e,propsOptions:t}},s){let n;return!!i[s]||a!==d0&&t0(a,s)||o!==d0&&t0(o,s)||(n=t[0])&&t0(n,s)||t0(l,s)||t0(li,s)||t0(e.config.globalProperties,s)},defineProperty(a,o,i){return i.get!=null?a._.accessCache[o]=0:t0(i,"value")&&this.set(a,o,i.value,null),Reflect.defineProperty(a,o,i)}};let l2=!0;function $s(a){const o=dt(a),i=a.proxy,l=a.ctx;l2=!1,o.beforeCreate&&Ql(o.beforeCreate,a,"bc");const{data:e,computed:t,methods:s,watch:n,provide:S,inject:k,created:r,beforeMount:x,mounted:c,beforeUpdate:w,updated:F,activated:d,deactivated:u,beforeDestroy:B,beforeUnmount:W,destroyed:f,unmounted:h,render:g,renderTracked:E,renderTriggered:O,errorCaptured:y,serverPrefetch:v,expose:D,inheritAttrs:I,components:M,directives:A,filters:n0}=o;if(k&&Ns(k,l,null,a.appContext.config.unwrapInjectedRef),s)for(const l0 in s){const e0=s[l0];J(e0)&&(l[l0]=e0.bind(i))}if(e){const l0=e.call(i,i);j0(l0)&&(a.data=go(l0))}if(l2=!0,t)for(const l0 in t){const e0=t[l0],h0=J(e0)?e0.bind(i,i):J(e0.get)?e0.get.bind(i,i):na,_0=!J(e0)&&J(e0.set)?e0.set.bind(i):na,I0=H0({get:h0,set:_0});Object.defineProperty(l,l0,{enumerable:!0,configurable:!0,get:()=>I0.value,set:b0=>I0.value=b0})}if(n)for(const l0 in n)Ft(n[l0],l,i,l0);if(S){const l0=J(S)?S.call(i):S;Reflect.ownKeys(l0).forEach(e0=>{N0(e0,l0[e0])})}r&&Ql(r,a,"c");function r0(l0,e0){V(e0)?e0.forEach(h0=>l0(h0.bind(i))):e0&&l0(e0.bind(i))}if(r0(Ds,x),r0(nt,c),r0(Os,w),r0(Rs,F),r0(_s,d),r0(Gs,u),r0(Is,y),r0(As,E),r0(Ls,O),r0(St,W),r0(kt,h),r0(Ts,v),V(D))if(D.length){const l0=a.exposed||(a.exposed={});D.forEach(e0=>{Object.defineProperty(l0,e0,{get:()=>i[e0],set:h0=>i[e0]=h0})})}else a.exposed||(a.exposed={});g&&a.render===na&&(a.render=g),I!=null&&(a.inheritAttrs=I),M&&(a.components=M),A&&(a.directives=A)}function Ns(a,o,i=na,l=!1){V(a)&&(a=e2(a));for(const e in a){const t=a[e];let s;j0(t)?"default"in t?s=f0(t.from||e,t.default,!0):s=f0(t.from||e):s=f0(t),z0(s)&&l?Object.defineProperty(o,e,{enumerable:!0,configurable:!0,get:()=>s.value,set:n=>s.value=n}):o[e]=s}}function Ql(a,o,i){la(V(a)?a.map(l=>l.bind(o.proxy)):a.bind(o.proxy),o,i)}function Ft(a,o,i,l){const e=l.includes(".")?it(i,l):()=>i[l];if(C0(a)){const t=o[a];J(t)&&x1(e,t)}else if(J(a))x1(e,a.bind(i));else if(j0(a))if(V(a))a.forEach(t=>Ft(t,o,i,l));else{const t=J(a.handler)?a.handler.bind(i):o[a.handler];J(t)&&x1(e,t,a)}}function dt(a){const o=a.type,{mixins:i,extends:l}=o,{mixins:e,optionsCache:t,config:{optionMergeStrategies:s}}=a.appContext,n=t.get(o);let S;return n?S=n:!e.length&&!i&&!l?S=o:(S={},e.length&&e.forEach(k=>ei(S,k,s,!0)),ei(S,o,s)),j0(o)&&t.set(o,S),S}function ei(a,o,i,l=!1){const{mixins:e,extends:t}=o;t&&ei(a,t,i,!0),e&&e.forEach(s=>ei(a,s,i,!0));for(const s in o)if(!(l&&s==="expose")){const n=Us[s]||i&&i[s];a[s]=n?n(a[s],o[s]):o[s]}return a}const Us={data:Kl,props:l1,emits:l1,methods:l1,computed:l1,beforeCreate:T0,created:T0,beforeMount:T0,mounted:T0,beforeUpdate:T0,updated:T0,beforeDestroy:T0,beforeUnmount:T0,destroyed:T0,unmounted:T0,activated:T0,deactivated:T0,errorCaptured:T0,serverPrefetch:T0,components:l1,directives:l1,watch:qs,provide:Kl,inject:Vs};function Kl(a,o){return o?a?function(){return v0(J(a)?a.call(this,this):a,J(o)?o.call(this,this):o)}:o:a}function Vs(a,o){return l1(e2(a),e2(o))}function e2(a){if(V(a)){const o={};for(let i=0;i<a.length;i++)o[a[i]]=a[i];return o}return a}function T0(a,o){return a?[...new Set([].concat(a,o))]:o}function l1(a,o){return a?v0(v0(Object.create(null),a),o):o}function qs(a,o){if(!a)return o;if(!o)return a;const i=v0(Object.create(null),a);for(const l in o)i[l]=T0(a[l],o[l]);return i}function Xs(a,o,i,l=!1){const e={},t={};Jo(t,hi,1),a.propsDefaults=Object.create(null),wt(a,o,e,t);for(const s in a.propsOptions[0])s in e||(e[s]=void 0);i?a.props=l?e:ss(e):a.type.props?a.props=e:a.props=t,a.attrs=t}function Ys(a,o,i,l){const{props:e,attrs:t,vnode:{patchFlag:s}}=a,n=x0(e),[S]=a.propsOptions;let k=!1;if((l||s>0)&&!(s&16)){if(s&8){const r=a.vnode.dynamicProps;for(let x=0;x<r.length;x++){let c=r[x];if(ui(a.emitsOptions,c))continue;const w=o[c];if(S)if(t0(t,c))w!==t[c]&&(t[c]=w,k=!0);else{const F=ma(c);e[F]=t2(S,n,F,w,a,!1)}else w!==t[c]&&(t[c]=w,k=!0)}}}else{wt(a,o,e,t)&&(k=!0);let r;for(const x in n)(!o||!t0(o,x)&&((r=p1(x))===x||!t0(o,r)))&&(S?i&&(i[x]!==void 0||i[r]!==void 0)&&(e[x]=t2(S,n,x,void 0,a,!0)):delete e[x]);if(t!==n)for(const x in t)(!o||!t0(o,x)&&!0)&&(delete t[x],k=!0)}k&&za(a,"set","$attrs")}function wt(a,o,i,l){const[e,t]=a.propsOptions;let s=!1,n;if(o)for(let S in o){if(Ao(S))continue;const k=o[S];let r;e&&t0(e,r=ma(S))?!t||!t.includes(r)?i[r]=k:(n||(n={}))[r]=k:ui(a.emitsOptions,S)||(!(S in l)||k!==l[S])&&(l[S]=k,s=!0)}if(t){const S=x0(i),k=n||d0;for(let r=0;r<t.length;r++){const x=t[r];i[x]=t2(e,S,x,k[x],a,!t0(k,x))}}return s}function t2(a,o,i,l,e,t){const s=a[i];if(s!=null){const n=t0(s,"default");if(n&&l===void 0){const S=s.default;if(s.type!==Function&&J(S)){const{propsDefaults:k}=e;i in k?l=k[i]:(Ua(e),l=k[i]=S.call(null,o),Qa())}else l=S}s[0]&&(t&&!n?l=!1:s[1]&&(l===""||l===p1(i))&&(l=!0))}return l}function mt(a,o,i=!1){const l=o.propsCache,e=l.get(a);if(e)return e;const t=a.props,s={},n=[];let S=!1;if(!J(a)){const r=x=>{S=!0;const[c,w]=mt(x,o,!0);v0(s,c),w&&n.push(...w)};!i&&o.mixins.length&&o.mixins.forEach(r),a.extends&&r(a.extends),a.mixins&&a.mixins.forEach(r)}if(!t&&!S)return j0(a)&&l.set(a,C1),C1;if(V(t))for(let r=0;r<t.length;r++){const x=ma(t[r]);$l(x)&&(s[x]=d0)}else if(t)for(const r in t){const x=ma(r);if($l(x)){const c=t[r],w=s[x]=V(c)||J(c)?{type:c}:c;if(w){const F=Vl(Boolean,w.type),d=Vl(String,w.type);w[0]=F>-1,w[1]=d<0||F<d,(F>-1||t0(w,"default"))&&n.push(x)}}}const k=[s,n];return j0(a)&&l.set(a,k),k}function $l(a){return a[0]!=="$"}function Nl(a){const o=a&&a.toString().match(/^\s*function (\w+)/);return o?o[1]:a===null?"null":""}function Ul(a,o){return Nl(a)===Nl(o)}function Vl(a,o){return V(o)?o.findIndex(i=>Ul(i,a)):J(o)&&Ul(o,a)?0:-1}const jt=a=>a[0]==="_"||a==="$stable",ol=a=>V(a)?a.map(ta):[ta(a)],Zs=(a,o,i)=>{if(o._n)return o;const l=ao((...e)=>ol(o(...e)),i);return l._c=!1,l},pt=(a,o,i)=>{const l=a._ctx;for(const e in a){if(jt(e))continue;const t=a[e];if(J(t))o[e]=Zs(e,t,l);else if(t!=null){const s=ol(t);o[e]=()=>s}}},ut=(a,o)=>{const i=ol(o);a.slots.default=()=>i},Js=(a,o)=>{if(a.vnode.shapeFlag&32){const i=o._;i?(a.slots=x0(o),Jo(o,"_",i)):pt(o,a.slots={})}else a.slots={},o&&ut(a,o);Jo(a.slots,hi,1)},an=(a,o,i)=>{const{vnode:l,slots:e}=a;let t=!0,s=d0;if(l.shapeFlag&32){const n=o._;n?i&&n===1?t=!1:(v0(e,o),!i&&n===1&&delete e._):(t=!o.$stable,pt(o,e)),s=o}else o&&(ut(a,o),s={default:1});if(t)for(const n in e)!jt(n)&&!(n in s)&&delete e[n]};function ft(){return{app:null,config:{isNativeTag:C5,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let on=0;function ln(a,o){return function(l,e=null){J(l)||(l=Object.assign({},l)),e!=null&&!j0(e)&&(e=null);const t=ft(),s=new Set;let n=!1;const S=t.app={_uid:on++,_component:l,_props:e,_container:null,_context:t,_instance:null,version:un,get config(){return t.config},set config(k){},use(k,...r){return s.has(k)||(k&&J(k.install)?(s.add(k),k.install(S,...r)):J(k)&&(s.add(k),k(S,...r))),S},mixin(k){return t.mixins.includes(k)||t.mixins.push(k),S},component(k,r){return r?(t.components[k]=r,S):t.components[k]},directive(k,r){return r?(t.directives[k]=r,S):t.directives[k]},mount(k,r,x){if(!n){const c=k0(l,e);return c.appContext=t,r&&o?o(c,k):a(c,k,x),n=!0,S._container=k,k.__vue_app__=S,Bi(c.component)||c.component.proxy}},unmount(){n&&(a(null,S._container),delete S._container.__vue_app__)},provide(k,r){return t.provides[k]=r,S}};return S}}function s2(a,o,i,l,e=!1){if(V(a)){a.forEach((c,w)=>s2(c,o&&(V(o)?o[w]:o),i,l,e));return}if(Qo(l)&&!e)return;const t=l.shapeFlag&4?Bi(l.component)||l.component.proxy:l.el,s=e?null:t,{i:n,r:S}=a,k=o&&o.r,r=n.refs===d0?n.refs={}:n.refs,x=n.setupState;if(k!=null&&k!==S&&(C0(k)?(r[k]=null,t0(x,k)&&(x[k]=null)):z0(k)&&(k.value=null)),J(S))Ia(S,n,12,[s,r]);else{const c=C0(S),w=z0(S);if(c||w){const F=()=>{if(a.f){const d=c?r[S]:S.value;e?V(d)&&T2(d,t):V(d)?d.includes(t)||d.push(t):c?(r[S]=[t],t0(x,S)&&(x[S]=r[S])):(S.value=[t],a.k&&(r[a.k]=S.value))}else c?(r[S]=s,t0(x,S)&&(x[S]=s)):w&&(S.value=s,a.k&&(r[a.k]=s))};s?(F.id=-1,$0(F,i)):F()}}}const $0=Ps;function en(a){return tn(a)}function tn(a,o){const i=v5();i.__VUE__=!0;const{insert:l,remove:e,patchProp:t,createElement:s,createText:n,createComment:S,setText:k,setElementText:r,parentNode:x,nextSibling:c,setScopeId:w=na,cloneNode:F,insertStaticContent:d}=a,u=(m,p,C,z=null,P=null,G=null,R=!1,_=null,H=!!p.dynamicChildren)=>{if(m===p)return;m&&!wa(m,p)&&(z=bo(m),Q0(m,P,G,!0),m=null),p.patchFlag===-2&&(H=!1,p.dynamicChildren=null);const{type:b,ref:$,shapeFlag:L}=p;switch(b){case il:B(m,p,C,z);break;case q0:W(m,p,C,z);break;case Ko:m==null&&f(p,C,z,R);break;case w0:A(m,p,C,z,P,G,R,_,H);break;default:L&1?E(m,p,C,z,P,G,R,_,H):L&6?n0(m,p,C,z,P,G,R,_,H):(L&64||L&128)&&b.process(m,p,C,z,P,G,R,_,H,W1)}$!=null&&P&&s2($,m&&m.ref,G,p||m,!p)},B=(m,p,C,z)=>{if(m==null)l(p.el=n(p.children),C,z);else{const P=p.el=m.el;p.children!==m.children&&k(P,p.children)}},W=(m,p,C,z)=>{m==null?l(p.el=S(p.children||""),C,z):p.el=m.el},f=(m,p,C,z)=>{[m.el,m.anchor]=d(m.children,p,C,z,m.el,m.anchor)},h=({el:m,anchor:p},C,z)=>{let P;for(;m&&m!==p;)P=c(m),l(m,C,z),m=P;l(p,C,z)},g=({el:m,anchor:p})=>{let C;for(;m&&m!==p;)C=c(m),e(m),m=C;e(p)},E=(m,p,C,z,P,G,R,_,H)=>{R=R||p.type==="svg",m==null?O(p,C,z,P,G,R,_,H):D(m,p,P,G,R,_,H)},O=(m,p,C,z,P,G,R,_)=>{let H,b;const{type:$,props:L,shapeFlag:N,transition:Z,patchFlag:S0,dirs:c0}=m;if(m.el&&F!==void 0&&S0===-1)H=m.el=F(m.el);else{if(H=m.el=s(m.type,G,L&&L.is,L),N&8?r(H,m.children):N&16&&v(m.children,H,null,z,P,G&&$!=="foreignObject",R,_),c0&&Ja(m,null,z,"created"),L){for(const p0 in L)p0!=="value"&&!Ao(p0)&&t(H,p0,null,L[p0],G,m.children,z,P,ua);"value"in L&&t(H,"value",null,L.value),(b=L.onVnodeBeforeMount)&&ra(b,z,m)}y(H,m,m.scopeId,R,z)}c0&&Ja(m,null,z,"beforeMount");const F0=(!P||P&&!P.pendingBranch)&&Z&&!Z.persisted;F0&&Z.beforeEnter(H),l(H,p,C),((b=L&&L.onVnodeMounted)||F0||c0)&&$0(()=>{b&&ra(b,z,m),F0&&Z.enter(H),c0&&Ja(m,null,z,"mounted")},P)},y=(m,p,C,z,P)=>{if(C&&w(m,C),z)for(let G=0;G<z.length;G++)w(m,z[G]);if(P){let G=P.subTree;if(p===G){const R=P.vnode;y(m,R,R.scopeId,R.slotScopeIds,P.parent)}}},v=(m,p,C,z,P,G,R,_,H=0)=>{for(let b=H;b<m.length;b++){const $=m[b]=_?Oa(m[b]):ta(m[b]);u(null,$,p,C,z,P,G,R,_)}},D=(m,p,C,z,P,G,R)=>{const _=p.el=m.el;let{patchFlag:H,dynamicChildren:b,dirs:$}=p;H|=m.patchFlag&16;const L=m.props||d0,N=p.props||d0;let Z;C&&a1(C,!1),(Z=N.onVnodeBeforeUpdate)&&ra(Z,C,p,m),$&&Ja(p,m,C,"beforeUpdate"),C&&a1(C,!0);const S0=P&&p.type!=="foreignObject";if(b?I(m.dynamicChildren,b,_,C,z,S0,G):R||h0(m,p,_,null,C,z,S0,G,!1),H>0){if(H&16)M(_,p,L,N,C,z,P);else if(H&2&&L.class!==N.class&&t(_,"class",null,N.class,P),H&4&&t(_,"style",L.style,N.style,P),H&8){const c0=p.dynamicProps;for(let F0=0;F0<c0.length;F0++){const p0=c0[F0],ea=L[p0],g1=N[p0];(g1!==ea||p0==="value")&&t(_,p0,ea,g1,P,m.children,C,z,ua)}}H&1&&m.children!==p.children&&r(_,p.children)}else!R&&b==null&&M(_,p,L,N,C,z,P);((Z=N.onVnodeUpdated)||$)&&$0(()=>{Z&&ra(Z,C,p,m),$&&Ja(p,m,C,"updated")},z)},I=(m,p,C,z,P,G,R)=>{for(let _=0;_<p.length;_++){const H=m[_],b=p[_],$=H.el&&(H.type===w0||!wa(H,b)||H.shapeFlag&70)?x(H.el):C;u(H,b,$,null,z,P,G,R,!0)}},M=(m,p,C,z,P,G,R)=>{if(C!==z){for(const _ in z){if(Ao(_))continue;const H=z[_],b=C[_];H!==b&&_!=="value"&&t(m,_,b,H,R,p.children,P,G,ua)}if(C!==d0)for(const _ in C)!Ao(_)&&!(_ in z)&&t(m,_,C[_],null,R,p.children,P,G,ua);"value"in z&&t(m,"value",C.value,z.value)}},A=(m,p,C,z,P,G,R,_,H)=>{const b=p.el=m?m.el:n(""),$=p.anchor=m?m.anchor:n("");let{patchFlag:L,dynamicChildren:N,slotScopeIds:Z}=p;Z&&(_=_?_.concat(Z):Z),m==null?(l(b,C,z),l($,C,z),v(p.children,C,$,P,G,R,_,H)):L>0&&L&64&&N&&m.dynamicChildren?(I(m.dynamicChildren,N,C,P,G,R,_),(p.key!=null||P&&p===P.subTree)&&Wt(m,p,!0)):h0(m,p,C,$,P,G,R,_,H)},n0=(m,p,C,z,P,G,R,_,H)=>{p.slotScopeIds=_,m==null?p.shapeFlag&512?P.ctx.activate(p,C,z,R,H):q(p,C,z,P,G,R,H):r0(m,p,H)},q=(m,p,C,z,P,G,R)=>{const _=m.component=rn(m,z,P);if(Wi(m)&&(_.ctx.renderer=W1),cn(_),_.asyncDep){if(P&&P.registerDep(_,l0),!m.el){const H=_.subTree=k0(q0);W(null,H,p,C)}return}l0(_,m,p,C,P,G,R)},r0=(m,p,C)=>{const z=p.component=m.component;if(Ws(m,p,C))if(z.asyncDep&&!z.asyncResolved){e0(z,p,C);return}else z.next=p,ws(z.update),z.update();else p.el=m.el,z.vnode=p},l0=(m,p,C,z,P,G,R)=>{const _=()=>{if(m.isMounted){let{next:$,bu:L,u:N,parent:Z,vnode:S0}=m,c0=$,F0;a1(m,!1),$?($.el=S0.el,e0(m,$,R)):$=S0,L&&Io(L),(F0=$.props&&$.props.onVnodeBeforeUpdate)&&ra(F0,Z,$,S0),a1(m,!0);const p0=Gi(m),ea=m.subTree;m.subTree=p0,u(ea,p0,x(ea.el),bo(ea),m,P,G),$.el=p0.el,c0===null&&Y2(m,p0.el),N&&$0(N,P),(F0=$.props&&$.props.onVnodeUpdated)&&$0(()=>ra(F0,Z,$,S0),P)}else{let $;const{el:L,props:N}=p,{bm:Z,m:S0,parent:c0}=m,F0=Qo(p);if(a1(m,!1),Z&&Io(Z),!F0&&($=N&&N.onVnodeBeforeMount)&&ra($,c0,p),a1(m,!0),L&&vi){const p0=()=>{m.subTree=Gi(m),vi(L,m.subTree,m,P,null)};F0?p.type.__asyncLoader().then(()=>!m.isUnmounted&&p0()):p0()}else{const p0=m.subTree=Gi(m);u(null,p0,C,z,m,P,G),p.el=p0.el}if(S0&&$0(S0,P),!F0&&($=N&&N.onVnodeMounted)){const p0=p;$0(()=>ra($,c0,p0),P)}(p.shapeFlag&256||c0&&Qo(c0.vnode)&&c0.vnode.shapeFlag&256)&&m.a&&$0(m.a,P),m.isMounted=!0,p=C=z=null}},H=m.effect=new Q2(_,()=>X2(b),m.scope),b=m.update=()=>H.run();b.id=m.uid,a1(m,!0),b()},e0=(m,p,C)=>{p.component=m;const z=m.vnode.props;m.vnode=p,m.next=null,Ys(m,p.props,z,C),an(m,p.children,C),R1(),Dl(),T1()},h0=(m,p,C,z,P,G,R,_,H=!1)=>{const b=m&&m.children,$=m?m.shapeFlag:0,L=p.children,{patchFlag:N,shapeFlag:Z}=p;if(N>0){if(N&128){I0(b,L,C,z,P,G,R,_,H);return}else if(N&256){_0(b,L,C,z,P,G,R,_,H);return}}Z&8?($&16&&ua(b,P,G),L!==b&&r(C,L)):$&16?Z&16?I0(b,L,C,z,P,G,R,_,H):ua(b,P,G,!0):($&8&&r(C,""),Z&16&&v(L,C,z,P,G,R,_,H))},_0=(m,p,C,z,P,G,R,_,H)=>{m=m||C1,p=p||C1;const b=m.length,$=p.length,L=Math.min(b,$);let N;for(N=0;N<L;N++){const Z=p[N]=H?Oa(p[N]):ta(p[N]);u(m[N],Z,C,null,P,G,R,_,H)}b>$?ua(m,P,G,!0,!1,L):v(p,C,z,P,G,R,_,H,L)},I0=(m,p,C,z,P,G,R,_,H)=>{let b=0;const $=p.length;let L=m.length-1,N=$-1;for(;b<=L&&b<=N;){const Z=m[b],S0=p[b]=H?Oa(p[b]):ta(p[b]);if(wa(Z,S0))u(Z,S0,C,null,P,G,R,_,H);else break;b++}for(;b<=L&&b<=N;){const Z=m[L],S0=p[N]=H?Oa(p[N]):ta(p[N]);if(wa(Z,S0))u(Z,S0,C,null,P,G,R,_,H);else break;L--,N--}if(b>L){if(b<=N){const Z=N+1,S0=Z<$?p[Z].el:z;for(;b<=N;)u(null,p[b]=H?Oa(p[b]):ta(p[b]),C,S0,P,G,R,_,H),b++}}else if(b>N)for(;b<=L;)Q0(m[b],P,G,!0),b++;else{const Z=b,S0=b,c0=new Map;for(b=S0;b<=N;b++){const U0=p[b]=H?Oa(p[b]):ta(p[b]);U0.key!=null&&c0.set(U0.key,b)}let F0,p0=0;const ea=N-S0+1;let g1=!1,Bl=0;const V1=new Array(ea);for(b=0;b<ea;b++)V1[b]=0;for(b=Z;b<=L;b++){const U0=m[b];if(p0>=ea){Q0(U0,P,G,!0);continue}let xa;if(U0.key!=null)xa=c0.get(U0.key);else for(F0=S0;F0<=N;F0++)if(V1[F0-S0]===0&&wa(U0,p[F0])){xa=F0;break}xa===void 0?Q0(U0,P,G,!0):(V1[xa-S0]=b+1,xa>=Bl?Bl=xa:g1=!0,u(U0,p[xa],C,null,P,G,R,_,H),p0++)}const yl=g1?sn(V1):C1;for(F0=yl.length-1,b=ea-1;b>=0;b--){const U0=S0+b,xa=p[U0],Cl=U0+1<$?p[U0+1].el:z;V1[b]===0?u(null,xa,C,Cl,P,G,R,_,H):g1&&(F0<0||b!==yl[F0]?b0(xa,C,Cl,2):F0--)}}},b0=(m,p,C,z,P=null)=>{const{el:G,type:R,transition:_,children:H,shapeFlag:b}=m;if(b&6){b0(m.component.subTree,p,C,z);return}if(b&128){m.suspense.move(p,C,z);return}if(b&64){R.move(m,p,C,W1);return}if(R===w0){l(G,p,C);for(let L=0;L<H.length;L++)b0(H[L],p,C,z);l(m.anchor,p,C);return}if(R===Ko){h(m,p,C);return}if(z!==2&&b&1&&_)if(z===0)_.beforeEnter(G),l(G,p,C),$0(()=>_.enter(G),P);else{const{leave:L,delayLeave:N,afterLeave:Z}=_,S0=()=>l(G,p,C),c0=()=>{L(G,()=>{S0(),Z&&Z()})};N?N(G,S0,c0):c0()}else l(G,p,C)},Q0=(m,p,C,z=!1,P=!1)=>{const{type:G,props:R,ref:_,children:H,dynamicChildren:b,shapeFlag:$,patchFlag:L,dirs:N}=m;if(_!=null&&s2(_,null,C,m,!0),$&256){p.ctx.deactivate(m);return}const Z=$&1&&N,S0=!Qo(m);let c0;if(S0&&(c0=R&&R.onVnodeBeforeUnmount)&&ra(c0,p,m),$&6)bi(m.component,C,z);else{if($&128){m.suspense.unmount(C,z);return}Z&&Ja(m,null,p,"beforeUnmount"),$&64?m.type.remove(m,p,C,P,W1,z):b&&(G!==w0||L>0&&L&64)?ua(b,p,C,!1,!0):(G===w0&&L&384||!P&&$&16)&&ua(H,p,C),z&&K0(m)}(S0&&(c0=R&&R.onVnodeUnmounted)||Z)&&$0(()=>{c0&&ra(c0,p,m),Z&&Ja(m,null,p,"unmounted")},C)},K0=m=>{const{type:p,el:C,anchor:z,transition:P}=m;if(p===w0){f1(C,z);return}if(p===Ko){g(m);return}const G=()=>{e(C),P&&!P.persisted&&P.afterLeave&&P.afterLeave()};if(m.shapeFlag&1&&P&&!P.persisted){const{leave:R,delayLeave:_}=P,H=()=>R(C,G);_?_(m.el,G,H):H()}else G()},f1=(m,p)=>{let C;for(;m!==p;)C=c(m),e(m),m=C;e(p)},bi=(m,p,C)=>{const{bum:z,scope:P,update:G,subTree:R,um:_}=m;z&&Io(z),P.stop(),G&&(G.active=!1,Q0(R,m,p,C)),_&&$0(_,p),$0(()=>{m.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&m.asyncDep&&!m.asyncResolved&&m.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},ua=(m,p,C,z=!1,P=!1,G=0)=>{for(let R=G;R<m.length;R++)Q0(m[R],p,C,z,P)},bo=m=>m.shapeFlag&6?bo(m.component.subTree):m.shapeFlag&128?m.suspense.next():c(m.anchor||m.el),hl=(m,p,C)=>{m==null?p._vnode&&Q0(p._vnode,null,null,!0):u(p._vnode||null,m,p,null,null,null,C),Dl(),Je(),p._vnode=m},W1={p:u,um:Q0,m:b0,r:K0,mt:q,mc:v,pc:h0,pbc:I,n:bo,o:a};let Mi,vi;return o&&([Mi,vi]=o(W1)),{render:hl,hydrate:Mi,createApp:ln(hl,Mi)}}function a1({effect:a,update:o},i){a.allowRecurse=o.allowRecurse=i}function Wt(a,o,i=!1){const l=a.children,e=o.children;if(V(l)&&V(e))for(let t=0;t<l.length;t++){const s=l[t];let n=e[t];n.shapeFlag&1&&!n.dynamicChildren&&((n.patchFlag<=0||n.patchFlag===32)&&(n=e[t]=Oa(e[t]),n.el=s.el),i||Wt(s,n))}}function sn(a){const o=a.slice(),i=[0];let l,e,t,s,n;const S=a.length;for(l=0;l<S;l++){const k=a[l];if(k!==0){if(e=i[i.length-1],a[e]<k){o[l]=e,i.push(l);continue}for(t=0,s=i.length-1;t<s;)n=t+s>>1,a[i[n]]<k?t=n+1:s=n;k<a[i[t]]&&(t>0&&(o[l]=i[t-1]),i[t]=l)}}for(t=i.length,s=i[t-1];t-- >0;)i[t]=s,s=o[s];return i}const nn=a=>a.__isTeleport,w0=Symbol(void 0),il=Symbol(void 0),q0=Symbol(void 0),Ko=Symbol(void 0),oo=[];let ia=null;function Q(a=!1){oo.push(ia=a?null:[])}function gt(){oo.pop(),ia=oo[oo.length-1]||null}let G1=1;function ql(a){G1+=a}function ht(a){return a.dynamicChildren=G1>0?ia||C1:null,gt(),G1>0&&ia&&ia.push(a),a}function Y(a,o,i,l,e,t){return ht(j(a,o,i,l,e,t,!0))}function Ea(a,o,i,l,e){return ht(k0(a,o,i,l,e,!0))}function ti(a){return a?a.__v_isVNode===!0:!1}function wa(a,o){return a.type===o.type&&a.key===o.key}const hi="__vInternal",Bt=({key:a})=>a!=null?a:null,$o=({ref:a,ref_key:o,ref_for:i})=>a!=null?C0(a)||z0(a)||J(a)?{i:oa,r:a,k:o,f:!!i}:a:null;function j(a,o=null,i=null,l=0,e=null,t=a===w0?0:1,s=!1,n=!1){const S={__v_isVNode:!0,__v_skip:!0,type:a,props:o,key:o&&Bt(o),ref:o&&$o(o),scopeId:fi,slotScopeIds:null,children:i,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:t,patchFlag:l,dynamicProps:e,dynamicChildren:null,appContext:null};return n?(ll(S,i),t&128&&a.normalize(S)):i&&(S.shapeFlag|=C0(i)?8:16),G1>0&&!s&&ia&&(S.patchFlag>0||t&6)&&S.patchFlag!==32&&ia.push(S),S}const k0=Sn;function Sn(a,o=null,i=null,l=0,e=null,t=!1){if((!a||a===rt)&&(a=q0),ti(a)){const n=Na(a,o,!0);return i&&ll(n,i),G1>0&&!t&&ia&&(n.shapeFlag&6?ia[ia.indexOf(a)]=n:ia.push(n)),n.patchFlag|=-2,n}if(jn(a)&&(a=a.__vccOpts),o){o=yt(o);let{class:n,style:S}=o;n&&!C0(n)&&(o.class=g0(n)),j0(S)&&(Qe(S)&&!V(S)&&(S=v0({},S)),o.style=fo(S))}const s=C0(a)?1:gs(a)?128:nn(a)?64:j0(a)?4:J(a)?2:0;return j(a,o,i,l,e,s,t,!0)}function yt(a){return a?Qe(a)||hi in a?v0({},a):a:null}function Na(a,o,i=!1){const{props:l,ref:e,patchFlag:t,children:s}=a,n=o?Et(l||{},o):l;return{__v_isVNode:!0,__v_skip:!0,type:a.type,props:n,key:n&&Bt(n),ref:o&&o.ref?i&&e?V(e)?e.concat($o(o)):[e,$o(o)]:$o(o):e,scopeId:a.scopeId,slotScopeIds:a.slotScopeIds,children:s,target:a.target,targetAnchor:a.targetAnchor,staticCount:a.staticCount,shapeFlag:a.shapeFlag,patchFlag:o&&a.type!==w0?t===-1?16:t|16:t,dynamicProps:a.dynamicProps,dynamicChildren:a.dynamicChildren,appContext:a.appContext,dirs:a.dirs,transition:a.transition,component:a.component,suspense:a.suspense,ssContent:a.ssContent&&Na(a.ssContent),ssFallback:a.ssFallback&&Na(a.ssFallback),el:a.el,anchor:a.anchor}}function o0(a=" ",o=0){return k0(il,null,a,o)}function Ct(a,o){const i=k0(Ko,null,a);return i.staticCount=o,i}function Ta(a="",o=!1){return o?(Q(),Ea(q0,null,a)):k0(q0,null,a)}function ta(a){return a==null||typeof a=="boolean"?k0(q0):V(a)?k0(w0,null,a.slice()):typeof a=="object"?Oa(a):k0(il,null,String(a))}function Oa(a){return a.el===null||a.memo?a:Na(a)}function ll(a,o){let i=0;const{shapeFlag:l}=a;if(o==null)o=null;else if(V(o))i=16;else if(typeof o=="object")if(l&65){const e=o.default;e&&(e._c&&(e._d=!1),ll(a,e()),e._c&&(e._d=!0));return}else{i=32;const e=o._;!e&&!(hi in o)?o._ctx=oa:e===3&&oa&&(oa.slots._===1?o._=1:(o._=2,a.patchFlag|=1024))}else J(o)?(o={default:o,_ctx:oa},i=32):(o=String(o),l&64?(i=16,o=[o0(o)]):i=8);a.children=o,a.shapeFlag|=i}function Et(...a){const o={};for(let i=0;i<a.length;i++){const l=a[i];for(const e in l)if(e==="class")o.class!==l.class&&(o.class=g0([o.class,l.class]));else if(e==="style")o.style=fo([o.style,l.style]);else if(wi(e)){const t=o[e],s=l[e];s&&t!==s&&!(V(t)&&t.includes(s))&&(o[e]=t?[].concat(t,s):s)}else e!==""&&(o[e]=l[e])}return o}function ra(a,o,i,l=null){la(a,o,7,[i,l])}const kn=ft();let xn=0;function rn(a,o,i){const l=a.type,e=(o?o.appContext:a.appContext)||kn,t={uid:xn++,vnode:a,type:l,parent:o,appContext:e,root:null,next:null,subTree:null,effect:null,update:null,scope:new _5(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:o?o.provides:Object.create(e.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:mt(l,e),emitsOptions:ot(l,e),emit:null,emitted:null,propsDefaults:d0,inheritAttrs:l.inheritAttrs,ctx:d0,data:d0,props:d0,attrs:d0,slots:d0,refs:d0,setupState:d0,setupContext:null,suspense:i,suspenseId:i?i.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return t.ctx={_:t},t.root=o?o.root:t,t.emit=js.bind(null,t),a.ce&&a.ce(t),t}let P0=null;const Pt=()=>P0||oa,Ua=a=>{P0=a,a.scope.on()},Qa=()=>{P0&&P0.scope.off(),P0=null};function zt(a){return a.vnode.shapeFlag&4}let ro=!1;function cn(a,o=!1){ro=o;const{props:i,children:l}=a.vnode,e=zt(a);Xs(a,i,e,o),Js(a,l);const t=e?Fn(a,o):void 0;return ro=!1,t}function Fn(a,o){const i=a.type;a.accessCache=Object.create(null),a.proxy=Ke(new Proxy(a.ctx,Ks));const{setup:l}=i;if(l){const e=a.setupContext=l.length>1?wn(a):null;Ua(a),R1();const t=Ia(l,a,0,[a.props,e]);if(T1(),Qa(),L2(t)){if(t.then(Qa,Qa),o)return t.then(s=>{n2(a,s,o)}).catch(s=>{ho(s,a,0)});a.asyncDep=t}else n2(a,t,o)}else bt(a,o)}function n2(a,o,i){J(o)?a.type.__ssrInlineRender?a.ssrRender=o:a.render=o:j0(o)&&(a.setupState=Ve(o)),bt(a,i)}let Xl;function bt(a,o,i){const l=a.type;if(!a.render){if(!o&&Xl&&!l.render){const e=l.template;if(e){const{isCustomElement:t,compilerOptions:s}=a.appContext.config,{delimiters:n,compilerOptions:S}=l,k=v0(v0({isCustomElement:t,delimiters:n},s),S);l.render=Xl(e,k)}}a.render=l.render||na}Ua(a),R1(),$s(a),T1(),Qa()}function dn(a){return new Proxy(a.attrs,{get(o,i){return X0(a,"get","$attrs"),o[i]}})}function wn(a){const o=l=>{a.exposed=l||{}};let i;return{get attrs(){return i||(i=dn(a))},slots:a.slots,emit:a.emit,expose:o}}function Bi(a){if(a.exposed)return a.exposeProxy||(a.exposeProxy=new Proxy(Ve(Ke(a.exposed)),{get(o,i){if(i in o)return o[i];if(i in li)return li[i](a)}}))}function mn(a,o=!0){return J(a)?a.displayName||a.name:a.name||o&&a.__name}function jn(a){return J(a)&&"__vccOpts"in a}const H0=(a,o)=>rs(a,o,ro);function Di(a){const o=Pt();let i=a();return Qa(),L2(i)&&(i=i.catch(l=>{throw Ua(o),l})),[i,()=>Ua(o)]}function pn(a,o,i){const l=arguments.length;return l===2?j0(o)&&!V(o)?ti(o)?k0(a,null,[o]):k0(a,o):k0(a,null,o):(l>3?i=Array.prototype.slice.call(arguments,2):l===3&&ti(i)&&(i=[i]),k0(a,o,i))}const un="3.2.38",fn="http://www.w3.org/2000/svg",t1=typeof document<"u"?document:null,Yl=t1&&t1.createElement("template"),Wn={insert:(a,o,i)=>{o.insertBefore(a,i||null)},remove:a=>{const o=a.parentNode;o&&o.removeChild(a)},createElement:(a,o,i,l)=>{const e=o?t1.createElementNS(fn,a):t1.createElement(a,i?{is:i}:void 0);return a==="select"&&l&&l.multiple!=null&&e.setAttribute("multiple",l.multiple),e},createText:a=>t1.createTextNode(a),createComment:a=>t1.createComment(a),setText:(a,o)=>{a.nodeValue=o},setElementText:(a,o)=>{a.textContent=o},parentNode:a=>a.parentNode,nextSibling:a=>a.nextSibling,querySelector:a=>t1.querySelector(a),setScopeId(a,o){a.setAttribute(o,"")},cloneNode(a){const o=a.cloneNode(!0);return"_value"in a&&(o._value=a._value),o},insertStaticContent(a,o,i,l,e,t){const s=i?i.previousSibling:o.lastChild;if(e&&(e===t||e.nextSibling))for(;o.insertBefore(e.cloneNode(!0),i),!(e===t||!(e=e.nextSibling)););else{Yl.innerHTML=l?`<svg>${a}</svg>`:a;const n=Yl.content;if(l){const S=n.firstChild;for(;S.firstChild;)n.appendChild(S.firstChild);n.removeChild(S)}o.insertBefore(n,i)}return[s?s.nextSibling:o.firstChild,i?i.previousSibling:o.lastChild]}};function gn(a,o,i){const l=a._vtc;l&&(o=(o?[o,...l]:[...l]).join(" ")),o==null?a.removeAttribute("class"):i?a.setAttribute("class",o):a.className=o}function hn(a,o,i){const l=a.style,e=C0(i);if(i&&!e){for(const t in i)S2(l,t,i[t]);if(o&&!C0(o))for(const t in o)i[t]==null&&S2(l,t,"")}else{const t=l.display;e?o!==i&&(l.cssText=i):o&&a.removeAttribute("style"),"_vod"in a&&(l.display=t)}}const Zl=/\s*!important$/;function S2(a,o,i){if(V(i))i.forEach(l=>S2(a,o,l));else if(i==null&&(i=""),o.startsWith("--"))a.setProperty(o,i);else{const l=Bn(a,o);Zl.test(i)?a.setProperty(p1(l),i.replace(Zl,""),"important"):a[l]=i}}const Jl=["Webkit","Moz","ms"],Oi={};function Bn(a,o){const i=Oi[o];if(i)return i;let l=ma(o);if(l!=="filter"&&l in a)return Oi[o]=l;l=ji(l);for(let e=0;e<Jl.length;e++){const t=Jl[e]+l;if(t in a)return Oi[o]=t}return o}const ae="http://www.w3.org/1999/xlink";function yn(a,o,i,l,e){if(l&&o.startsWith("xlink:"))i==null?a.removeAttributeNS(ae,o.slice(6,o.length)):a.setAttributeNS(ae,o,i);else{const t=f5(o);i==null||t&&!Pe(i)?a.removeAttribute(o):a.setAttribute(o,t?"":i)}}function Cn(a,o,i,l,e,t,s){if(o==="innerHTML"||o==="textContent"){l&&s(l,e,t),a[o]=i==null?"":i;return}if(o==="value"&&a.tagName!=="PROGRESS"&&!a.tagName.includes("-")){a._value=i;const S=i==null?"":i;(a.value!==S||a.tagName==="OPTION")&&(a.value=S),i==null&&a.removeAttribute(o);return}let n=!1;if(i===""||i==null){const S=typeof a[o];S==="boolean"?i=Pe(i):i==null&&S==="string"?(i="",n=!0):S==="number"&&(i=0,n=!0)}try{a[o]=i}catch{}n&&a.removeAttribute(o)}const[Mt,En]=(()=>{let a=Date.now,o=!1;if(typeof window<"u"){Date.now()>document.createEvent("Event").timeStamp&&(a=performance.now.bind(performance));const i=navigator.userAgent.match(/firefox\/(\d+)/i);o=!!(i&&Number(i[1])<=53)}return[a,o]})();let k2=0;const Pn=Promise.resolve(),zn=()=>{k2=0},bn=()=>k2||(Pn.then(zn),k2=Mt());function Ba(a,o,i,l){a.addEventListener(o,i,l)}function Mn(a,o,i,l){a.removeEventListener(o,i,l)}function vn(a,o,i,l,e=null){const t=a._vei||(a._vei={}),s=t[o];if(l&&s)s.value=l;else{const[n,S]=_n(o);if(l){const k=t[o]=Gn(l,e);Ba(a,n,k,S)}else s&&(Mn(a,n,s,S),t[o]=void 0)}}const oe=/(?:Once|Passive|Capture)$/;function _n(a){let o;if(oe.test(a)){o={};let l;for(;l=a.match(oe);)a=a.slice(0,a.length-l[0].length),o[l[0].toLowerCase()]=!0}return[a[2]===":"?a.slice(3):p1(a.slice(2)),o]}function Gn(a,o){const i=l=>{const e=l.timeStamp||Mt();(En||e>=i.attached-1)&&la(Hn(l,i.value),o,5,[l])};return i.value=a,i.attached=bn(),i}function Hn(a,o){if(V(o)){const i=a.stopImmediatePropagation;return a.stopImmediatePropagation=()=>{i.call(a),a._stopped=!0},o.map(l=>e=>!e._stopped&&l&&l(e))}else return o}const ie=/^on[a-z]/,Dn=(a,o,i,l,e=!1,t,s,n,S)=>{o==="class"?gn(a,l,e):o==="style"?hn(a,i,l):wi(o)?R2(o)||vn(a,o,i,l,s):(o[0]==="."?(o=o.slice(1),!0):o[0]==="^"?(o=o.slice(1),!1):On(a,o,l,e))?Cn(a,o,l,t,s,n,S):(o==="true-value"?a._trueValue=l:o==="false-value"&&(a._falseValue=l),yn(a,o,l,e))};function On(a,o,i,l){return l?!!(o==="innerHTML"||o==="textContent"||o in a&&ie.test(o)&&J(i)):o==="spellcheck"||o==="draggable"||o==="translate"||o==="form"||o==="list"&&a.tagName==="INPUT"||o==="type"&&a.tagName==="TEXTAREA"||ie.test(o)&&C0(i)?!1:o in a}const Ga="transition",q1="animation",el=(a,{slots:o})=>pn(lt,Rn(a),o);el.displayName="Transition";const vt={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};el.props=v0({},lt.props,vt);const o1=(a,o=[])=>{V(a)?a.forEach(i=>i(...o)):a&&a(...o)},le=a=>a?V(a)?a.some(o=>o.length>1):a.length>1:!1;function Rn(a){const o={};for(const M in a)M in vt||(o[M]=a[M]);if(a.css===!1)return o;const{name:i="v",type:l,duration:e,enterFromClass:t=`${i}-enter-from`,enterActiveClass:s=`${i}-enter-active`,enterToClass:n=`${i}-enter-to`,appearFromClass:S=t,appearActiveClass:k=s,appearToClass:r=n,leaveFromClass:x=`${i}-leave-from`,leaveActiveClass:c=`${i}-leave-active`,leaveToClass:w=`${i}-leave-to`}=a,F=Tn(e),d=F&&F[0],u=F&&F[1],{onBeforeEnter:B,onEnter:W,onEnterCancelled:f,onLeave:h,onLeaveCancelled:g,onBeforeAppear:E=B,onAppear:O=W,onAppearCancelled:y=f}=o,v=(M,A,n0)=>{i1(M,A?r:n),i1(M,A?k:s),n0&&n0()},D=(M,A)=>{M._isLeaving=!1,i1(M,x),i1(M,w),i1(M,c),A&&A()},I=M=>(A,n0)=>{const q=M?O:W,r0=()=>v(A,M,n0);o1(q,[A,r0]),ee(()=>{i1(A,M?S:t),Ha(A,M?r:n),le(q)||te(A,l,d,r0)})};return v0(o,{onBeforeEnter(M){o1(B,[M]),Ha(M,t),Ha(M,s)},onBeforeAppear(M){o1(E,[M]),Ha(M,S),Ha(M,k)},onEnter:I(!1),onAppear:I(!0),onLeave(M,A){M._isLeaving=!0;const n0=()=>D(M,A);Ha(M,x),In(),Ha(M,c),ee(()=>{!M._isLeaving||(i1(M,x),Ha(M,w),le(h)||te(M,l,u,n0))}),o1(h,[M,n0])},onEnterCancelled(M){v(M,!1),o1(f,[M])},onAppearCancelled(M){v(M,!0),o1(y,[M])},onLeaveCancelled(M){D(M),o1(g,[M])}})}function Tn(a){if(a==null)return null;if(j0(a))return[Ri(a.enter),Ri(a.leave)];{const o=Ri(a);return[o,o]}}function Ri(a){return v1(a)}function Ha(a,o){o.split(/\s+/).forEach(i=>i&&a.classList.add(i)),(a._vtc||(a._vtc=new Set)).add(o)}function i1(a,o){o.split(/\s+/).forEach(l=>l&&a.classList.remove(l));const{_vtc:i}=a;i&&(i.delete(o),i.size||(a._vtc=void 0))}function ee(a){requestAnimationFrame(()=>{requestAnimationFrame(a)})}let Ln=0;function te(a,o,i,l){const e=a._endId=++Ln,t=()=>{e===a._endId&&l()};if(i)return setTimeout(t,i);const{type:s,timeout:n,propCount:S}=An(a,o);if(!s)return l();const k=s+"end";let r=0;const x=()=>{a.removeEventListener(k,c),t()},c=w=>{w.target===a&&++r>=S&&x()};setTimeout(()=>{r<S&&x()},n+1),a.addEventListener(k,c)}function An(a,o){const i=window.getComputedStyle(a),l=F=>(i[F]||"").split(", "),e=l(Ga+"Delay"),t=l(Ga+"Duration"),s=se(e,t),n=l(q1+"Delay"),S=l(q1+"Duration"),k=se(n,S);let r=null,x=0,c=0;o===Ga?s>0&&(r=Ga,x=s,c=t.length):o===q1?k>0&&(r=q1,x=k,c=S.length):(x=Math.max(s,k),r=x>0?s>k?Ga:q1:null,c=r?r===Ga?t.length:S.length:0);const w=r===Ga&&/\b(transform|all)(,|$)/.test(i[Ga+"Property"]);return{type:r,timeout:x,propCount:c,hasTransform:w}}function se(a,o){for(;a.length<o.length;)a=a.concat(a);return Math.max(...o.map((i,l)=>ne(i)+ne(a[l])))}function ne(a){return Number(a.slice(0,-1).replace(",","."))*1e3}function In(){return document.body.offsetHeight}const Va=a=>{const o=a.props["onUpdate:modelValue"]||!1;return V(o)?i=>Io(o,i):o};function Qn(a){a.target.composing=!0}function Se(a){const o=a.target;o.composing&&(o.composing=!1,o.dispatchEvent(new Event("input")))}const yi={created(a,{modifiers:{lazy:o,trim:i,number:l}},e){a._assign=Va(e);const t=l||e.props&&e.props.type==="number";Ba(a,o?"change":"input",s=>{if(s.target.composing)return;let n=a.value;i&&(n=n.trim()),t&&(n=v1(n)),a._assign(n)}),i&&Ba(a,"change",()=>{a.value=a.value.trim()}),o||(Ba(a,"compositionstart",Qn),Ba(a,"compositionend",Se),Ba(a,"change",Se))},mounted(a,{value:o}){a.value=o==null?"":o},beforeUpdate(a,{value:o,modifiers:{lazy:i,trim:l,number:e}},t){if(a._assign=Va(t),a.composing||document.activeElement===a&&a.type!=="range"&&(i||l&&a.value.trim()===o||(e||a.type==="number")&&v1(a.value)===o))return;const s=o==null?"":o;a.value!==s&&(a.value=s)}},Ti={deep:!0,created(a,o,i){a._assign=Va(i),Ba(a,"change",()=>{const l=a._modelValue,e=H1(a),t=a.checked,s=a._assign;if(V(l)){const n=O2(l,e),S=n!==-1;if(t&&!S)s(l.concat(e));else if(!t&&S){const k=[...l];k.splice(n,1),s(k)}}else if(O1(l)){const n=new Set(l);t?n.add(e):n.delete(e),s(n)}else s(_t(a,t))})},mounted:ke,beforeUpdate(a,o,i){a._assign=Va(i),ke(a,o,i)}};function ke(a,{value:o,oldValue:i},l){a._modelValue=o,V(o)?a.checked=O2(o,l.props.value)>-1:O1(o)?a.checked=o.has(l.props.value):o!==i&&(a.checked=w1(o,_t(a,!0)))}const x2={created(a,{value:o},i){a.checked=w1(o,i.props.value),a._assign=Va(i),Ba(a,"change",()=>{a._assign(H1(a))})},beforeUpdate(a,{value:o,oldValue:i},l){a._assign=Va(l),o!==i&&(a.checked=w1(o,l.props.value))}},Kn={deep:!0,created(a,{value:o,modifiers:{number:i}},l){const e=O1(o);Ba(a,"change",()=>{const t=Array.prototype.filter.call(a.options,s=>s.selected).map(s=>i?v1(H1(s)):H1(s));a._assign(a.multiple?e?new Set(t):t:t[0])}),a._assign=Va(l)},mounted(a,{value:o}){xe(a,o)},beforeUpdate(a,o,i){a._assign=Va(i)},updated(a,{value:o}){xe(a,o)}};function xe(a,o){const i=a.multiple;if(!(i&&!V(o)&&!O1(o))){for(let l=0,e=a.options.length;l<e;l++){const t=a.options[l],s=H1(t);if(i)V(o)?t.selected=O2(o,s)>-1:t.selected=o.has(s);else if(w1(H1(t),o)){a.selectedIndex!==l&&(a.selectedIndex=l);return}}!i&&a.selectedIndex!==-1&&(a.selectedIndex=-1)}}function H1(a){return"_value"in a?a._value:a.value}function _t(a,o){const i=o?"_trueValue":"_falseValue";return i in a?a[i]:o}const $n=["ctrl","shift","alt","meta"],Nn={stop:a=>a.stopPropagation(),prevent:a=>a.preventDefault(),self:a=>a.target!==a.currentTarget,ctrl:a=>!a.ctrlKey,shift:a=>!a.shiftKey,alt:a=>!a.altKey,meta:a=>!a.metaKey,left:a=>"button"in a&&a.button!==0,middle:a=>"button"in a&&a.button!==1,right:a=>"button"in a&&a.button!==2,exact:(a,o)=>$n.some(i=>a[`${i}Key`]&&!o.includes(i))},Un=(a,o)=>(i,...l)=>{for(let e=0;e<o.length;e++){const t=Nn[o[e]];if(t&&t(i,o))return}return a(i,...l)},Vn={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},r2=(a,o)=>i=>{if(!("key"in i))return;const l=p1(i.key);if(o.some(e=>e===l||Vn[e]===l))return a(i)},qn=v0({patchProp:Dn},Wn);let re;function Xn(){return re||(re=en(qn))}const Yn=(...a)=>{const o=Xn().createApp(...a),{mount:i}=o;return o.mount=l=>{const e=Zn(l);if(!e)return;const t=o._component;!J(t)&&!t.render&&!t.template&&(t.template=e.innerHTML),e.innerHTML="";const s=i(e,!1,e instanceof SVGElement);return e instanceof Element&&(e.removeAttribute("v-cloak"),e.setAttribute("data-v-app","")),s},o};function Zn(a){return C0(a)?document.querySelector(a):a}const r1=ns();function No(a){a===void 0&&(a=r1.value.comp.returnValue()),r1.value.resolve(a),r1.value=null}function Jn(a,o,i="default"){return new Promise(l=>{r1.value={dialog:a,props:o,wrapper:i,resolve:l}})}const aS={install:(a,o)=>{a.config.globalProperties.$close=(i,l)=>{No(l)}}};var oS=(a,o)=>{const i=a.__vccOpts||a;for(const[l,e]of o)i[l]=e;return i};const iS=vs({name:"DialogWrapper",components:{},props:{name:{type:String,default:"default"},transitionAttrs:Object},setup(){const a=s0();return x1(a,()=>{r1.value&&(r1.value.comp=a.value)}),{dialogRef:r1,dialogInstance:a}}});function lS(a,o,i,l,e,t){return Q(),Ea(el,B5(yt(a.transitionAttrs)),{default:ao(()=>[a.dialogRef&&a.dialogRef.wrapper===a.name?(Q(),Ea(ct(a.dialogRef.dialog),Et({key:0},a.dialogRef.props,{ref:"dialogInstance"}),null,16)):Ta("",!0)]),_:1},16)}var eS=oS(iS,[["render",lS]]);/*! *****************************************************************************
...
***************************************************************************** */var i0=function(){return i0=Object.assign||function(o){for(var i,l=1,e=arguments.length;l<e;l++){i=arguments[l];for(var t in i)Object.prototype.hasOwnProperty.call(i,t)&&(o[t]=i[t])}return o},i0.apply(this,arguments)};function c2(a,o,i){if(i||arguments.length===2)for(var l=0,e=o.length,t;l<e;l++)(t||!(l in o))&&(t||(t=Array.prototype.slice.call(o,0,l)),t[l]=o[l]);return a.concat(t||Array.prototype.slice.call(o))}var u0=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,y0=Object.keys,O0=Array.isArray;typeof Promise<"u"&&!u0.Promise&&(u0.Promise=Promise);function A0(a,o){return typeof o!="object"||y0(o).forEach(function(i){a[i]=o[i]}),a}var co=Object.getPrototypeOf,tS={}.hasOwnProperty;function Y0(a,o){return tS.call(a,o)}function D1(a,o){typeof o=="function"&&(o=o(co(a))),(typeof Reflect>"u"?y0:Reflect.ownKeys)(o).forEach(function(i){ba(a,i,o[i])})}var Gt=Object.defineProperty;function ba(a,o,i,l){Gt(a,o,A0(i&&Y0(i,"get")&&typeof i.get=="function"?{get:i.get,set:i.set,configurable:!0}:{value:i,configurable:!0,writable:!0},l))}function L1(a){return{from:function(o){return a.prototype=Object.create(o.prototype),ba(a.prototype,"constructor",a),{extend:D1.bind(null,a.prototype)}}}}var sS=Object.getOwnPropertyDescriptor;function tl(a,o){var i=sS(a,o),l;return i||(l=co(a))&&tl(l,o)}var nS=[].slice;function Ci(a,o,i){return nS.call(a,o,i)}function Ht(a,o){return o(a)}function Z1(a){if(!a)throw new Error("Assertion Failed")}function Dt(a){u0.setImmediate?setImmediate(a):setTimeout(a,0)}function Ot(a,o){return a.reduce(function(i,l,e){var t=o(l,e);return t&&(i[t[0]]=t[1]),i},{})}function SS(a,o,i){try{a.apply(null,i)}catch(l){o&&o(l)}}function Pa(a,o){if(Y0(a,o))return a[o];if(!o)return a;if(typeof o!="string"){for(var i=[],l=0,e=o.length;l<e;++l){var t=Pa(a,o[l]);i.push(t)}return i}var s=o.indexOf(".");if(s!==-1){var n=a[o.substr(0,s)];return n===void 0?void 0:Pa(n,o.substr(s+1))}}function ka(a,o,i){if(!(!a||o===void 0)&&!("isFrozen"in Object&&Object.isFrozen(a)))if(typeof o!="string"&&"length"in o){Z1(typeof i!="string"&&"length"in i);for(var l=0,e=o.length;l<e;++l)ka(a,o[l],i[l])}else{var t=o.indexOf(".");if(t!==-1){var s=o.substr(0,t),n=o.substr(t+1);if(n==="")i===void 0?O0(a)&&!isNaN(parseInt(s))?a.splice(s,1):delete a[s]:a[s]=i;else{var S=a[s];(!S||!Y0(a,s))&&(S=a[s]={}),ka(S,n,i)}}else i===void 0?O0(a)&&!isNaN(parseInt(o))?a.splice(o,1):delete a[o]:a[o]=i}}function kS(a,o){typeof o=="string"?ka(a,o,void 0):"length"in o&&[].map.call(o,function(i){ka(a,i,void 0)})}function Rt(a){var o={};for(var i in a)Y0(a,i)&&(o[i]=a[i]);return o}var xS=[].concat;function Tt(a){return xS.apply([],a)}var Lt="Boolean,String,Date,RegExp,Blob,File,FileList,FileSystemFileHandle,ArrayBuffer,DataView,Uint8ClampedArray,ImageBitmap,ImageData,Map,Set,CryptoKey".split(",").concat(Tt([8,16,32,64].map(function(a){return["Int","Uint","Float"].map(function(o){return o+a+"Array"})}))).filter(function(a){return u0[a]}),rS=Lt.map(function(a){return u0[a]});Ot(Lt,function(a){return[a,!0]});var Ra=null;function Bo(a){Ra=typeof WeakMap<"u"&&new WeakMap;var o=F2(a);return Ra=null,o}function F2(a){if(!a||typeof a!="object")return a;var o=Ra&&Ra.get(a);if(o)return o;if(O0(a)){o=[],Ra&&Ra.set(a,o);for(var i=0,l=a.length;i<l;++i)o.push(F2(a[i]))}else if(rS.indexOf(a.constructor)>=0)o=a;else{var e=co(a);o=e===Object.prototype?{}:Object.create(e),Ra&&Ra.set(a,o);for(var t in a)Y0(a,t)&&(o[t]=F2(a[t]))}return o}var cS={}.toString;function d2(a){return cS.call(a).slice(8,-1)}var w2=typeof Symbol<"u"?Symbol.iterator:"@@iterator",FS=typeof w2=="symbol"?function(a){var o;return a!=null&&(o=a[w2])&&o.apply(a)}:function(){return null},y1={};function ya(a){var o,i,l,e;if(arguments.length===1){if(O0(a))return a.slice();if(this===y1&&typeof a=="string")return[a];if(e=FS(a)){for(i=[];l=e.next(),!l.done;)i.push(l.value);return i}if(a==null)return[a];if(o=a.length,typeof o=="number"){for(i=new Array(o);o--;)i[o]=a[o];return i}return[a]}for(o=arguments.length,i=new Array(o);o--;)i[o]=arguments[o];return i}var sl=typeof Symbol<"u"?function(a){return a[Symbol.toStringTag]==="AsyncFunction"}:function(){return!1},ja=typeof location<"u"&&/^(http|https):\/\/(localhost|127\.0\.0\.1)/.test(location.href);function At(a,o){ja=a,It=o}var It=function(){return!0},dS=!new Error("").stack;function u1(){if(dS)try{throw u1.arguments,new Error}catch(a){return a}return new Error}function m2(a,o){var i=a.stack;return i?(o=o||0,i.indexOf(a.name)===0&&(o+=(a.name+a.message).split(`
`).length),i.split(`
`).slice(o).filter(It).map(function(l){return`
`+l}).join("")):""}var wS=["Modify","Bulk","OpenFailed","VersionChange","Schema","Upgrade","InvalidTable","MissingAPI","NoSuchDatabase","InvalidArgument","SubTransaction","Unsupported","Internal","DatabaseClosed","PrematureCommit","ForeignAwait"],Qt=["Unknown","Constraint","Data","TransactionInactive","ReadOnly","Version","NotFound","InvalidState","InvalidAccess","Abort","Timeout","QuotaExceeded","Syntax","DataClone"],nl=wS.concat(Qt),mS={VersionChanged:"Database version changed by other database connection",DatabaseClosed:"Database has been closed",Abort:"Transaction aborted",TransactionInactive:"Transaction has already completed or failed",MissingAPI:"IndexedDB API missing. Please visit https://tinyurl.com/y2uuvskb"};function A1(a,o){this._e=u1(),this.name=a,this.message=o}L1(A1).from(Error).extend({stack:{get:function(){return this._stack||(this._stack=this.name+": "+this.message+m2(this._e,2))}},toString:function(){return this.name+": "+this.message}});function Kt(a,o){return a+". Errors: "+Object.keys(o).map(function(i){return o[i].toString()}).filter(function(i,l,e){return e.indexOf(i)===l}).join(`
`)}function si(a,o,i,l){this._e=u1(),this.failures=o,this.failedKeys=l,this.successCount=i,this.message=Kt(a,o)}L1(si).from(A1);function io(a,o){this._e=u1(),this.name="BulkError",this.failures=Object.keys(o).map(function(i){return o[i]}),this.failuresByPos=o,this.message=Kt(a,o)}L1(io).from(A1);var Sl=nl.reduce(function(a,o){return a[o]=o+"Error",a},{}),jS=A1,X=nl.reduce(function(a,o){var i=o+"Error";function l(e,t){this._e=u1(),this.name=i,e?typeof e=="string"?(this.message=""+e+(t?`
 `+t:""),this.inner=t||null):typeof e=="object"&&(this.message=e.name+" "+e.message,this.inner=e):(this.message=mS[o]||i,this.inner=null)}return L1(l).from(jS),a[o]=l,a},{});X.Syntax=SyntaxError;X.Type=TypeError;X.Range=RangeError;var ce=Qt.reduce(function(a,o){return a[o+"Error"]=X[o],a},{});function pS(a,o){if(!a||a instanceof A1||a instanceof TypeError||a instanceof SyntaxError||!a.name||!ce[a.name])return a;var i=new ce[a.name](o||a.message,a);return"stack"in a&&ba(i,"stack",{get:function(){return this.inner.stack}}),i}var Ei=nl.reduce(function(a,o){return["Syntax","Type","Range"].indexOf(o)===-1&&(a[o+"Error"]=X[o]),a},{});Ei.ModifyError=si;Ei.DexieError=A1;Ei.BulkError=io;function m0(){}function yo(a){return a}function uS(a,o){return a==null||a===yo?o:function(i){return o(a(i))}}function m1(a,o){return function(){a.apply(this,arguments),o.apply(this,arguments)}}function fS(a,o){return a===m0?o:function(){var i=a.apply(this,arguments);i!==void 0&&(arguments[0]=i);var l=this.onsuccess,e=this.onerror;this.onsuccess=null,this.onerror=null;var t=o.apply(this,arguments);return l&&(this.onsuccess=this.onsuccess?m1(l,this.onsuccess):l),e&&(this.onerror=this.onerror?m1(e,this.onerror):e),t!==void 0?t:i}}function WS(a,o){return a===m0?o:function(){a.apply(this,arguments);var i=this.onsuccess,l=this.onerror;this.onsuccess=this.onerror=null,o.apply(this,arguments),i&&(this.onsuccess=this.onsuccess?m1(i,this.onsuccess):i),l&&(this.onerror=this.onerror?m1(l,this.onerror):l)}}function gS(a,o){return a===m0?o:function(i){var l=a.apply(this,arguments);A0(i,l);var e=this.onsuccess,t=this.onerror;this.onsuccess=null,this.onerror=null;var s=o.apply(this,arguments);return e&&(this.onsuccess=this.onsuccess?m1(e,this.onsuccess):e),t&&(this.onerror=this.onerror?m1(t,this.onerror):t),l===void 0?s===void 0?void 0:s:A0(l,s)}}function hS(a,o){return a===m0?o:function(){return o.apply(this,arguments)===!1?!1:a.apply(this,arguments)}}function kl(a,o){return a===m0?o:function(){var i=a.apply(this,arguments);if(i&&typeof i.then=="function"){for(var l=this,e=arguments.length,t=new Array(e);e--;)t[e]=arguments[e];return i.then(function(){return o.apply(l,t)})}return o.apply(this,arguments)}}var Fo={},BS=100,yS=20,$t=100,xl=typeof Promise>"u"?[]:function(){var a=Promise.resolve();if(typeof crypto>"u"||!crypto.subtle)return[a,co(a),a];var o=crypto.subtle.digest("SHA-512",new Uint8Array([0]));return[o,co(o),a]}(),j2=xl[0],ni=xl[1],p2=xl[2],Nt=ni&&ni.then,Uo=j2&&j2.constructor,rl=!!p2,u2=!1,CS=p2?function(){p2.then(Do)}:u0.setImmediate?setImmediate.bind(null,Do):u0.MutationObserver?function(){var a=document.createElement("div");new MutationObserver(function(){Do(),a=null}).observe(a,{attributes:!0}),a.setAttribute("i","1")}:function(){setTimeout(Do,0)},wo=function(a,o){J1.push([a,o]),Si&&(CS(),Si=!1)},f2=!0,Si=!0,c1=[],Vo=[],W2=null,g2=yo,M1={id:"global",global:!0,ref:0,unhandleds:[],onunhandled:we,pgp:!1,env:{},finalize:function(){this.unhandleds.forEach(function(a){try{we(a[0],a[1])}catch{}})}},U=M1,J1=[],F1=0,qo=[];function T(a){if(typeof this!="object")throw new TypeError("Promises must be constructed via new");this._listeners=[],this.onuncatched=m0,this._lib=!1;var o=this._PSD=U;if(ja&&(this._stackHolder=u1(),this._prev=null,this._numPrev=0),typeof a!="function"){if(a!==Fo)throw new TypeError("Not a function");this._state=arguments[1],this._value=arguments[2],this._state===!1&&B2(this,this._value);return}this._state=null,this._value=null,++o.ref,Vt(this,a)}var h2={get:function(){var a=U,o=ki;function i(l,e){var t=this,s=!a.global&&(a!==U||o!==ki),n=s&&!Ma(),S=new T(function(k,r){cl(t,new Ut(ri(l,a,s,n),ri(e,a,s,n),k,r,a))});return ja&&Yt(S,this),S}return i.prototype=Fo,i},set:function(a){ba(this,"then",a&&a.prototype===Fo?h2:{get:function(){return a},set:h2.set})}};D1(T.prototype,{then:h2,_then:function(a,o){cl(this,new Ut(null,null,a,o,U))},catch:function(a){if(arguments.length===1)return this.then(null,a);var o=arguments[0],i=arguments[1];return typeof o=="function"?this.then(null,function(l){return l instanceof o?i(l):Xo(l)}):this.then(null,function(l){return l&&l.name===o?i(l):Xo(l)})},finally:function(a){return this.then(function(o){return a(),o},function(o){return a(),Xo(o)})},stack:{get:function(){if(this._stack)return this._stack;try{u2=!0;var a=Xt(this,[],yS),o=a.join(`
From previous: `);return this._state!==null&&(this._stack=o),o}finally{u2=!1}}},timeout:function(a,o){var i=this;return a<1/0?new T(function(l,e){var t=setTimeout(function(){return e(new X.Timeout(o))},a);i.then(l,e).finally(clearTimeout.bind(null,t))}):this}});typeof Symbol<"u"&&Symbol.toStringTag&&ba(T.prototype,Symbol.toStringTag,"Dexie.Promise");M1.env=Zt();function Ut(a,o,i,l,e){this.onFulfilled=typeof a=="function"?a:null,this.onRejected=typeof o=="function"?o:null,this.resolve=i,this.reject=l,this.psd=e}D1(T,{all:function(){var a=ya.apply(null,arguments).map(xi);return new T(function(o,i){a.length===0&&o([]);var l=a.length;a.forEach(function(e,t){return T.resolve(e).then(function(s){a[t]=s,--l||o(a)},i)})})},resolve:function(a){if(a instanceof T)return a;if(a&&typeof a.then=="function")return new T(function(i,l){a.then(i,l)});var o=new T(Fo,!0,a);return Yt(o,W2),o},reject:Xo,race:function(){var a=ya.apply(null,arguments).map(xi);return new T(function(o,i){a.map(function(l){return T.resolve(l).then(o,i)})})},PSD:{get:function(){return U},set:function(a){return U=a}},totalEchoes:{get:function(){return ki}},newPSD:qa,usePSD:Q1,scheduler:{get:function(){return wo},set:function(a){wo=a}},rejectionMapper:{get:function(){return g2},set:function(a){g2=a}},follow:function(a,o){return new T(function(i,l){return qa(function(e,t){var s=U;s.unhandleds=[],s.onunhandled=t,s.finalize=m1(function(){var n=this;PS(function(){n.unhandleds.length===0?e():t(n.unhandleds[0])})},s.finalize),a()},o,i,l)})}});Uo&&(Uo.allSettled&&ba(T,"allSettled",function(){var a=ya.apply(null,arguments).map(xi);return new T(function(o){a.length===0&&o([]);var i=a.length,l=new Array(i);a.forEach(function(e,t){return T.resolve(e).then(function(s){return l[t]={status:"fulfilled",value:s}},function(s){return l[t]={status:"rejected",reason:s}}).then(function(){return--i||o(l)})})})}),Uo.any&&typeof AggregateError<"u"&&ba(T,"any",function(){var a=ya.apply(null,arguments).map(xi);return new T(function(o,i){a.length===0&&i(new AggregateError([]));var l=a.length,e=new Array(l);a.forEach(function(t,s){return T.resolve(t).then(function(n){return o(n)},function(n){e[s]=n,--l||i(new AggregateError(e))})})})}));function Vt(a,o){try{o(function(i){if(a._state===null){if(i===a)throw new TypeError("A promise cannot be resolved with itself.");var l=a._lib&&Co();i&&typeof i.then=="function"?Vt(a,function(e,t){i instanceof T?i._then(e,t):i.then(e,t)}):(a._state=!0,a._value=i,qt(a)),l&&Eo()}},B2.bind(null,a))}catch(i){B2(a,i)}}function B2(a,o){if(Vo.push(o),a._state===null){var i=a._lib&&Co();o=g2(o),a._state=!1,a._value=o,ja&&o!==null&&typeof o=="object"&&!o._promise&&SS(function(){var l=tl(o,"stack");o._promise=a,ba(o,"stack",{get:function(){return u2?l&&(l.get?l.get.apply(o):l.value):a.stack}})}),zS(a),qt(a),i&&Eo()}}function qt(a){var o=a._listeners;a._listeners=[];for(var i=0,l=o.length;i<l;++i)cl(a,o[i]);var e=a._PSD;--e.ref||e.finalize(),F1===0&&(++F1,wo(function(){--F1===0&&Fl()},[]))}function cl(a,o){if(a._state===null){a._listeners.push(o);return}var i=a._state?o.onFulfilled:o.onRejected;if(i===null)return(a._state?o.resolve:o.reject)(a._value);++o.psd.ref,++F1,wo(ES,[i,a,o])}function ES(a,o,i){try{W2=o;var l,e=o._value;o._state?l=a(e):(Vo.length&&(Vo=[]),l=a(e),Vo.indexOf(e)===-1&&bS(o)),i.resolve(l)}catch(t){i.reject(t)}finally{W2=null,--F1===0&&Fl(),--i.psd.ref||i.psd.finalize()}}function Xt(a,o,i){if(o.length===i)return o;var l="";if(a._state===!1){var e=a._value,t,s;e!=null?(t=e.name||"Error",s=e.message||e,l=m2(e,0)):(t=e,s=""),o.push(t+(s?": "+s:"")+l)}return ja&&(l=m2(a._stackHolder,2),l&&o.indexOf(l)===-1&&o.push(l),a._prev&&Xt(a._prev,o,i)),o}function Yt(a,o){var i=o?o._numPrev+1:0;i<BS&&(a._prev=o,a._numPrev=i)}function Do(){Co()&&Eo()}function Co(){var a=f2;return f2=!1,Si=!1,a}function Eo(){var a,o,i;do for(;J1.length>0;)for(a=J1,J1=[],i=a.length,o=0;o<i;++o){var l=a[o];l[0].apply(null,l[1])}while(J1.length>0);f2=!0,Si=!0}function Fl(){var a=c1;c1=[],a.forEach(function(l){l._PSD.onunhandled.call(null,l._value,l)});for(var o=qo.slice(0),i=o.length;i;)o[--i]()}function PS(a){function o(){a(),qo.splice(qo.indexOf(o),1)}qo.push(o),++F1,wo(function(){--F1===0&&Fl()},[])}function zS(a){c1.some(function(o){return o._value===a._value})||c1.push(a)}function bS(a){for(var o=c1.length;o;)if(c1[--o]._value===a._value){c1.splice(o,1);return}}function Xo(a){return new T(Fo,!1,a)}function W0(a,o){var i=U;return function(){var l=Co(),e=U;try{return Xa(i,!0),a.apply(this,arguments)}catch(t){o&&o(t)}finally{Xa(e,!1),l&&Eo()}}}var D0={awaits:0,echoes:0,id:0},MS=0,Yo=[],Li=0,ki=0,vS=0;function qa(a,o,i,l){var e=U,t=Object.create(e);t.parent=e,t.ref=0,t.global=!1,t.id=++vS;var s=M1.env;t.env=rl?{Promise:T,PromiseProp:{value:T,configurable:!0,writable:!0},all:T.all,race:T.race,allSettled:T.allSettled,any:T.any,resolve:T.resolve,reject:T.reject,nthen:Fe(s.nthen,t),gthen:Fe(s.gthen,t)}:{},o&&A0(t,o),++e.ref,t.finalize=function(){--this.parent.ref||this.parent.finalize()};var n=Q1(t,a,i,l);return t.ref===0&&t.finalize(),n}function I1(){return D0.id||(D0.id=++MS),++D0.awaits,D0.echoes+=$t,D0.id}function Ma(){return D0.awaits?(--D0.awaits===0&&(D0.id=0),D0.echoes=D0.awaits*$t,!0):!1}(""+Nt).indexOf("[native code]")===-1&&(I1=Ma=m0);function xi(a){return D0.echoes&&a&&a.constructor===Uo?(I1(),a.then(function(o){return Ma(),o},function(o){return Ma(),E0(o)})):a}function _S(a){++ki,(!D0.echoes||--D0.echoes===0)&&(D0.echoes=D0.id=0),Yo.push(U),Xa(a,!0)}function GS(){var a=Yo[Yo.length-1];Yo.pop(),Xa(a,!1)}function Xa(a,o){var i=U;if((o?D0.echoes&&(!Li++||a!==U):Li&&(!--Li||a!==U))&&Jt(o?_S.bind(null,a):GS),a!==U&&(U=a,i===M1&&(M1.env=Zt()),rl)){var l=M1.env.Promise,e=a.env;ni.then=e.nthen,l.prototype.then=e.gthen,(i.global||a.global)&&(Object.defineProperty(u0,"Promise",e.PromiseProp),l.all=e.all,l.race=e.race,l.resolve=e.resolve,l.reject=e.reject,e.allSettled&&(l.allSettled=e.allSettled),e.any&&(l.any=e.any))}}function Zt(){var a=u0.Promise;return rl?{Promise:a,PromiseProp:Object.getOwnPropertyDescriptor(u0,"Promise"),all:a.all,race:a.race,allSettled:a.allSettled,any:a.any,resolve:a.resolve,reject:a.reject,nthen:ni.then,gthen:a.prototype.then}:{}}function Q1(a,o,i,l,e){var t=U;try{return Xa(a,!0),o(i,l,e)}finally{Xa(t,!1)}}function Jt(a){Nt.call(j2,a)}function ri(a,o,i,l){return typeof a!="function"?a:function(){var e=U;i&&I1(),Xa(o,!0);try{return a.apply(this,arguments)}finally{Xa(e,!1),l&&Jt(Ma)}}}function Fe(a,o){return function(i,l){return a.call(this,ri(i,o),ri(l,o))}}var de="unhandledrejection";function we(a,o){var i;try{i=o.onuncatched(a)}catch{}if(i!==!1)try{var l,e={promise:o,reason:a};if(u0.document&&document.createEvent?(l=document.createEvent("Event"),l.initEvent(de,!0,!0),A0(l,e)):u0.CustomEvent&&(l=new CustomEvent(de,{detail:e}),A0(l,e)),l&&u0.dispatchEvent&&(dispatchEvent(l),!u0.PromiseRejectionEvent&&u0.onunhandledrejection))try{u0.onunhandledrejection(l)}catch{}ja&&l&&!l.defaultPrevented&&console.warn("Unhandled rejection: "+(a.stack||a))}catch{}}var E0=T.reject;function y2(a,o,i,l){if(!a.idbdb||!a._state.openComplete&&!U.letThrough&&!a._vip){if(a._state.openComplete)return E0(new X.DatabaseClosed(a._state.dbOpenError));if(!a._state.isBeingOpened){if(!a._options.autoOpen)return E0(new X.DatabaseClosed);a.open().catch(m0)}return a._state.dbReadyPromise.then(function(){return y2(a,o,i,l)})}else{var e=a._createTransaction(o,i,a._dbSchema);try{e.create(),a._state.PR1398_maxLoop=3}catch(t){return t.name===Sl.InvalidState&&a.isOpen()&&--a._state.PR1398_maxLoop>0?(console.warn("Dexie: Need to reopen db"),a._close(),a.open().then(function(){return y2(a,o,i,l)})):E0(t)}return e._promise(o,function(t,s){return qa(function(){return U.trans=e,l(t,s,e)})}).then(function(t){return e._completion.then(function(){return t})})}}var me="3.2.2",S1=String.fromCharCode(65535),C2=-1/0,fa="Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.",a5="String expected.",lo=[],Pi=typeof navigator<"u"&&/(MSIE|Trident|Edge)/.test(navigator.userAgent),HS=Pi,DS=Pi,o5=function(a){return!/(dexie\.js|dexie\.min\.js)/.test(a)},zi="__dbnames",Ai="readonly",Ii="readwrite";function j1(a,o){return a?o?function(){return a.apply(this,arguments)&&o.apply(this,arguments)}:a:o}var i5={type:3,lower:-1/0,lowerOpen:!1,upper:[[]],upperOpen:!1};function Oo(a){return typeof a=="string"&&!/\./.test(a)?function(o){return o[a]===void 0&&a in o&&(o=Bo(o),delete o[a]),o}:function(o){return o}}var OS=function(){function a(){}return a.prototype._trans=function(o,i,l){var e=this._tx||U.trans,t=this.name;function s(S,k,r){if(!r.schema[t])throw new X.NotFound("Table "+t+" not part of transaction");return i(r.idbtrans,r)}var n=Co();try{return e&&e.db===this.db?e===U.trans?e._promise(o,s,l):qa(function(){return e._promise(o,s,l)},{trans:e,transless:U.transless||U}):y2(this.db,o,[this.name],s)}finally{n&&Eo()}},a.prototype.get=function(o,i){var l=this;return o&&o.constructor===Object?this.where(o).first(i):this._trans("readonly",function(e){return l.core.get({trans:e,key:o}).then(function(t){return l.hook.reading.fire(t)})}).then(i)},a.prototype.where=function(o){if(typeof o=="string")return new this.db.WhereClause(this,o);if(O0(o))return new this.db.WhereClause(this,"["+o.join("+")+"]");var i=y0(o);if(i.length===1)return this.where(i[0]).equals(o[i[0]]);var l=this.schema.indexes.concat(this.schema.primKey).filter(function(r){return r.compound&&i.every(function(x){return r.keyPath.indexOf(x)>=0})&&r.keyPath.every(function(x){return i.indexOf(x)>=0})})[0];if(l&&this.db._maxKey!==S1)return this.where(l.name).equals(l.keyPath.map(function(r){return o[r]}));!l&&ja&&console.warn("The query "+JSON.stringify(o)+" on "+this.name+" would benefit of a "+("compound index ["+i.join("+")+"]"));var e=this.schema.idxByName,t=this.db._deps.indexedDB;function s(r,x){try{return t.cmp(r,x)===0}catch{return!1}}var n=i.reduce(function(r,x){var c=r[0],w=r[1],F=e[x],d=o[x];return[c||F,c||!F?j1(w,F&&F.multi?function(u){var B=Pa(u,x);return O0(B)&&B.some(function(W){return s(d,W)})}:function(u){return s(d,Pa(u,x))}):w]},[null,null]),S=n[0],k=n[1];return S?this.where(S.name).equals(o[S.keyPath]).filter(k):l?this.filter(k):this.where(i).equals("")},a.prototype.filter=function(o){return this.toCollection().and(o)},a.prototype.count=function(o){return this.toCollection().count(o)},a.prototype.offset=function(o){return this.toCollection().offset(o)},a.prototype.limit=function(o){return this.toCollection().limit(o)},a.prototype.each=function(o){return this.toCollection().each(o)},a.prototype.toArray=function(o){return this.toCollection().toArray(o)},a.prototype.toCollection=function(){return new this.db.Collection(new this.db.WhereClause(this))},a.prototype.orderBy=function(o){return new this.db.Collection(new this.db.WhereClause(this,O0(o)?"["+o.join("+")+"]":o))},a.prototype.reverse=function(){return this.toCollection().reverse()},a.prototype.mapToClass=function(o){this.schema.mappedClass=o;var i=function(l){if(!l)return l;var e=Object.create(o.prototype);for(var t in l)if(Y0(l,t))try{e[t]=l[t]}catch{}return e};return this.schema.readHook&&this.hook.reading.unsubscribe(this.schema.readHook),this.schema.readHook=i,this.hook("reading",i),o},a.prototype.defineClass=function(){function o(i){A0(this,i)}return this.mapToClass(o)},a.prototype.add=function(o,i){var l=this,e=this.schema.primKey,t=e.auto,s=e.keyPath,n=o;return s&&t&&(n=Oo(s)(o)),this._trans("readwrite",function(S){return l.core.mutate({trans:S,type:"add",keys:i!=null?[i]:null,values:[n]})}).then(function(S){return S.numFailures?T.reject(S.failures[0]):S.lastResult}).then(function(S){if(s)try{ka(o,s,S)}catch{}return S})},a.prototype.update=function(o,i){if(typeof o=="object"&&!O0(o)){var l=Pa(o,this.schema.primKey.keyPath);if(l===void 0)return E0(new X.InvalidArgument("Given object does not contain its primary key"));try{typeof i!="function"?y0(i).forEach(function(e){ka(o,e,i[e])}):i(o,{value:o,primKey:l})}catch{}return this.where(":id").equals(l).modify(i)}else return this.where(":id").equals(o).modify(i)},a.prototype.put=function(o,i){var l=this,e=this.schema.primKey,t=e.auto,s=e.keyPath,n=o;return s&&t&&(n=Oo(s)(o)),this._trans("readwrite",function(S){return l.core.mutate({trans:S,type:"put",values:[n],keys:i!=null?[i]:null})}).then(function(S){return S.numFailures?T.reject(S.failures[0]):S.lastResult}).then(function(S){if(s)try{ka(o,s,S)}catch{}return S})},a.prototype.delete=function(o){var i=this;return this._trans("readwrite",function(l){return i.core.mutate({trans:l,type:"delete",keys:[o]})}).then(function(l){return l.numFailures?T.reject(l.failures[0]):void 0})},a.prototype.clear=function(){var o=this;return this._trans("readwrite",function(i){return o.core.mutate({trans:i,type:"deleteRange",range:i5})}).then(function(i){return i.numFailures?T.reject(i.failures[0]):void 0})},a.prototype.bulkGet=function(o){var i=this;return this._trans("readonly",function(l){return i.core.getMany({keys:o,trans:l}).then(function(e){return e.map(function(t){return i.hook.reading.fire(t)})})})},a.prototype.bulkAdd=function(o,i,l){var e=this,t=Array.isArray(i)?i:void 0;l=l||(t?void 0:i);var s=l?l.allKeys:void 0;return this._trans("readwrite",function(n){var S=e.schema.primKey,k=S.auto,r=S.keyPath;if(r&&t)throw new X.InvalidArgument("bulkAdd(): keys argument invalid on tables with inbound keys");if(t&&t.length!==o.length)throw new X.InvalidArgument("Arguments objects and keys must have the same length");var x=o.length,c=r&&k?o.map(Oo(r)):o;return e.core.mutate({trans:n,type:"add",keys:t,values:c,wantResults:s}).then(function(w){var F=w.numFailures,d=w.results,u=w.lastResult,B=w.failures,W=s?d:u;if(F===0)return W;throw new io(e.name+".bulkAdd(): "+F+" of "+x+" operations failed",B)})})},a.prototype.bulkPut=function(o,i,l){var e=this,t=Array.isArray(i)?i:void 0;l=l||(t?void 0:i);var s=l?l.allKeys:void 0;return this._trans("readwrite",function(n){var S=e.schema.primKey,k=S.auto,r=S.keyPath;if(r&&t)throw new X.InvalidArgument("bulkPut(): keys argument invalid on tables with inbound keys");if(t&&t.length!==o.length)throw new X.InvalidArgument("Arguments objects and keys must have the same length");var x=o.length,c=r&&k?o.map(Oo(r)):o;return e.core.mutate({trans:n,type:"put",keys:t,values:c,wantResults:s}).then(function(w){var F=w.numFailures,d=w.results,u=w.lastResult,B=w.failures,W=s?d:u;if(F===0)return W;throw new io(e.name+".bulkPut(): "+F+" of "+x+" operations failed",B)})})},a.prototype.bulkDelete=function(o){var i=this,l=o.length;return this._trans("readwrite",function(e){return i.core.mutate({trans:e,type:"delete",keys:o})}).then(function(e){var t=e.numFailures,s=e.lastResult,n=e.failures;if(t===0)return s;throw new io(i.name+".bulkDelete(): "+t+" of "+l+" operations failed",n)})},a}();function Po(a){var o={},i=function(n,S){if(S){for(var k=arguments.length,r=new Array(k-1);--k;)r[k-1]=arguments[k];return o[n].subscribe.apply(null,r),a}else if(typeof n=="string")return o[n]};i.addEventType=t;for(var l=1,e=arguments.length;l<e;++l)t(arguments[l]);return i;function t(n,S,k){if(typeof n=="object")return s(n);S||(S=hS),k||(k=m0);var r={subscribers:[],fire:k,subscribe:function(x){r.subscribers.indexOf(x)===-1&&(r.subscribers.push(x),r.fire=S(r.fire,x))},unsubscribe:function(x){r.subscribers=r.subscribers.filter(function(c){return c!==x}),r.fire=r.subscribers.reduce(S,k)}};return o[n]=i[n]=r,r}function s(n){y0(n).forEach(function(S){var k=n[S];if(O0(k))t(S,n[S][0],n[S][1]);else if(k==="asap")var r=t(S,yo,function(){for(var c=arguments.length,w=new Array(c);c--;)w[c]=arguments[c];r.subscribers.forEach(function(F){Dt(function(){F.apply(null,w)})})});else throw new X.InvalidArgument("Invalid event config")})}}function zo(a,o){return L1(o).from({prototype:a}),o}function RS(a){return zo(OS.prototype,function(i,l,e){this.db=a,this._tx=e,this.name=i,this.schema=l,this.hook=a._allTables[i]?a._allTables[i].hook:Po(null,{creating:[fS,m0],reading:[uS,yo],updating:[gS,m0],deleting:[WS,m0]})})}function h1(a,o){return!(a.filter||a.algorithm||a.or)&&(o?a.justLimit:!a.replayFilter)}function Qi(a,o){a.filter=j1(a.filter,o)}function Ki(a,o,i){var l=a.replayFilter;a.replayFilter=l?function(){return j1(l(),o())}:o,a.justLimit=i&&!l}function TS(a,o){a.isMatch=j1(a.isMatch,o)}function Zo(a,o){if(a.isPrimKey)return o.primaryKey;var i=o.getIndexByKeyPath(a.index);if(!i)throw new X.Schema("KeyPath "+a.index+" on object store "+o.name+" is not indexed");return i}function je(a,o,i){var l=Zo(a,o.schema);return o.openCursor({trans:i,values:!a.keysOnly,reverse:a.dir==="prev",unique:!!a.unique,query:{index:l,range:a.range}})}function Ro(a,o,i,l){var e=a.replayFilter?j1(a.filter,a.replayFilter()):a.filter;if(a.or){var t={},s=function(n,S,k){if(!e||e(S,k,function(c){return S.stop(c)},function(c){return S.fail(c)})){var r=S.primaryKey,x=""+r;x==="[object ArrayBuffer]"&&(x=""+new Uint8Array(r)),Y0(t,x)||(t[x]=!0,o(n,S,k))}};return Promise.all([a.or._iterate(s,i),pe(je(a,l,i),a.algorithm,s,!a.keysOnly&&a.valueMapper)])}else return pe(je(a,l,i),j1(a.algorithm,e),o,!a.keysOnly&&a.valueMapper)}function pe(a,o,i,l){var e=l?function(s,n,S){return i(l(s),n,S)}:i,t=W0(e);return a.then(function(s){if(s)return s.start(function(){var n=function(){return s.continue()};(!o||o(s,function(S){return n=S},function(S){s.stop(S),n=m0},function(S){s.fail(S),n=m0}))&&t(s.value,s,function(S){return n=S}),n()})})}function L0(a,o){try{var i=ue(a),l=ue(o);if(i!==l)return i==="Array"?1:l==="Array"?-1:i==="binary"?1:l==="binary"?-1:i==="string"?1:l==="string"?-1:i==="Date"?1:l!=="Date"?NaN:-1;switch(i){case"number":case"Date":case"string":return a>o?1:a<o?-1:0;case"binary":return AS(fe(a),fe(o));case"Array":return LS(a,o)}}catch{}return NaN}function LS(a,o){for(var i=a.length,l=o.length,e=i<l?i:l,t=0;t<e;++t){var s=L0(a[t],o[t]);if(s!==0)return s}return i===l?0:i<l?-1:1}function AS(a,o){for(var i=a.length,l=o.length,e=i<l?i:l,t=0;t<e;++t)if(a[t]!==o[t])return a[t]<o[t]?-1:1;return i===l?0:i<l?-1:1}function ue(a){var o=typeof a;if(o!=="object")return o;if(ArrayBuffer.isView(a))return"binary";var i=d2(a);return i==="ArrayBuffer"?"binary":i}function fe(a){return a instanceof Uint8Array?a:ArrayBuffer.isView(a)?new Uint8Array(a.buffer,a.byteOffset,a.byteLength):new Uint8Array(a)}var IS=function(){function a(){}return a.prototype._read=function(o,i){var l=this._ctx;return l.error?l.table._trans(null,E0.bind(null,l.error)):l.table._trans("readonly",o).then(i)},a.prototype._write=function(o){var i=this._ctx;return i.error?i.table._trans(null,E0.bind(null,i.error)):i.table._trans("readwrite",o,"locked")},a.prototype._addAlgorithm=function(o){var i=this._ctx;i.algorithm=j1(i.algorithm,o)},a.prototype._iterate=function(o,i){return Ro(this._ctx,o,i,this._ctx.table.core)},a.prototype.clone=function(o){var i=Object.create(this.constructor.prototype),l=Object.create(this._ctx);return o&&A0(l,o),i._ctx=l,i},a.prototype.raw=function(){return this._ctx.valueMapper=null,this},a.prototype.each=function(o){var i=this._ctx;return this._read(function(l){return Ro(i,o,l,i.table.core)})},a.prototype.count=function(o){var i=this;return this._read(function(l){var e=i._ctx,t=e.table.core;if(h1(e,!0))return t.count({trans:l,query:{index:Zo(e,t.schema),range:e.range}}).then(function(n){return Math.min(n,e.limit)});var s=0;return Ro(e,function(){return++s,!1},l,t).then(function(){return s})}).then(o)},a.prototype.sortBy=function(o,i){var l=o.split(".").reverse(),e=l[0],t=l.length-1;function s(k,r){return r?s(k[l[r]],r-1):k[e]}var n=this._ctx.dir==="next"?1:-1;function S(k,r){var x=s(k,t),c=s(r,t);return x<c?-n:x>c?n:0}return this.toArray(function(k){return k.sort(S)}).then(i)},a.prototype.toArray=function(o){var i=this;return this._read(function(l){var e=i._ctx;if(e.dir==="next"&&h1(e,!0)&&e.limit>0){var t=e.valueMapper,s=Zo(e,e.table.core.schema);return e.table.core.query({trans:l,limit:e.limit,values:!0,query:{index:s,range:e.range}}).then(function(S){var k=S.result;return t?k.map(t):k})}else{var n=[];return Ro(e,function(S){return n.push(S)},l,e.table.core).then(function(){return n})}},o)},a.prototype.offset=function(o){var i=this._ctx;return o<=0?this:(i.offset+=o,h1(i)?Ki(i,function(){var l=o;return function(e,t){return l===0?!0:l===1?(--l,!1):(t(function(){e.advance(l),l=0}),!1)}}):Ki(i,function(){var l=o;return function(){return--l<0}}),this)},a.prototype.limit=function(o){return this._ctx.limit=Math.min(this._ctx.limit,o),Ki(this._ctx,function(){var i=o;return function(l,e,t){return--i<=0&&e(t),i>=0}},!0),this},a.prototype.until=function(o,i){return Qi(this._ctx,function(l,e,t){return o(l.value)?(e(t),i):!0}),this},a.prototype.first=function(o){return this.limit(1).toArray(function(i){return i[0]}).then(o)},a.prototype.last=function(o){return this.reverse().first(o)},a.prototype.filter=function(o){return Qi(this._ctx,function(i){return o(i.value)}),TS(this._ctx,o),this},a.prototype.and=function(o){return this.filter(o)},a.prototype.or=function(o){return new this.db.WhereClause(this._ctx.table,o,this)},a.prototype.reverse=function(){return this._ctx.dir=this._ctx.dir==="prev"?"next":"prev",this._ondirectionchange&&this._ondirectionchange(this._ctx.dir),this},a.prototype.desc=function(){return this.reverse()},a.prototype.eachKey=function(o){var i=this._ctx;return i.keysOnly=!i.isMatch,this.each(function(l,e){o(e.key,e)})},a.prototype.eachUniqueKey=function(o){return this._ctx.unique="unique",this.eachKey(o)},a.prototype.eachPrimaryKey=function(o){var i=this._ctx;return i.keysOnly=!i.isMatch,this.each(function(l,e){o(e.primaryKey,e)})},a.prototype.keys=function(o){var i=this._ctx;i.keysOnly=!i.isMatch;var l=[];return this.each(function(e,t){l.push(t.key)}).then(function(){return l}).then(o)},a.prototype.primaryKeys=function(o){var i=this._ctx;if(i.dir==="next"&&h1(i,!0)&&i.limit>0)return this._read(function(e){var t=Zo(i,i.table.core.schema);return i.table.core.query({trans:e,values:!1,limit:i.limit,query:{index:t,range:i.range}})}).then(function(e){var t=e.result;return t}).then(o);i.keysOnly=!i.isMatch;var l=[];return this.each(function(e,t){l.push(t.primaryKey)}).then(function(){return l}).then(o)},a.prototype.uniqueKeys=function(o){return this._ctx.unique="unique",this.keys(o)},a.prototype.firstKey=function(o){return this.limit(1).keys(function(i){return i[0]}).then(o)},a.prototype.lastKey=function(o){return this.reverse().firstKey(o)},a.prototype.distinct=function(){var o=this._ctx,i=o.index&&o.table.schema.idxByName[o.index];if(!i||!i.multi)return this;var l={};return Qi(this._ctx,function(e){var t=e.primaryKey.toString(),s=Y0(l,t);return l[t]=!0,!s}),this},a.prototype.modify=function(o){var i=this,l=this._ctx;return this._write(function(e){var t;if(typeof o=="function")t=o;else{var s=y0(o),n=s.length;t=function(B){for(var W=!1,f=0;f<n;++f){var h=s[f],g=o[h];Pa(B,h)!==g&&(ka(B,h,g),W=!0)}return W}}var S=l.table.core,k=S.schema.primaryKey,r=k.outbound,x=k.extractKey,c=i.db._options.modifyChunkSize||200,w=[],F=0,d=[],u=function(B,W){var f=W.failures,h=W.numFailures;F+=B-h;for(var g=0,E=y0(f);g<E.length;g++){var O=E[g];w.push(f[O])}};return i.clone().primaryKeys().then(function(B){var W=function(f){var h=Math.min(c,B.length-f);return S.getMany({trans:e,keys:B.slice(f,f+h),cache:"immutable"}).then(function(g){for(var E=[],O=[],y=r?[]:null,v=[],D=0;D<h;++D){var I=g[D],M={value:Bo(I),primKey:B[f+D]};t.call(M,M.value,M)!==!1&&(M.value==null?v.push(B[f+D]):!r&&L0(x(I),x(M.value))!==0?(v.push(B[f+D]),E.push(M.value)):(O.push(M.value),r&&y.push(B[f+D])))}var A=h1(l)&&l.limit===1/0&&(typeof o!="function"||o===$i)&&{index:l.index,range:l.range};return Promise.resolve(E.length>0&&S.mutate({trans:e,type:"add",values:E}).then(function(n0){for(var q in n0.failures)v.splice(parseInt(q),1);u(E.length,n0)})).then(function(){return(O.length>0||A&&typeof o=="object")&&S.mutate({trans:e,type:"put",keys:y,values:O,criteria:A,changeSpec:typeof o!="function"&&o}).then(function(n0){return u(O.length,n0)})}).then(function(){return(v.length>0||A&&o===$i)&&S.mutate({trans:e,type:"delete",keys:v,criteria:A}).then(function(n0){return u(v.length,n0)})}).then(function(){return B.length>f+h&&W(f+c)})})};return W(0).then(function(){if(w.length>0)throw new si("Error modifying one or more objects",w,F,d);return B.length})})})},a.prototype.delete=function(){var o=this._ctx,i=o.range;return h1(o)&&(o.isPrimKey&&!DS||i.type===3)?this._write(function(l){var e=o.table.core.schema.primaryKey,t=i;return o.table.core.count({trans:l,query:{index:e,range:t}}).then(function(s){return o.table.core.mutate({trans:l,type:"deleteRange",range:t}).then(function(n){var S=n.failures;n.lastResult,n.results;var k=n.numFailures;if(k)throw new si("Could not delete some values",Object.keys(S).map(function(r){return S[r]}),s-k);return s-k})})}):this.modify($i)},a}(),$i=function(a,o){return o.value=null};function QS(a){return zo(IS.prototype,function(i,l){this.db=a;var e=i5,t=null;if(l)try{e=l()}catch(k){t=k}var s=i._ctx,n=s.table,S=n.hook.reading.fire;this._ctx={table:n,index:s.index,isPrimKey:!s.index||n.schema.primKey.keyPath&&s.index===n.schema.primKey.name,range:e,keysOnly:!1,dir:"next",unique:"",algorithm:null,filter:null,replayFilter:null,justLimit:!0,isMatch:null,offset:0,limit:1/0,error:t,or:s.or,valueMapper:S!==yo?S:null}})}function KS(a,o){return a<o?-1:a===o?0:1}function $S(a,o){return a>o?-1:a===o?0:1}function V0(a,o,i){var l=a instanceof e5?new a.Collection(a):a;return l._ctx.error=i?new i(o):new TypeError(o),l}function B1(a){return new a.Collection(a,function(){return l5("")}).limit(0)}function NS(a){return a==="next"?function(o){return o.toUpperCase()}:function(o){return o.toLowerCase()}}function US(a){return a==="next"?function(o){return o.toLowerCase()}:function(o){return o.toUpperCase()}}function VS(a,o,i,l,e,t){for(var s=Math.min(a.length,l.length),n=-1,S=0;S<s;++S){var k=o[S];if(k!==l[S])return e(a[S],i[S])<0?a.substr(0,S)+i[S]+i.substr(S+1):e(a[S],l[S])<0?a.substr(0,S)+l[S]+i.substr(S+1):n>=0?a.substr(0,n)+o[n]+i.substr(n+1):null;e(a[S],k)<0&&(n=S)}return s<l.length&&t==="next"?a+i.substr(a.length):s<a.length&&t==="prev"?a.substr(0,i.length):n<0?null:a.substr(0,n)+l[n]+i.substr(n+1)}function To(a,o,i,l){var e,t,s,n,S,k,r,x=i.length;if(!i.every(function(d){return typeof d=="string"}))return V0(a,a5);function c(d){e=NS(d),t=US(d),s=d==="next"?KS:$S;var u=i.map(function(B){return{lower:t(B),upper:e(B)}}).sort(function(B,W){return s(B.lower,W.lower)});n=u.map(function(B){return B.upper}),S=u.map(function(B){return B.lower}),k=d,r=d==="next"?"":l}c("next");var w=new a.Collection(a,function(){return Da(n[0],S[x-1]+l)});w._ondirectionchange=function(d){c(d)};var F=0;return w._addAlgorithm(function(d,u,B){var W=d.key;if(typeof W!="string")return!1;var f=t(W);if(o(f,S,F))return!0;for(var h=null,g=F;g<x;++g){var E=VS(W,f,n[g],S[g],s,k);E===null&&h===null?F=g+1:(h===null||s(h,E)>0)&&(h=E)}return u(h!==null?function(){d.continue(h+r)}:B),!1}),w}function Da(a,o,i,l){return{type:2,lower:a,upper:o,lowerOpen:i,upperOpen:l}}function l5(a){return{type:1,lower:a,upper:a}}var e5=function(){function a(){}return Object.defineProperty(a.prototype,"Collection",{get:function(){return this._ctx.table.db.Collection},enumerable:!1,configurable:!0}),a.prototype.between=function(o,i,l,e){l=l!==!1,e=e===!0;try{return this._cmp(o,i)>0||this._cmp(o,i)===0&&(l||e)&&!(l&&e)?B1(this):new this.Collection(this,function(){return Da(o,i,!l,!e)})}catch{return V0(this,fa)}},a.prototype.equals=function(o){return o==null?V0(this,fa):new this.Collection(this,function(){return l5(o)})},a.prototype.above=function(o){return o==null?V0(this,fa):new this.Collection(this,function(){return Da(o,void 0,!0)})},a.prototype.aboveOrEqual=function(o){return o==null?V0(this,fa):new this.Collection(this,function(){return Da(o,void 0,!1)})},a.prototype.below=function(o){return o==null?V0(this,fa):new this.Collection(this,function(){return Da(void 0,o,!1,!0)})},a.prototype.belowOrEqual=function(o){return o==null?V0(this,fa):new this.Collection(this,function(){return Da(void 0,o)})},a.prototype.startsWith=function(o){return typeof o!="string"?V0(this,a5):this.between(o,o+S1,!0,!0)},a.prototype.startsWithIgnoreCase=function(o){return o===""?this.startsWith(o):To(this,function(i,l){return i.indexOf(l[0])===0},[o],S1)},a.prototype.equalsIgnoreCase=function(o){return To(this,function(i,l){return i===l[0]},[o],"")},a.prototype.anyOfIgnoreCase=function(){var o=ya.apply(y1,arguments);return o.length===0?B1(this):To(this,function(i,l){return l.indexOf(i)!==-1},o,"")},a.prototype.startsWithAnyOfIgnoreCase=function(){var o=ya.apply(y1,arguments);return o.length===0?B1(this):To(this,function(i,l){return l.some(function(e){return i.indexOf(e)===0})},o,S1)},a.prototype.anyOf=function(){var o=this,i=ya.apply(y1,arguments),l=this._cmp;try{i.sort(l)}catch{return V0(this,fa)}if(i.length===0)return B1(this);var e=new this.Collection(this,function(){return Da(i[0],i[i.length-1])});e._ondirectionchange=function(s){l=s==="next"?o._ascending:o._descending,i.sort(l)};var t=0;return e._addAlgorithm(function(s,n,S){for(var k=s.key;l(k,i[t])>0;)if(++t,t===i.length)return n(S),!1;return l(k,i[t])===0?!0:(n(function(){s.continue(i[t])}),!1)}),e},a.prototype.notEqual=function(o){return this.inAnyRange([[C2,o],[o,this.db._maxKey]],{includeLowers:!1,includeUppers:!1})},a.prototype.noneOf=function(){var o=ya.apply(y1,arguments);if(o.length===0)return new this.Collection(this);try{o.sort(this._ascending)}catch{return V0(this,fa)}var i=o.reduce(function(l,e){return l?l.concat([[l[l.length-1][1],e]]):[[C2,e]]},null);return i.push([o[o.length-1],this.db._maxKey]),this.inAnyRange(i,{includeLowers:!1,includeUppers:!1})},a.prototype.inAnyRange=function(o,i){var l=this,e=this._cmp,t=this._ascending,s=this._descending,n=this._min,S=this._max;if(o.length===0)return B1(this);if(!o.every(function(g){return g[0]!==void 0&&g[1]!==void 0&&t(g[0],g[1])<=0}))return V0(this,"First argument to inAnyRange() must be an Array of two-value Arrays [lower,upper] where upper must not be lower than lower",X.InvalidArgument);var k=!i||i.includeLowers!==!1,r=i&&i.includeUppers===!0;function x(g,E){for(var O=0,y=g.length;O<y;++O){var v=g[O];if(e(E[0],v[1])<0&&e(E[1],v[0])>0){v[0]=n(v[0],E[0]),v[1]=S(v[1],E[1]);break}}return O===y&&g.push(E),g}var c=t;function w(g,E){return c(g[0],E[0])}var F;try{F=o.reduce(x,[]),F.sort(w)}catch{return V0(this,fa)}var d=0,u=r?function(g){return t(g,F[d][1])>0}:function(g){return t(g,F[d][1])>=0},B=k?function(g){return s(g,F[d][0])>0}:function(g){return s(g,F[d][0])>=0};function W(g){return!u(g)&&!B(g)}var f=u,h=new this.Collection(this,function(){return Da(F[0][0],F[F.length-1][1],!k,!r)});return h._ondirectionchange=function(g){g==="next"?(f=u,c=t):(f=B,c=s),F.sort(w)},h._addAlgorithm(function(g,E,O){for(var y=g.key;f(y);)if(++d,d===F.length)return E(O),!1;return W(y)?!0:(l._cmp(y,F[d][1])===0||l._cmp(y,F[d][0])===0||E(function(){c===t?g.continue(F[d][0]):g.continue(F[d][1])}),!1)}),h},a.prototype.startsWithAnyOf=function(){var o=ya.apply(y1,arguments);return o.every(function(i){return typeof i=="string"})?o.length===0?B1(this):this.inAnyRange(o.map(function(i){return[i,i+S1]})):V0(this,"startsWithAnyOf() only works with strings")},a}();function qS(a){return zo(e5.prototype,function(i,l,e){this.db=a,this._ctx={table:i,index:l===":id"?null:l,or:e};var t=a._deps.indexedDB;if(!t)throw new X.MissingAPI;this._cmp=this._ascending=t.cmp.bind(t),this._descending=function(s,n){return t.cmp(n,s)},this._max=function(s,n){return t.cmp(s,n)>0?s:n},this._min=function(s,n){return t.cmp(s,n)<0?s:n},this._IDBKeyRange=a._deps.IDBKeyRange})}function Fa(a){return W0(function(o){return mo(o),a(o.target.error),!1})}function mo(a){a.stopPropagation&&a.stopPropagation(),a.preventDefault&&a.preventDefault()}var jo="storagemutated",La="x-storagemutated-1",Ya=Po(null,jo),XS=function(){function a(){}return a.prototype._lock=function(){return Z1(!U.global),++this._reculock,this._reculock===1&&!U.global&&(U.lockOwnerFor=this),this},a.prototype._unlock=function(){if(Z1(!U.global),--this._reculock===0)for(U.global||(U.lockOwnerFor=null);this._blockedFuncs.length>0&&!this._locked();){var o=this._blockedFuncs.shift();try{Q1(o[1],o[0])}catch{}}return this},a.prototype._locked=function(){return this._reculock&&U.lockOwnerFor!==this},a.prototype.create=function(o){var i=this;if(!this.mode)return this;var l=this.db.idbdb,e=this.db._state.dbOpenError;if(Z1(!this.idbtrans),!o&&!l)switch(e&&e.name){case"DatabaseClosedError":throw new X.DatabaseClosed(e);case"MissingAPIError":throw new X.MissingAPI(e.message,e);default:throw new X.OpenFailed(e)}if(!this.active)throw new X.TransactionInactive;return Z1(this._completion._state===null),o=this.idbtrans=o||(this.db.core?this.db.core.transaction(this.storeNames,this.mode,{durability:this.chromeTransactionDurability}):l.transaction(this.storeNames,this.mode,{durability:this.chromeTransactionDurability})),o.onerror=W0(function(t){mo(t),i._reject(o.error)}),o.onabort=W0(function(t){mo(t),i.active&&i._reject(new X.Abort(o.error)),i.active=!1,i.on("abort").fire(t)}),o.oncomplete=W0(function(){i.active=!1,i._resolve(),"mutatedParts"in o&&Ya.storagemutated.fire(o.mutatedParts)}),this},a.prototype._promise=function(o,i,l){var e=this;if(o==="readwrite"&&this.mode!=="readwrite")return E0(new X.ReadOnly("Transaction is readonly"));if(!this.active)return E0(new X.TransactionInactive);if(this._locked())return new T(function(s,n){e._blockedFuncs.push([function(){e._promise(o,i,l).then(s,n)},U])});if(l)return qa(function(){var s=new T(function(n,S){e._lock();var k=i(n,S,e);k&&k.then&&k.then(n,S)});return s.finally(function(){return e._unlock()}),s._lib=!0,s});var t=new T(function(s,n){var S=i(s,n,e);S&&S.then&&S.then(s,n)});return t._lib=!0,t},a.prototype._root=function(){return this.parent?this.parent._root():this},a.prototype.waitFor=function(o){var i=this._root(),l=T.resolve(o);if(i._waitingFor)i._waitingFor=i._waitingFor.then(function(){return l});else{i._waitingFor=l,i._waitingQueue=[];var e=i.idbtrans.objectStore(i.storeNames[0]);(function s(){for(++i._spinCount;i._waitingQueue.length;)i._waitingQueue.shift()();i._waitingFor&&(e.get(-1/0).onsuccess=s)})()}var t=i._waitingFor;return new T(function(s,n){l.then(function(S){return i._waitingQueue.push(W0(s.bind(null,S)))},function(S){return i._waitingQueue.push(W0(n.bind(null,S)))}).finally(function(){i._waitingFor===t&&(i._waitingFor=null)})})},a.prototype.abort=function(){this.active&&(this.active=!1,this.idbtrans&&this.idbtrans.abort(),this._reject(new X.Abort))},a.prototype.table=function(o){var i=this._memoizedTables||(this._memoizedTables={});if(Y0(i,o))return i[o];var l=this.schema[o];if(!l)throw new X.NotFound("Table "+o+" not part of transaction");var e=new this.db.Table(o,l,this);return e.core=this.db.core.table(o),i[o]=e,e},a}();function YS(a){return zo(XS.prototype,function(i,l,e,t,s){var n=this;this.db=a,this.mode=i,this.storeNames=l,this.schema=e,this.chromeTransactionDurability=t,this.idbtrans=null,this.on=Po(this,"complete","error","abort"),this.parent=s||null,this.active=!0,this._reculock=0,this._blockedFuncs=[],this._resolve=null,this._reject=null,this._waitingFor=null,this._waitingQueue=null,this._spinCount=0,this._completion=new T(function(S,k){n._resolve=S,n._reject=k}),this._completion.then(function(){n.active=!1,n.on.complete.fire()},function(S){var k=n.active;return n.active=!1,n.on.error.fire(S),n.parent?n.parent._reject(S):k&&n.idbtrans&&n.idbtrans.abort(),E0(S)})})}function E2(a,o,i,l,e,t,s){return{name:a,keyPath:o,unique:i,multi:l,auto:e,compound:t,src:(i&&!s?"&":"")+(l?"*":"")+(e?"++":"")+t5(o)}}function t5(a){return typeof a=="string"?a:a?"["+[].join.call(a,"+")+"]":""}function s5(a,o,i){return{name:a,primKey:o,indexes:i,mappedClass:null,idxByName:Ot(i,function(l){return[l.name,l]})}}function ZS(a){return a.length===1?a[0]:a}var po=function(a){try{return a.only([[]]),po=function(){return[[]]},[[]]}catch{return po=function(){return S1},S1}};function P2(a){return a==null?function(){}:typeof a=="string"?JS(a):function(o){return Pa(o,a)}}function JS(a){var o=a.split(".");return o.length===1?function(i){return i[a]}:function(i){return Pa(i,a)}}function We(a){return[].slice.call(a)}var ak=0;function eo(a){return a==null?":id":typeof a=="string"?a:"["+a.join("+")+"]"}function ok(a,o,i){function l(x,c){var w=We(x.objectStoreNames);return{schema:{name:x.name,tables:w.map(function(F){return c.objectStore(F)}).map(function(F){var d=F.keyPath,u=F.autoIncrement,B=O0(d),W=d==null,f={},h={name:F.name,primaryKey:{name:null,isPrimaryKey:!0,outbound:W,compound:B,keyPath:d,autoIncrement:u,unique:!0,extractKey:P2(d)},indexes:We(F.indexNames).map(function(g){return F.index(g)}).map(function(g){var E=g.name,O=g.unique,y=g.multiEntry,v=g.keyPath,D=O0(v),I={name:E,compound:D,keyPath:v,unique:O,multiEntry:y,extractKey:P2(v)};return f[eo(v)]=I,I}),getIndexByKeyPath:function(g){return f[eo(g)]}};return f[":id"]=h.primaryKey,d!=null&&(f[eo(d)]=h.primaryKey),h})},hasGetAll:w.length>0&&"getAll"in c.objectStore(w[0])&&!(typeof navigator<"u"&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1]<604)}}function e(x){if(x.type===3)return null;if(x.type===4)throw new Error("Cannot convert never type to IDBKeyRange");var c=x.lower,w=x.upper,F=x.lowerOpen,d=x.upperOpen,u=c===void 0?w===void 0?null:o.upperBound(w,!!d):w===void 0?o.lowerBound(c,!!F):o.bound(c,w,!!F,!!d);return u}function t(x){var c=x.name;function w(u){var B=u.trans,W=u.type,f=u.keys,h=u.values,g=u.range;return new Promise(function(E,O){E=W0(E);var y=B.objectStore(c),v=y.keyPath==null,D=W==="put"||W==="add";if(!D&&W!=="delete"&&W!=="deleteRange")throw new Error("Invalid operation type: "+W);var I=(f||h||{length:1}).length;if(f&&h&&f.length!==h.length)throw new Error("Given keys array must have same length as given values array.");if(I===0)return E({numFailures:0,failures:{},results:[],lastResult:void 0});var M,A=[],n0=[],q=0,r0=function(b0){++q,mo(b0)};if(W==="deleteRange"){if(g.type===4)return E({numFailures:q,failures:n0,results:[],lastResult:void 0});g.type===3?A.push(M=y.clear()):A.push(M=y.delete(e(g)))}else{var l0=D?v?[h,f]:[h,null]:[f,null],e0=l0[0],h0=l0[1];if(D)for(var _0=0;_0<I;++_0)A.push(M=h0&&h0[_0]!==void 0?y[W](e0[_0],h0[_0]):y[W](e0[_0])),M.onerror=r0;else for(var _0=0;_0<I;++_0)A.push(M=y[W](e0[_0])),M.onerror=r0}var I0=function(b0){var Q0=b0.target.result;A.forEach(function(K0,f1){return K0.error!=null&&(n0[f1]=K0.error)}),E({numFailures:q,failures:n0,results:W==="delete"?f:A.map(function(K0){return K0.result}),lastResult:Q0})};M.onerror=function(b0){r0(b0),I0(b0)},M.onsuccess=I0})}function F(u){var B=u.trans,W=u.values,f=u.query,h=u.reverse,g=u.unique;return new Promise(function(E,O){E=W0(E);var y=f.index,v=f.range,D=B.objectStore(c),I=y.isPrimaryKey?D:D.index(y.name),M=h?g?"prevunique":"prev":g?"nextunique":"next",A=W||!("openKeyCursor"in I)?I.openCursor(e(v),M):I.openKeyCursor(e(v),M);A.onerror=Fa(O),A.onsuccess=W0(function(n0){var q=A.result;if(!q){E(null);return}q.___id=++ak,q.done=!1;var r0=q.continue.bind(q),l0=q.continuePrimaryKey;l0&&(l0=l0.bind(q));var e0=q.advance.bind(q),h0=function(){throw new Error("Cursor not started")},_0=function(){throw new Error("Cursor not stopped")};q.trans=B,q.stop=q.continue=q.continuePrimaryKey=q.advance=h0,q.fail=W0(O),q.next=function(){var I0=this,b0=1;return this.start(function(){return b0--?I0.continue():I0.stop()}).then(function(){return I0})},q.start=function(I0){var b0=new Promise(function(K0,f1){K0=W0(K0),A.onerror=Fa(f1),q.fail=f1,q.stop=function(bi){q.stop=q.continue=q.continuePrimaryKey=q.advance=_0,K0(bi)}}),Q0=function(){if(A.result)try{I0()}catch(K0){q.fail(K0)}else q.done=!0,q.start=function(){throw new Error("Cursor behind last entry")},q.stop()};return A.onsuccess=W0(function(K0){A.onsuccess=Q0,Q0()}),q.continue=r0,q.continuePrimaryKey=l0,q.advance=e0,Q0(),b0},E(q)},O)})}function d(u){return function(B){return new Promise(function(W,f){W=W0(W);var h=B.trans,g=B.values,E=B.limit,O=B.query,y=E===1/0?void 0:E,v=O.index,D=O.range,I=h.objectStore(c),M=v.isPrimaryKey?I:I.index(v.name),A=e(D);if(E===0)return W({result:[]});if(u){var n0=g?M.getAll(A,y):M.getAllKeys(A,y);n0.onsuccess=function(e0){return W({result:e0.target.result})},n0.onerror=Fa(f)}else{var q=0,r0=g||!("openKeyCursor"in M)?M.openCursor(A):M.openKeyCursor(A),l0=[];r0.onsuccess=function(e0){var h0=r0.result;if(!h0)return W({result:l0});if(l0.push(g?h0.value:h0.primaryKey),++q===E)return W({result:l0});h0.continue()},r0.onerror=Fa(f)}})}}return{name:c,schema:x,mutate:w,getMany:function(u){var B=u.trans,W=u.keys;return new Promise(function(f,h){f=W0(f);for(var g=B.objectStore(c),E=W.length,O=new Array(E),y=0,v=0,D,I=function(q){var r0=q.target;(O[r0._pos]=r0.result)!=null,++v===y&&f(O)},M=Fa(h),A=0;A<E;++A){var n0=W[A];n0!=null&&(D=g.get(W[A]),D._pos=A,D.onsuccess=I,D.onerror=M,++y)}y===0&&f(O)})},get:function(u){var B=u.trans,W=u.key;return new Promise(function(f,h){f=W0(f);var g=B.objectStore(c),E=g.get(W);E.onsuccess=function(O){return f(O.target.result)},E.onerror=Fa(h)})},query:d(S),openCursor:F,count:function(u){var B=u.query,W=u.trans,f=B.index,h=B.range;return new Promise(function(g,E){var O=W.objectStore(c),y=f.isPrimaryKey?O:O.index(f.name),v=e(h),D=v?y.count(v):y.count();D.onsuccess=W0(function(I){return g(I.target.result)}),D.onerror=Fa(E)})}}}var s=l(a,i),n=s.schema,S=s.hasGetAll,k=n.tables.map(function(x){return t(x)}),r={};return k.forEach(function(x){return r[x.name]=x}),{stack:"dbcore",transaction:a.transaction.bind(a),table:function(x){var c=r[x];if(!c)throw new Error("Table '"+x+"' not found");return r[x]},MIN_KEY:-1/0,MAX_KEY:po(o),schema:n}}function ik(a,o){return o.reduce(function(i,l){var e=l.create;return i0(i0({},i),e(i))},a)}function lk(a,o,i,l){var e=i.IDBKeyRange;i.indexedDB;var t=ik(ok(o,e,l),a.dbcore);return{dbcore:t}}function dl(a,o){var i=a._novip,l=o.db,e=lk(i._middlewares,l,i._deps,o);i.core=e.dbcore,i.tables.forEach(function(t){var s=t.name;i.core.schema.tables.some(function(n){return n.name===s})&&(t.core=i.core.table(s),i[s]instanceof i.Table&&(i[s].core=t.core))})}function ci(a,o,i,l){var e=a._novip;i.forEach(function(t){var s=l[t];o.forEach(function(n){var S=tl(n,t);(!S||"value"in S&&S.value===void 0)&&(n===e.Transaction.prototype||n instanceof e.Transaction?ba(n,t,{get:function(){return this.table(t)},set:function(k){Gt(this,t,{value:k,writable:!0,configurable:!0,enumerable:!0})}}):n[t]=new e.Table(t,s))})})}function z2(a,o){var i=a._novip;o.forEach(function(l){for(var e in l)l[e]instanceof i.Table&&delete l[e]})}function ek(a,o){return a._cfg.version-o._cfg.version}function tk(a,o,i,l){var e=a._dbSchema,t=a._createTransaction("readwrite",a._storeNames,e);t.create(i),t._completion.catch(l);var s=t._reject.bind(t),n=U.transless||U;qa(function(){U.trans=t,U.transless=n,o===0?(y0(e).forEach(function(S){wl(i,S,e[S].primKey,e[S].indexes)}),dl(a,i),T.follow(function(){return a.on.populate.fire(t)}).catch(s)):sk(a,o,t,i).catch(s)})}function sk(a,o,i,l){var e=a._novip,t=[],s=e._versions,n=e._dbSchema=ml(e,e.idbdb,l),S=!1,k=s.filter(function(x){return x._cfg.version>=o});k.forEach(function(x){t.push(function(){var c=n,w=x._cfg.dbschema;M2(e,c,l),M2(e,w,l),n=e._dbSchema=w;var F=n5(c,w);F.add.forEach(function(h){wl(l,h[0],h[1].primKey,h[1].indexes)}),F.change.forEach(function(h){if(h.recreate)throw new X.Upgrade("Not yet support for changing primary key");var g=l.objectStore(h.name);h.add.forEach(function(E){return b2(g,E)}),h.change.forEach(function(E){g.deleteIndex(E.name),b2(g,E)}),h.del.forEach(function(E){return g.deleteIndex(E)})});var d=x._cfg.contentUpgrade;if(d&&x._cfg.version>o){dl(e,l),i._memoizedTables={},S=!0;var u=Rt(w);F.del.forEach(function(h){u[h]=c[h]}),z2(e,[e.Transaction.prototype]),ci(e,[e.Transaction.prototype],y0(u),u),i.schema=u;var B=sl(d);B&&I1();var W,f=T.follow(function(){if(W=d(i),W&&B){var h=Ma.bind(null,null);W.then(h,h)}});return W&&typeof W.then=="function"?T.resolve(W):f.then(function(){return W})}}),t.push(function(c){if(!S||!HS){var w=x._cfg.dbschema;Sk(w,c)}z2(e,[e.Transaction.prototype]),ci(e,[e.Transaction.prototype],e._storeNames,e._dbSchema),i.schema=e._dbSchema})});function r(){return t.length?T.resolve(t.shift()(i.idbtrans)).then(r):T.resolve()}return r().then(function(){nk(n,l)})}function n5(a,o){var i={del:[],add:[],change:[]},l;for(l in a)o[l]||i.del.push(l);for(l in o){var e=a[l],t=o[l];if(!e)i.add.push([l,t]);else{var s={name:l,def:t,recreate:!1,del:[],add:[],change:[]};if(""+(e.primKey.keyPath||"")!=""+(t.primKey.keyPath||"")||e.primKey.auto!==t.primKey.auto&&!Pi)s.recreate=!0,i.change.push(s);else{var n=e.idxByName,S=t.idxByName,k=void 0;for(k in n)S[k]||s.del.push(k);for(k in S){var r=n[k],x=S[k];r?r.src!==x.src&&s.change.push(x):s.add.push(x)}(s.del.length>0||s.add.length>0||s.change.length>0)&&i.change.push(s)}}}return i}function wl(a,o,i,l){var e=a.db.createObjectStore(o,i.keyPath?{keyPath:i.keyPath,autoIncrement:i.auto}:{autoIncrement:i.auto});return l.forEach(function(t){return b2(e,t)}),e}function nk(a,o){y0(a).forEach(function(i){o.db.objectStoreNames.contains(i)||wl(o,i,a[i].primKey,a[i].indexes)})}function Sk(a,o){[].slice.call(o.db.objectStoreNames).forEach(function(i){return a[i]==null&&o.db.deleteObjectStore(i)})}function b2(a,o){a.createIndex(o.name,o.keyPath,{unique:o.unique,multiEntry:o.multi})}function ml(a,o,i){var l={},e=Ci(o.objectStoreNames,0);return e.forEach(function(t){for(var s=i.objectStore(t),n=s.keyPath,S=E2(t5(n),n||"",!1,!1,!!s.autoIncrement,n&&typeof n!="string",!0),k=[],r=0;r<s.indexNames.length;++r){var x=s.index(s.indexNames[r]);n=x.keyPath;var c=E2(x.name,n,!!x.unique,!!x.multiEntry,!1,n&&typeof n!="string",!1);k.push(c)}l[t]=s5(t,S,k)}),l}function kk(a,o,i){var l=a._novip;l.verno=o.version/10;var e=l._dbSchema=ml(l,o,i);l._storeNames=Ci(o.objectStoreNames,0),ci(l,[l._allTables],y0(e),e)}function xk(a,o){var i=ml(a,a.idbdb,o),l=n5(i,a._dbSchema);return!(l.add.length||l.change.some(function(e){return e.add.length||e.change.length}))}function M2(a,o,i){for(var l=a._novip,e=i.db.objectStoreNames,t=0;t<e.length;++t){var s=e[t],n=i.objectStore(s);l._hasGetAll="getAll"in n;for(var S=0;S<n.indexNames.length;++S){var k=n.indexNames[S],r=n.index(k).keyPath,x=typeof r=="string"?r:"["+Ci(r).join("+")+"]";if(o[s]){var c=o[s].idxByName[x];c&&(c.name=k,delete o[s].idxByName[x],o[s].idxByName[k]=c)}}}typeof navigator<"u"&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&u0.WorkerGlobalScope&&u0 instanceof u0.WorkerGlobalScope&&[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1]<604&&(l._hasGetAll=!1)}function rk(a){return a.split(",").map(function(o,i){o=o.trim();var l=o.replace(/([&*]|\+\+)/g,""),e=/^\[/.test(l)?l.match(/^\[(.*)\]$/)[1].split("+"):l;return E2(l,e||null,/\&/.test(o),/\*/.test(o),/\+\+/.test(o),O0(e),i===0)})}var ck=function(){function a(){}return a.prototype._parseStoresSpec=function(o,i){y0(o).forEach(function(l){if(o[l]!==null){var e=rk(o[l]),t=e.shift();if(t.multi)throw new X.Schema("Primary key cannot be multi-valued");e.forEach(function(s){if(s.auto)throw new X.Schema("Only primary key can be marked as autoIncrement (++)");if(!s.keyPath)throw new X.Schema("Index must have a name and cannot be an empty string")}),i[l]=s5(l,t,e)}})},a.prototype.stores=function(o){var i=this.db;this._cfg.storesSource=this._cfg.storesSource?A0(this._cfg.storesSource,o):o;var l=i._versions,e={},t={};return l.forEach(function(s){A0(e,s._cfg.storesSource),t=s._cfg.dbschema={},s._parseStoresSpec(e,t)}),i._dbSchema=t,z2(i,[i._allTables,i,i.Transaction.prototype]),ci(i,[i._allTables,i,i.Transaction.prototype,this._cfg.tables],y0(t),t),i._storeNames=y0(t),this},a.prototype.upgrade=function(o){return this._cfg.contentUpgrade=kl(this._cfg.contentUpgrade||m0,o),this},a}();function Fk(a){return zo(ck.prototype,function(i){this.db=a,this._cfg={version:i,storesSource:null,dbschema:{},tables:{},contentUpgrade:null}})}function jl(a,o){var i=a._dbNamesDB;return i||(i=a._dbNamesDB=new Wl(zi,{addons:[],indexedDB:a,IDBKeyRange:o}),i.version(1).stores({dbnames:"name"})),i.table("dbnames")}function pl(a){return a&&typeof a.databases=="function"}function dk(a){var o=a.indexedDB,i=a.IDBKeyRange;return pl(o)?Promise.resolve(o.databases()).then(function(l){return l.map(function(e){return e.name}).filter(function(e){return e!==zi})}):jl(o,i).toCollection().primaryKeys()}function wk(a,o){var i=a.indexedDB,l=a.IDBKeyRange;!pl(i)&&o!==zi&&jl(i,l).put({name:o}).catch(m0)}function mk(a,o){var i=a.indexedDB,l=a.IDBKeyRange;!pl(i)&&o!==zi&&jl(i,l).delete(o).catch(m0)}function v2(a){return qa(function(){return U.letThrough=!0,a()})}function jk(){var a=!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent);if(!a||!indexedDB.databases)return Promise.resolve();var o;return new Promise(function(i){var l=function(){return indexedDB.databases().finally(i)};o=setInterval(l,100),l()}).finally(function(){return clearInterval(o)})}function pk(a){var o=a._state,i=a._deps.indexedDB;if(o.isBeingOpened||a.idbdb)return o.dbReadyPromise.then(function(){return o.dbOpenError?E0(o.dbOpenError):a});ja&&(o.openCanceller._stackHolder=u1()),o.isBeingOpened=!0,o.dbOpenError=null,o.openComplete=!1;var l=o.openCanceller;function e(){if(o.openCanceller!==l)throw new X.DatabaseClosed("db.open() was cancelled")}var t=o.dbReadyResolve,s=null,n=!1;return T.race([l,(typeof navigator>"u"?T.resolve():jk()).then(function(){return new T(function(S,k){if(e(),!i)throw new X.MissingAPI;var r=a.name,x=o.autoSchema?i.open(r):i.open(r,Math.round(a.verno*10));if(!x)throw new X.MissingAPI;x.onerror=Fa(k),x.onblocked=W0(a._fireOnBlocked),x.onupgradeneeded=W0(function(c){if(s=x.transaction,o.autoSchema&&!a._options.allowEmptyDB){x.onerror=mo,s.abort(),x.result.close();var w=i.deleteDatabase(r);w.onsuccess=w.onerror=W0(function(){k(new X.NoSuchDatabase("Database "+r+" doesnt exist"))})}else{s.onerror=Fa(k);var F=c.oldVersion>Math.pow(2,62)?0:c.oldVersion;n=F<1,a._novip.idbdb=x.result,tk(a,F/10,s,k)}},k),x.onsuccess=W0(function(){s=null;var c=a._novip.idbdb=x.result,w=Ci(c.objectStoreNames);if(w.length>0)try{var F=c.transaction(ZS(w),"readonly");o.autoSchema?kk(a,c,F):(M2(a,a._dbSchema,F),xk(a,F)||console.warn("Dexie SchemaDiff: Schema was extended without increasing the number passed to db.version(). Some queries may fail.")),dl(a,F)}catch{}lo.push(a),c.onversionchange=W0(function(d){o.vcFired=!0,a.on("versionchange").fire(d)}),c.onclose=W0(function(d){a.on("close").fire(d)}),n&&wk(a._deps,r),S()},k)})})]).then(function(){return e(),o.onReadyBeingFired=[],T.resolve(v2(function(){return a.on.ready.fire(a.vip)})).then(function S(){if(o.onReadyBeingFired.length>0){var k=o.onReadyBeingFired.reduce(kl,m0);return o.onReadyBeingFired=[],T.resolve(v2(function(){return k(a.vip)})).then(S)}})}).finally(function(){o.onReadyBeingFired=null,o.isBeingOpened=!1}).then(function(){return a}).catch(function(S){o.dbOpenError=S;try{s&&s.abort()}catch{}return l===o.openCanceller&&a._close(),E0(S)}).finally(function(){o.openComplete=!0,t()})}function _2(a){var o=function(s){return a.next(s)},i=function(s){return a.throw(s)},l=t(o),e=t(i);function t(s){return function(n){var S=s(n),k=S.value;return S.done?k:!k||typeof k.then!="function"?O0(k)?Promise.all(k).then(l,e):l(k):k.then(l,e)}}return t(o)()}function uk(a,o,i){var l=arguments.length;if(l<2)throw new X.InvalidArgument("Too few arguments");for(var e=new Array(l-1);--l;)e[l-1]=arguments[l];i=e.pop();var t=Tt(e);return[a,t,i]}function S5(a,o,i,l,e){return T.resolve().then(function(){var t=U.transless||U,s=a._createTransaction(o,i,a._dbSchema,l),n={trans:s,transless:t};if(l)s.idbtrans=l.idbtrans;else try{s.create(),a._state.PR1398_maxLoop=3}catch(x){return x.name===Sl.InvalidState&&a.isOpen()&&--a._state.PR1398_maxLoop>0?(console.warn("Dexie: Need to reopen db"),a._close(),a.open().then(function(){return S5(a,o,i,null,e)})):E0(x)}var S=sl(e);S&&I1();var k,r=T.follow(function(){if(k=e.call(s,s),k)if(S){var x=Ma.bind(null,null);k.then(x,x)}else typeof k.next=="function"&&typeof k.throw=="function"&&(k=_2(k))},n);return(k&&typeof k.then=="function"?T.resolve(k).then(function(x){return s.active?x:E0(new X.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"))}):r.then(function(){return k})).then(function(x){return l&&s._resolve(),s._completion.then(function(){return x})}).catch(function(x){return s._reject(x),E0(x)})})}function Lo(a,o,i){for(var l=O0(a)?a.slice():[a],e=0;e<i;++e)l.push(o);return l}function fk(a){return i0(i0({},a),{table:function(o){var i=a.table(o),l=i.schema,e={},t=[];function s(d,u,B){var W=eo(d),f=e[W]=e[W]||[],h=d==null?0:typeof d=="string"?1:d.length,g=u>0,E=i0(i0({},B),{isVirtual:g,keyTail:u,keyLength:h,extractKey:P2(d),unique:!g&&B.unique});if(f.push(E),E.isPrimaryKey||t.push(E),h>1){var O=h===2?d[0]:d.slice(0,h-1);s(O,u+1,B)}return f.sort(function(y,v){return y.keyTail-v.keyTail}),E}var n=s(l.primaryKey.keyPath,0,l.primaryKey);e[":id"]=[n];for(var S=0,k=l.indexes;S<k.length;S++){var r=k[S];s(r.keyPath,0,r)}function x(d){var u=e[eo(d)];return u&&u[0]}function c(d,u){return{type:d.type===1?2:d.type,lower:Lo(d.lower,d.lowerOpen?a.MAX_KEY:a.MIN_KEY,u),lowerOpen:!0,upper:Lo(d.upper,d.upperOpen?a.MIN_KEY:a.MAX_KEY,u),upperOpen:!0}}function w(d){var u=d.query.index;return u.isVirtual?i0(i0({},d),{query:{index:u,range:c(d.query.range,u.keyTail)}}):d}var F=i0(i0({},i),{schema:i0(i0({},l),{primaryKey:n,indexes:t,getIndexByKeyPath:x}),count:function(d){return i.count(w(d))},query:function(d){return i.query(w(d))},openCursor:function(d){var u=d.query.index,B=u.keyTail,W=u.isVirtual,f=u.keyLength;if(!W)return i.openCursor(d);function h(g){function E(y){y!=null?g.continue(Lo(y,d.reverse?a.MAX_KEY:a.MIN_KEY,B)):d.unique?g.continue(g.key.slice(0,f).concat(d.reverse?a.MIN_KEY:a.MAX_KEY,B)):g.continue()}var O=Object.create(g,{continue:{value:E},continuePrimaryKey:{value:function(y,v){g.continuePrimaryKey(Lo(y,a.MAX_KEY,B),v)}},primaryKey:{get:function(){return g.primaryKey}},key:{get:function(){var y=g.key;return f===1?y[0]:y.slice(0,f)}},value:{get:function(){return g.value}}});return O}return i.openCursor(w(d)).then(function(g){return g&&h(g)})}});return F}})}var Wk={stack:"dbcore",name:"VirtualIndexMiddleware",level:1,create:fk};function ul(a,o,i,l){return i=i||{},l=l||"",y0(a).forEach(function(e){if(!Y0(o,e))i[l+e]=void 0;else{var t=a[e],s=o[e];if(typeof t=="object"&&typeof s=="object"&&t&&s){var n=d2(t),S=d2(s);n!==S?i[l+e]=o[e]:n==="Object"?ul(t,s,i,l+e+"."):t!==s&&(i[l+e]=o[e])}else t!==s&&(i[l+e]=o[e])}}),y0(o).forEach(function(e){Y0(a,e)||(i[l+e]=o[e])}),i}function gk(a,o){return o.type==="delete"?o.keys:o.keys||o.values.map(a.extractKey)}var hk={stack:"dbcore",name:"HooksMiddleware",level:2,create:function(a){return i0(i0({},a),{table:function(o){var i=a.table(o),l=i.schema.primaryKey,e=i0(i0({},i),{mutate:function(t){var s=U.trans,n=s.table(o).hook,S=n.deleting,k=n.creating,r=n.updating;switch(t.type){case"add":if(k.fire===m0)break;return s._promise("readwrite",function(){return x(t)},!0);case"put":if(k.fire===m0&&r.fire===m0)break;return s._promise("readwrite",function(){return x(t)},!0);case"delete":if(S.fire===m0)break;return s._promise("readwrite",function(){return x(t)},!0);case"deleteRange":if(S.fire===m0)break;return s._promise("readwrite",function(){return c(t)},!0)}return i.mutate(t);function x(F){var d=U.trans,u=F.keys||gk(l,F);if(!u)throw new Error("Keys missing");return F=F.type==="add"||F.type==="put"?i0(i0({},F),{keys:u}):i0({},F),F.type!=="delete"&&(F.values=c2([],F.values,!0)),F.keys&&(F.keys=c2([],F.keys,!0)),Bk(i,F,u).then(function(B){var W=u.map(function(f,h){var g=B[h],E={onerror:null,onsuccess:null};if(F.type==="delete")S.fire.call(E,f,g,d);else if(F.type==="add"||g===void 0){var O=k.fire.call(E,f,F.values[h],d);f==null&&O!=null&&(f=O,F.keys[h]=f,l.outbound||ka(F.values[h],l.keyPath,f))}else{var y=ul(g,F.values[h]),v=r.fire.call(E,y,f,g,d);if(v){var D=F.values[h];Object.keys(v).forEach(function(I){Y0(D,I)?D[I]=v[I]:ka(D,I,v[I])})}}return E});return i.mutate(F).then(function(f){for(var h=f.failures,g=f.results,E=f.numFailures,O=f.lastResult,y=0;y<u.length;++y){var v=g?g[y]:u[y],D=W[y];v==null?D.onerror&&D.onerror(h[y]):D.onsuccess&&D.onsuccess(F.type==="put"&&B[y]?F.values[y]:v)}return{failures:h,results:g,numFailures:E,lastResult:O}}).catch(function(f){return W.forEach(function(h){return h.onerror&&h.onerror(f)}),Promise.reject(f)})})}function c(F){return w(F.trans,F.range,1e4)}function w(F,d,u){return i.query({trans:F,values:!1,query:{index:l,range:d},limit:u}).then(function(B){var W=B.result;return x({type:"delete",keys:W,trans:F}).then(function(f){return f.numFailures>0?Promise.reject(f.failures[0]):W.length<u?{failures:[],numFailures:0,lastResult:void 0}:w(F,i0(i0({},d),{lower:W[W.length-1],lowerOpen:!0}),u)})})}}});return e}})}};function Bk(a,o,i){return o.type==="add"?Promise.resolve([]):a.getMany({trans:o.trans,keys:i,cache:"immutable"})}function k5(a,o,i){try{if(!o||o.keys.length<a.length)return null;for(var l=[],e=0,t=0;e<o.keys.length&&t<a.length;++e)L0(o.keys[e],a[t])===0&&(l.push(i?Bo(o.values[e]):o.values[e]),++t);return l.length===a.length?l:null}catch{return null}}var yk={stack:"dbcore",level:-1,create:function(a){return{table:function(o){var i=a.table(o);return i0(i0({},i),{getMany:function(l){if(!l.cache)return i.getMany(l);var e=k5(l.keys,l.trans._cache,l.cache==="clone");return e?T.resolve(e):i.getMany(l).then(function(t){return l.trans._cache={keys:l.keys,values:l.cache==="clone"?Bo(t):t},t})},mutate:function(l){return l.type!=="add"&&(l.trans._cache=null),i.mutate(l)}})}}}},Ni;function fl(a){return!("from"in a)}var ga=function(a,o){if(this)A0(this,arguments.length?{d:1,from:a,to:arguments.length>1?o:a}:{d:0});else{var i=new ga;return a&&"d"in a&&A0(i,a),i}};D1(ga.prototype,(Ni={add:function(a){return Fi(this,a),this},addKey:function(a){return uo(this,a,a),this},addKeys:function(a){var o=this;return a.forEach(function(i){return uo(o,i,i)}),this}},Ni[w2]=function(){return G2(this)},Ni));function uo(a,o,i){var l=L0(o,i);if(!isNaN(l)){if(l>0)throw RangeError();if(fl(a))return A0(a,{from:o,to:i,d:1});var e=a.l,t=a.r;if(L0(i,a.from)<0)return e?uo(e,o,i):a.l={from:o,to:i,d:1,l:null,r:null},ge(a);if(L0(o,a.to)>0)return t?uo(t,o,i):a.r={from:o,to:i,d:1,l:null,r:null},ge(a);L0(o,a.from)<0&&(a.from=o,a.l=null,a.d=t?t.d+1:1),L0(i,a.to)>0&&(a.to=i,a.r=null,a.d=a.l?a.l.d+1:1);var s=!a.r;e&&!a.l&&Fi(a,e),t&&s&&Fi(a,t)}}function Fi(a,o){function i(l,e){var t=e.from,s=e.to,n=e.l,S=e.r;uo(l,t,s),n&&i(l,n),S&&i(l,S)}fl(o)||i(a,o)}function Ck(a,o){var i=G2(o),l=i.next();if(l.done)return!1;for(var e=l.value,t=G2(a),s=t.next(e.from),n=s.value;!l.done&&!s.done;){if(L0(n.from,e.to)<=0&&L0(n.to,e.from)>=0)return!0;L0(e.from,n.from)<0?e=(l=i.next(n.from)).value:n=(s=t.next(e.from)).value}return!1}function G2(a){var o=fl(a)?null:{s:0,n:a};return{next:function(i){for(var l=arguments.length>0;o;)switch(o.s){case 0:if(o.s=1,l)for(;o.n.l&&L0(i,o.n.from)<0;)o={up:o,n:o.n.l,s:1};else for(;o.n.l;)o={up:o,n:o.n.l,s:1};case 1:if(o.s=2,!l||L0(i,o.n.to)<=0)return{value:o.n,done:!1};case 2:if(o.n.r){o.s=3,o={up:o,n:o.n.r,s:0};continue}case 3:o=o.up}return{done:!0}}}}function ge(a){var o,i,l=(((o=a.r)===null||o===void 0?void 0:o.d)||0)-(((i=a.l)===null||i===void 0?void 0:i.d)||0),e=l>1?"r":l<-1?"l":"";if(e){var t=e==="r"?"l":"r",s=i0({},a),n=a[e];a.from=n.from,a.to=n.to,a[e]=n[e],s[e]=n[t],a[t]=s,s.d=he(s)}a.d=he(a)}function he(a){var o=a.r,i=a.l;return(o?i?Math.max(o.d,i.d):o.d:i?i.d:0)+1}var Ek={stack:"dbcore",level:0,create:function(a){var o=a.schema.name,i=new ga(a.MIN_KEY,a.MAX_KEY);return i0(i0({},a),{table:function(l){var e=a.table(l),t=e.schema,s=t.primaryKey,n=s.extractKey,S=s.outbound,k=i0(i0({},e),{mutate:function(c){var w=c.trans,F=w.mutatedParts||(w.mutatedParts={}),d=function(O){var y="idb://"+o+"/"+l+"/"+O;return F[y]||(F[y]=new ga)},u=d(""),B=d(":dels"),W=c.type,f=c.type==="deleteRange"?[c.range]:c.type==="delete"?[c.keys]:c.values.length<50?[[],c.values]:[],h=f[0],g=f[1],E=c.trans._cache;return e.mutate(c).then(function(O){if(O0(h)){W!=="delete"&&(h=O.results),u.addKeys(h);var y=k5(h,E);!y&&W!=="add"&&B.addKeys(h),(y||g)&&Pk(d,t,y,g)}else if(h){var v={from:h.lower,to:h.upper};B.add(v),u.add(v)}else u.add(i),B.add(i),t.indexes.forEach(function(D){return d(D.name).add(i)});return O})}}),r=function(c){var w,F,d=c.query,u=d.index,B=d.range;return[u,new ga((w=B.lower)!==null&&w!==void 0?w:a.MIN_KEY,(F=B.upper)!==null&&F!==void 0?F:a.MAX_KEY)]},x={get:function(c){return[s,new ga(c.key)]},getMany:function(c){return[s,new ga().addKeys(c.keys)]},count:r,query:r,openCursor:r};return y0(x).forEach(function(c){k[c]=function(w){var F=U.subscr;if(F){var d=function(E){var O="idb://"+o+"/"+l+"/"+E;return F[O]||(F[O]=new ga)},u=d(""),B=d(":dels"),W=x[c](w),f=W[0],h=W[1];if(d(f.name||"").add(h),!f.isPrimaryKey)if(c==="count")B.add(i);else{var g=c==="query"&&S&&w.values&&e.query(i0(i0({},w),{values:!1}));return e[c].apply(this,arguments).then(function(E){if(c==="query"){if(S&&w.values)return g.then(function(D){var I=D.result;return u.addKeys(I),E});var O=w.values?E.result.map(n):E.result;w.values?u.addKeys(O):B.addKeys(O)}else if(c==="openCursor"){var y=E,v=w.values;return y&&Object.create(y,{key:{get:function(){return B.addKey(y.primaryKey),y.key}},primaryKey:{get:function(){var D=y.primaryKey;return B.addKey(D),D}},value:{get:function(){return v&&u.addKey(y.primaryKey),y.value}}})}return E})}}return e[c].apply(this,arguments)}}),k}})}};function Pk(a,o,i,l){function e(t){var s=a(t.name||"");function n(k){return k!=null?t.extractKey(k):null}var S=function(k){return t.multiEntry&&O0(k)?k.forEach(function(r){return s.addKey(r)}):s.addKey(k)};(i||l).forEach(function(k,r){var x=i&&n(i[r]),c=l&&n(l[r]);L0(x,c)!==0&&(x!=null&&S(x),c!=null&&S(c))})}o.indexes.forEach(e)}var Wl=function(){function a(o,i){var l=this;this._middlewares={},this.verno=0;var e=a.dependencies;this._options=i=i0({addons:a.addons,autoOpen:!0,indexedDB:e.indexedDB,IDBKeyRange:e.IDBKeyRange},i),this._deps={indexedDB:i.indexedDB,IDBKeyRange:i.IDBKeyRange};var t=i.addons;this._dbSchema={},this._versions=[],this._storeNames=[],this._allTables={},this.idbdb=null,this._novip=this;var s={dbOpenError:null,isBeingOpened:!1,onReadyBeingFired:null,openComplete:!1,dbReadyResolve:m0,dbReadyPromise:null,cancelOpen:m0,openCanceller:null,autoSchema:!0,PR1398_maxLoop:3};s.dbReadyPromise=new T(function(n){s.dbReadyResolve=n}),s.openCanceller=new T(function(n,S){s.cancelOpen=S}),this._state=s,this.name=o,this.on=Po(this,"populate","blocked","versionchange","close",{ready:[kl,m0]}),this.on.ready.subscribe=Ht(this.on.ready.subscribe,function(n){return function(S,k){a.vip(function(){var r=l._state;if(r.openComplete)r.dbOpenError||T.resolve().then(S),k&&n(S);else if(r.onReadyBeingFired)r.onReadyBeingFired.push(S),k&&n(S);else{n(S);var x=l;k||n(function c(){x.on.ready.unsubscribe(S),x.on.ready.unsubscribe(c)})}})}}),this.Collection=QS(this),this.Table=RS(this),this.Transaction=YS(this),this.Version=Fk(this),this.WhereClause=qS(this),this.on("versionchange",function(n){n.newVersion>0?console.warn("Another connection wants to upgrade database '"+l.name+"'. Closing db now to resume the upgrade."):console.warn("Another connection wants to delete database '"+l.name+"'. Closing db now to resume the delete request."),l.close()}),this.on("blocked",function(n){!n.newVersion||n.newVersion<n.oldVersion?console.warn("Dexie.delete('"+l.name+"') was blocked"):console.warn("Upgrade '"+l.name+"' blocked by other connection holding version "+n.oldVersion/10)}),this._maxKey=po(i.IDBKeyRange),this._createTransaction=function(n,S,k,r){return new l.Transaction(n,S,k,l._options.chromeTransactionDurability,r)},this._fireOnBlocked=function(n){l.on("blocked").fire(n),lo.filter(function(S){return S.name===l.name&&S!==l&&!S._state.vcFired}).map(function(S){return S.on("versionchange").fire(n)})},this.use(Wk),this.use(hk),this.use(Ek),this.use(yk),this.vip=Object.create(this,{_vip:{value:!0}}),t.forEach(function(n){return n(l)})}return a.prototype.version=function(o){if(isNaN(o)||o<.1)throw new X.Type("Given version is not a positive number");if(o=Math.round(o*10)/10,this.idbdb||this._state.isBeingOpened)throw new X.Schema("Cannot add version when database is open");this.verno=Math.max(this.verno,o);var i=this._versions,l=i.filter(function(e){return e._cfg.version===o})[0];return l||(l=new this.Version(o),i.push(l),i.sort(ek),l.stores({}),this._state.autoSchema=!1,l)},a.prototype._whenReady=function(o){var i=this;return this.idbdb&&(this._state.openComplete||U.letThrough||this._vip)?o():new T(function(l,e){if(i._state.openComplete)return e(new X.DatabaseClosed(i._state.dbOpenError));if(!i._state.isBeingOpened){if(!i._options.autoOpen){e(new X.DatabaseClosed);return}i.open().catch(m0)}i._state.dbReadyPromise.then(l,e)}).then(o)},a.prototype.use=function(o){var i=o.stack,l=o.create,e=o.level,t=o.name;t&&this.unuse({stack:i,name:t});var s=this._middlewares[i]||(this._middlewares[i]=[]);return s.push({stack:i,create:l,level:e==null?10:e,name:t}),s.sort(function(n,S){return n.level-S.level}),this},a.prototype.unuse=function(o){var i=o.stack,l=o.name,e=o.create;return i&&this._middlewares[i]&&(this._middlewares[i]=this._middlewares[i].filter(function(t){return e?t.create!==e:l?t.name!==l:!1})),this},a.prototype.open=function(){return pk(this)},a.prototype._close=function(){var o=this._state,i=lo.indexOf(this);if(i>=0&&lo.splice(i,1),this.idbdb){try{this.idbdb.close()}catch{}this._novip.idbdb=null}o.dbReadyPromise=new T(function(l){o.dbReadyResolve=l}),o.openCanceller=new T(function(l,e){o.cancelOpen=e})},a.prototype.close=function(){this._close();var o=this._state;this._options.autoOpen=!1,o.dbOpenError=new X.DatabaseClosed,o.isBeingOpened&&o.cancelOpen(o.dbOpenError)},a.prototype.delete=function(){var o=this,i=arguments.length>0,l=this._state;return new T(function(e,t){var s=function(){o.close();var n=o._deps.indexedDB.deleteDatabase(o.name);n.onsuccess=W0(function(){mk(o._deps,o.name),e()}),n.onerror=Fa(t),n.onblocked=o._fireOnBlocked};if(i)throw new X.InvalidArgument("Arguments not allowed in db.delete()");l.isBeingOpened?l.dbReadyPromise.then(s):s()})},a.prototype.backendDB=function(){return this.idbdb},a.prototype.isOpen=function(){return this.idbdb!==null},a.prototype.hasBeenClosed=function(){var o=this._state.dbOpenError;return o&&o.name==="DatabaseClosed"},a.prototype.hasFailed=function(){return this._state.dbOpenError!==null},a.prototype.dynamicallyOpened=function(){return this._state.autoSchema},Object.defineProperty(a.prototype,"tables",{get:function(){var o=this;return y0(this._allTables).map(function(i){return o._allTables[i]})},enumerable:!1,configurable:!0}),a.prototype.transaction=function(){var o=uk.apply(this,arguments);return this._transaction.apply(this,o)},a.prototype._transaction=function(o,i,l){var e=this,t=U.trans;(!t||t.db!==this||o.indexOf("!")!==-1)&&(t=null);var s=o.indexOf("?")!==-1;o=o.replace("!","").replace("?","");var n,S;try{if(S=i.map(function(r){var x=r instanceof e.Table?r.name:r;if(typeof x!="string")throw new TypeError("Invalid table argument to Dexie.transaction(). Only Table or String are allowed");return x}),o=="r"||o===Ai)n=Ai;else if(o=="rw"||o==Ii)n=Ii;else throw new X.InvalidArgument("Invalid transaction mode: "+o);if(t){if(t.mode===Ai&&n===Ii)if(s)t=null;else throw new X.SubTransaction("Cannot enter a sub-transaction with READWRITE mode when parent transaction is READONLY");t&&S.forEach(function(r){if(t&&t.storeNames.indexOf(r)===-1)if(s)t=null;else throw new X.SubTransaction("Table "+r+" not included in parent transaction.")}),s&&t&&!t.active&&(t=null)}}catch(r){return t?t._promise(null,function(x,c){c(r)}):E0(r)}var k=S5.bind(null,this,n,S,t,l);return t?t._promise(n,k,"lock"):U.trans?Q1(U.transless,function(){return e._whenReady(k)}):this._whenReady(k)},a.prototype.table=function(o){if(!Y0(this._allTables,o))throw new X.InvalidTable("Table "+o+" does not exist");return this._allTables[o]},a}(),zk=typeof Symbol<"u"&&"observable"in Symbol?Symbol.observable:"@@observable",bk=function(){function a(o){this._subscribe=o}return a.prototype.subscribe=function(o,i,l){return this._subscribe(!o||typeof o=="function"?{next:o,error:i,complete:l}:o)},a.prototype[zk]=function(){return this},a}();function x5(a,o){return y0(o).forEach(function(i){var l=a[i]||(a[i]=new ga);Fi(l,o[i])}),a}function Mk(a){return new bk(function(o){var i=sl(a);function l(w){i&&I1();var F=function(){return qa(a,{subscr:w,trans:null})},d=U.trans?Q1(U.transless,F):F();return i&&d.then(Ma,Ma),d}var e=!1,t={},s={},n={get closed(){return e},unsubscribe:function(){e=!0,Ya.storagemutated.unsubscribe(x)}};o.start&&o.start(n);var S=!1,k=!1;function r(){return y0(s).some(function(w){return t[w]&&Ck(t[w],s[w])})}var x=function(w){x5(t,w),r()&&c()},c=function(){if(!(S||e)){t={};var w={},F=l(w);k||(Ya(jo,x),k=!0),S=!0,Promise.resolve(F).then(function(d){S=!1,!e&&(r()?c():(t={},s=w,o.next&&o.next(d)))},function(d){S=!1,o.error&&o.error(d),n.unsubscribe()})}};return c(),n})}var H2;try{H2={indexedDB:u0.indexedDB||u0.mozIndexedDB||u0.webkitIndexedDB||u0.msIndexedDB,IDBKeyRange:u0.IDBKeyRange||u0.webkitIDBKeyRange}}catch{H2={indexedDB:null,IDBKeyRange:null}}var s1=Wl;D1(s1,i0(i0({},Ei),{delete:function(a){var o=new s1(a,{addons:[]});return o.delete()},exists:function(a){return new s1(a,{addons:[]}).open().then(function(o){return o.close(),!0}).catch("NoSuchDatabaseError",function(){return!1})},getDatabaseNames:function(a){try{return dk(s1.dependencies).then(a)}catch{return E0(new X.MissingAPI)}},defineClass:function(){function a(o){A0(this,o)}return a},ignoreTransaction:function(a){return U.trans?Q1(U.transless,a):a()},vip:v2,async:function(a){return function(){try{var o=_2(a.apply(this,arguments));return!o||typeof o.then!="function"?T.resolve(o):o}catch(i){return E0(i)}}},spawn:function(a,o,i){try{var l=_2(a.apply(i,o||[]));return!l||typeof l.then!="function"?T.resolve(l):l}catch(e){return E0(e)}},currentTransaction:{get:function(){return U.trans||null}},waitFor:function(a,o){var i=T.resolve(typeof a=="function"?s1.ignoreTransaction(a):a).timeout(o||6e4);return U.trans?U.trans.waitFor(i):i},Promise:T,debug:{get:function(){return ja},set:function(a){At(a,a==="dexie"?function(){return!0}:o5)}},derive:L1,extend:A0,props:D1,override:Ht,Events:Po,on:Ya,liveQuery:Mk,extendObservabilitySet:x5,getByKeyPath:Pa,setByKeyPath:ka,delByKeyPath:kS,shallowClone:Rt,deepClone:Bo,getObjectDiff:ul,cmp:L0,asap:Dt,minKey:C2,addons:[],connections:lo,errnames:Sl,dependencies:H2,semVer:me,version:me.split(".").map(function(a){return parseInt(a)}).reduce(function(a,o,i){return a+o/Math.pow(10,i*2)})}));s1.maxKey=po(s1.dependencies.IDBKeyRange);typeof dispatchEvent<"u"&&typeof addEventListener<"u"&&(Ya(jo,function(a){if(!Ca){var o;Pi?(o=document.createEvent("CustomEvent"),o.initCustomEvent(La,!0,!0,a)):o=new CustomEvent(La,{detail:a}),Ca=!0,dispatchEvent(o),Ca=!1}}),addEventListener(La,function(a){var o=a.detail;Ca||di(o)}));function di(a){var o=Ca;try{Ca=!0,Ya.storagemutated.fire(a)}finally{Ca=o}}var Ca=!1;if(typeof BroadcastChannel<"u"){var Be=new BroadcastChannel(La);Ya(jo,function(a){Ca||Be.postMessage(a)}),Be.onmessage=function(a){a.data&&di(a.data)}}else if(typeof self<"u"&&typeof navigator<"u"){Ya(jo,function(a){try{Ca||(typeof localStorage<"u"&&localStorage.setItem(La,JSON.stringify({trig:Math.random(),changedParts:a})),typeof self.clients=="object"&&c2([],self.clients.matchAll({includeUncontrolled:!0}),!0).forEach(function(o){return o.postMessage({type:La,changedParts:a})}))}catch{}}),typeof addEventListener<"u"&&addEventListener("storage",function(a){if(a.key===La){var o=JSON.parse(a.newValue);o&&di(o.changedParts)}});var ye=self.document&&navigator.serviceWorker;ye&&ye.addEventListener("message",vk)}function vk(a){var o=a.data;o&&o.type===La&&di(o.changedParts)}T.rejectionMapper=pS;At(ja,o5);const B0=new Wl("StockBrowserDB");B0.version(1).stores({products:"code, tCub, aCub"});B0.version(2).stores({products:"code, tCub, aCub",timestamps:"id"});function M0(a,o,i,l){if(!a||!o||!i||!l)return 0;a=a.split("x");const e=a[0]/1e3,t=a[1]/1e3,s=a[2]/1e3;return i==="m3"&&(l==="m2"&&(o=o/e),l==="szt"&&(o=o/e/t/s)),i==="m2"&&(l==="m3"&&(o=o*e),l==="szt"&&(o=o/t/s)),i==="szt"&&(l==="m3"&&(o=o*e*t*s),l==="m2"&&(o=o*t*s)),o*1}function ha(a,o,i,l){if(!a||!o||!i||!l)return 0;a=a.split("x");const e=a[0]/1e3,t=a[1]/1e3,s=a[2]/1e3;return i==="m3"&&(l==="m2"&&(o=o*e),l==="szt"&&(o=o*e*t*s)),i==="m2"&&(l==="m3"&&(o=o/e),l==="szt"&&(o=o*t*s)),i==="szt"&&(l==="m3"&&(o=o/e/t/s),l==="m2"&&(o=o/t/s)),o*1}function to(a){const o=document.querySelector(a);window.scrollTo({top:o.offsetTop,behavior:"smooth"})}function d1(a){a=a||"",a=a.replace(/,/gi,"."),a=a.replace(/-\+/gi,"-"),a=a.replace(/--/gi,"+"),a=a.replace(/\++/gi,"+"),a=a.replace(/\B\.\B/gi,"0"),a=a.replace(/\B(\.)/gi,"0$1"),a=a.replace(/(\d)(\()/gi,"$1*$2"),a=a.replace(/(\))(\d)/gi,"$1*$2"),a=a.replace(/(\))(\()/gi,"$1*$2");const o=/\(([^\(\)]+)\)/i,i=/\d+(\.\d+)?[\*\/]-?\d+(\.\d+)?/i,l=/[\+\-]?\d+(\.\d+)?/gi,e=a.match(o),t=a.match(i),s=a.match(l);if(e){let k=a.replace(o,d1(e[1]));return d1(k)}if(t){let k=a.replace(i,S(t[0]));return d1(k)}return(s?s.reduce((k,r)=>r*1+k*1):0)*1;function S(k){let[r,x]=k.split(/[\*\/]/);return r*=1,x*=1,/\*/.test(k)?r*x:r/x}}const R0=(a,o)=>{const i=a.__vccOpts||a;for(const[l,e]of o)i[l]=e;return i},_k=["innerHTML"],Gk=["value"],Hk={__name:"Browser__Price_Field",props:["size","unit"],setup(a){const o=a,i=f0("priceRoot"),l=f0("buyPrice"),e=s0(!1),t=s0(),s=f0("vat");function n(w){const F=w.target.value.trim()*1;t.value=w.target.value.trim(),o.unit==="pCub"&&(i.value=ha(o.size,F,"m3","m3")/s.m3),o.unit==="pSqr"&&(i.value=ha(o.size,F,"m2","m3")/s.m2),o.unit==="pPcs"&&(i.value=ha(o.size,F,"szt","m3")/s.szt),o.unit==="marg"&&(i.value=l+F),o.unit==="perc"&&(i.value=l+l/100*F)}const S=H0(()=>{const w=i.value;let F=0;return o.unit==="pCub"&&(F=ha(o.size,w,"m3","m3")*s.m3),o.unit==="pSqr"&&(F=ha(o.size,w,"m3","m2")*s.m2),o.unit==="pPcs"&&(F=ha(o.size,w,"m3","szt")*s.szt),o.unit==="marg"&&(F=w-l),o.unit==="perc"&&(F=(w-l)/l*100),(isNaN(F)||!isFinite(F))&&(F=0),F}),k=H0(()=>{const w=i.value-l;return o.unit==="marg"&&w>=0?"+":""}),r=H0(()=>{let w=2;return o.unit==="pCub"&&(w=2),o.unit==="pSqr"&&(w=2),o.unit==="pPcs"&&(w=2),o.unit==="marg"&&(w=2),o.unit==="perc"&&(w=1),w}),x=H0(()=>{let w="";return o.unit==="pCub"&&(w="z\u0142/m<sup>3</sup>"),o.unit==="pSqr"&&(w="z\u0142/m<sup>2</sup>"),o.unit==="pPcs"&&(w="z\u0142/szt"),o.unit==="marg"&&(w="z\u0142/m<sup>3</sup>"),o.unit==="perc"&&(w="%"),w}),c=H0(()=>{let w="";return o.unit==="pCub"&&s.m3>1&&(w="vatApplied"),o.unit==="pSqr"&&s.m2>1&&(w="vatApplied"),o.unit==="pPcs"&&s.szt>1&&(w="vatApplied"),w});return(w,F)=>(Q(),Y("div",{class:g0(K(c))},[e.value?(Q(),Y("input",{key:1,class:"price__edit",type:"number",value:t.value,onInput:F[1]||(F[1]=d=>n(d)),onBlur:F[2]||(F[2]=d=>e.value=!1),onFocus:F[3]||(F[3]=d=>d.target.select()),onKeydown:[F[4]||(F[4]=r2(d=>d.target.select(),["enter"])),F[5]||(F[5]=r2(d=>d.target.blur(),["esc"]))],onVnodeMounted:F[6]||(F[6]=({el:d})=>d.focus())},null,40,Gk)):(Q(),Y("span",{key:0,class:"price__result",contenteditable:"true",onFocus:F[0]||(F[0]=d=>[e.value=!0,t.value=K(S).toFixed(K(r))])},[o0(a0(K(k))+a0(K(S).toFixed(K(r))),1),j("small",{innerHTML:K(x)},null,8,_k)],32))],2))}},X1=R0(Hk,[["__scopeId","data-v-3e8a6713"]]);const Dk=a=>(Z0("data-v-d9afe0d0"),a=a(),J0(),a),Ok={class:"product__buyp"},Rk=Dk(()=>j("small",null,[o0("z\u0142/m"),j("sup",null,"3")],-1)),Tk={__name:"Browser__Prices",props:["plySize","buyPrice"],setup(a){const o=a,i=s0(o.buyPrice);N0("priceRoot",i),N0("buyPrice",o.buyPrice);const l=H0(()=>{const e=i.value-o.buyPrice;return e>1?"green":e<-1?"red":""});return(e,t)=>(Q(),Y(w0,null,[j("div",Ok,[o0(a0(o.buyPrice.toFixed(2)),1),Rk]),k0(X1,{class:g0(["product__pCub",K(l)]),size:o.plySize,unit:"pCub"},null,8,["class","size"]),k0(X1,{class:g0(["product__pSqr",K(l)]),size:o.plySize,unit:"pSqr"},null,8,["class","size"]),k0(X1,{class:g0(["product__pPcs",K(l)]),size:o.plySize,unit:"pPcs"},null,8,["class","size"]),k0(X1,{class:g0(["product__marg",K(l)]),size:o.plySize,unit:"marg"},null,8,["class","size"]),k0(X1,{class:g0(["product__perc",K(l)]),size:o.plySize,unit:"perc"},null,8,["class","size"])],64))}},Lk=R0(Tk,[["__scopeId","data-v-d9afe0d0"]]);const Ak={class:"data-set"},Ik=["for"],Qk=["id","value"],Kk={__name:"Browser__DataSet",async setup(a){let o,i;const l=f0("unfilteredData_global"),e=f0("dataSet_global");console.time("count-dataset");const t={"dataset-full":{label:"Stany zerowe",count:([o,i]=Di(()=>B0.products.count()),o=await o,i(),o)},"dataset-total":{label:"Stany ca\u0142kowite",count:([o,i]=Di(()=>B0.products.where("tCub").above(0).count()),o=await o,i(),o)},"dataset-aviable":{label:"Stany handlowe",count:([o,i]=Di(()=>B0.products.where("aCub").above(0).count()),o=await o,i(),o)}};return console.timeEnd("count-dataset"),J2(async()=>{console.time("change-dataset"),e.value==="dataset-full"&&(l.value=await B0.products.toArray()),e.value==="dataset-total"&&(l.value=await B0.products.where("tCub").above(0).toArray()),e.value==="dataset-aviable"&&(l.value=await B0.products.where("aCub").above(0).toArray()),console.timeEnd("change-dataset")}),(s,n)=>(Q(),Y("section",Ak,[(Q(),Y(w0,null,$a(t,({label:S,count:k},r)=>j("label",{for:r},[o0(a0(S)+": ",1),Sa(j("input",{type:"radio",name:"dataset",id:r,value:r,"onUpdate:modelValue":n[0]||(n[0]=x=>z0(e)?e.value=x:null)},null,8,Qk),[[x2,K(e)]]),o0(" ("+a0(k)+") ",1)],8,Ik)),64))]))}},$k=R0(Kk,[["__scopeId","data-v-f36fc6ea"]]),Nk={group:"Grupa",thick:"Grubo\u015B\u0107",sizeA:"Wymiar A",sizeB:"Wymiar B",grade:"Klasa",words:"Opis"};function Uk(a){const o="KILO|BB|B|CP|CC|C|WGE|WG|PQF|PQ|PF|F|WH|W|M",i=`\\b(${o}){1}(/(${o})){0,1}(?!\\.)\\b`;return a.toUpperCase().match(new RegExp(i,"gi"))}function Vk(a,o){o.addEventListener(a,()=>{to("#results")},{once:!0})}function qk(a){return a.split(" ").map(o=>{const i=/^\|+|\|+$/g,l=/\d*x[\d\|]*x\d*/i.test(o),e=/=/.test(o)?"\\b":"";let t="";return o=o.replace("=",""),o=o.replace(i,""),o=o.replace(/(\?)/g,"\\$1"),l&&(o=o.split("x").map(s=>(s=s.replace(i,""),s.length>0?`(${s})`:"(\\d+(,\\d+)?)")).join("x"),o=`(?<!,)${o}(mm)?`),t=`(?=.*${e}(${o})${e})`,t}).join("")}const K1=a=>(Z0("data-v-42edc1fb"),a=a(),J0(),a),Xk={class:"filters",style:{"grid-area":"fltr"}},Yk={class:"textFilter"},Zk=o0(" Szukaj:"),Jk={id:"tags-selector",class:"tags-selector",action:"javascript:void(0)"},ax={class:"tags-selector__groupHeader"},ox=["checked","name","id","value"],ix=["for","onClick"],lx={class:"tags-selector__groupFooter"},ex=K1(()=>j("span",null,"Filtruj",-1)),tx=K1(()=>j("i",{class:"bi bi-funnel"},null,-1)),sx=[ex,tx],nx=["onClick"],Sx=K1(()=>j("span",null,"Usu\u0144",-1)),kx=K1(()=>j("i",{class:"bi bi-trash3"},null,-1)),xx=[Sx,kx],rx={class:"filters__footer"},cx=K1(()=>j("span",null,"Usu\u0144 wszystkie",-1)),Fx=K1(()=>j("i",{class:"bi bi-trash3"},null,-1)),dx=[cx,Fx],wx={__name:"Browser__Filters",setup(a){const o=f0("unfilteredData_global"),i=f0("filteredData_global"),l=s0(""),e=s0({group:[],thick:[],sizeA:[],sizeB:[],grade:[],words:[]}),t=H0(()=>{const c=i.value;let w=new Set,F=new Set,d=new Set,u=new Set,B=new Set,W=new Set;const f=(h,g)=>new Intl.Collator(void 0,{numeric:!0}).compare(h,g);for(const h of c){const g=`${h.code} ${h.name}`,E=g.split(/[ \/]/gi),O=Uk(g);if(h.group&&h.group.split(" ").map(y=>w.add(y)),h.size){const[y,v,D]=h.size.split("x");y&&F.add(y),v&&d.add(v),D&&u.add(D)}O&&O.map(y=>B.add(y));for(const y of E)/\d/.test(y)||y.length<3||W.add(y.toLowerCase().replace(/[\.,]$/gi,""))}return{group:Array.from(w).sort(f),thick:Array.from(F).sort(f),sizeA:Array.from(d).sort(f),sizeB:Array.from(u).sort(f),grade:Array.from(B).sort(f),words:Array.from(W).sort(f)}}),s=H0(()=>{const c=e.value,w=c.thick.length||c.sizeA.length||c.sizeB.length?"x":"";let F=c.group.join("|"),d=c.thick.join("|"),u=c.sizeA.join("|"),B=c.sizeB.join("|"),W="",f=c.grade.join("|"),h=c.words.join("|");return F&&(F=`${F} `),f&&(f=`=${f} `),w.length&&(W=`=${d}${w}${u}${w}${B} `),`${F}${W}${f}${h}`.trim()});x1([l,s,o],()=>{let c=o.value;if(!c)return;let w=`${l.value} ${s.value}`,F=qk(w);console.log(F),c=c.filter(d=>`${d.code} ${d.group} ${d.name}`.match(new RegExp(F,"i"))),i.value=c});function n(c,w){const F=document.querySelector("#tags-selector"),d=new FormData(F);let u={group:d.getAll("group"),thick:d.getAll("thick"),sizeA:d.getAll("sizeA"),sizeB:d.getAll("sizeB"),grade:d.getAll("grade"),words:d.getAll("words")};c&&w&&u[c].push(w),Object.assign(e.value,u)}function S(c){const w=e.value;w[c]=[],e.value=w}function k(){l.value="",e.value={group:[],thick:[],sizeA:[],sizeB:[],grade:[],words:[]}}function r(c,w){return!(e.value[c].findIndex(u=>u===w)<0)}function x(c){return!e.value[c].length}return(c,w)=>(Q(),Y("section",Xk,[j("div",Yk,[Zk,Sa(j("input",{class:"textFilter__input",type:"search",name:"filter","onUpdate:modelValue":w[0]||(w[0]=F=>l.value=F)},null,512),[[yi,l.value]])]),j("form",Jk,[(Q(!0),Y(w0,null,$a(K(t),(F,d)=>(Q(),Y("fieldset",{class:g0(["tags-selector__group",[d]]),key:d},[j("header",ax,[j("h3",null,a0(K(Nk)[d]),1)]),(Q(!0),Y(w0,null,$a(F,(u,B)=>(Q(),Y("div",{class:"tags-selector__tag",key:`${d}-${u}`},[j("input",{type:"checkbox",checked:r(d,u),name:d,id:`${d}-${B}`,value:u},null,8,ox),j("label",{class:"button inline",for:`${d}-${B}`,onClick:Un(W=>n(d,u),["prevent"])},a0(u),9,ix)]))),128)),j("footer",lx,[j("button",{class:"button",onClick:n},sx),j("button",{class:g0(["button delete",{disabled:x(d)}]),onClick:u=>S(d)},xx,10,nx)])],2))),128))]),j("footer",rx,[j("button",{class:g0(["button"]),onClick:w[1]||(w[1]=F=>k())},dx),j("button",{id:"show-results",class:"button accent",onVnodeUpdated:w[2]||(w[2]=F=>K(Vk)("click",F.el)),onClick:n},[j("span",null,"Poka\u017C wyniki ("+a0(K(i).length)+")",1)],512)])]))}},mx=R0(wx,[["__scopeId","data-v-42edc1fb"]]);const jx=a=>(Z0("data-v-3017b9e1"),a=a(),J0(),a),px=["id","onClick"],ux=["innerHTML"],fx={key:0},Wx={key:0,class:"bi bi-sort-down-alt"},gx={key:1,class:"bi bi-sort-down"},hx={key:1},Bx=jx(()=>j("i",{class:"bi bi-arrow-down-short"},null,-1)),yx=[Bx],Cx={__name:"Browser__Sorting",setup(a){const o=f0("filteredData_global"),i=f0("sortedData_global"),l=s0(["code",1]),e="od ma\u0142ych ilo\u015Bci",t="od du\u017Cych ilo\u015Bci",s=go({code:[1,"Kod","od pocz\u0105tku","od ko\u0144ca"],tCub:[0,"Ca\u0142k. m<sup>3</sup>",e,t],tSqr:[0,"Ca\u0142k. m<sup>2</sup>",e,t],tPcs:[0,"Ca\u0142k. szt",e,t],pCub:[0,"PLN/m<sup>3</sup>","od tanich","od drogich"],pSqr:[0,"PLN/m<sup>2</sup>","od tanich","od drogich"],pPcs:[0,"PLN/szt","od tanich","od drogich"],aCub:[0,"Hand. m<sup>3</sup>",e,t],aSqr:[0,"Hand. m<sup>2</sup>",e,t],aPcs:[0,"Hand. szt",e,t]});x1([l,o],()=>{const[S,k]=l.value;let r=K(o);!r||(r=r.sort((x,c)=>{const w=x.size,F=c.size,d=S.slice(0,1);let u=S.slice(-3);return u.match(/Sqr|Pcs/)?(u==="Sqr"&&(u="m2"),u==="Pcs"&&(u="szt"),d==="p"&&(x=ha(w,x[`${d}Cub`],"m3",u),c=ha(F,c[`${d}Cub`],"m3",u)),(d==="t"||d==="a")&&(x=M0(w,x[`${d}Cub`],"m3",u),c=M0(F,c[`${d}Cub`],"m3",u))):(x=x[S],c=c[S]),(x===c?0:x>c?1:-1)*k}),i.value=r)});function n(S){const[k]=l.value;S!==k&&(s[k][0]=0),s[S][0]=s[S][0]==0?1:s[S][0]*=-1,l.value=[S,s[S][0]]}return(S,k)=>(Q(!0),Y(w0,null,$a(s,([r,x,c,w],F)=>(Q(),Y("button",{key:F,id:F,class:g0(["button small",{active:r!=0}]),style:fo(`grid-area: ${F}`),onClick:d=>n(F)},[j("span",{innerHTML:`${x}`},null,8,ux),r!=0?(Q(),Y("span",fx,[r>0?(Q(),Y("i",Wx)):(Q(),Y("i",gx))])):(Q(),Y("span",hx,yx))],14,px))),128))}},Ex=R0(Cx,[["__scopeId","data-v-3017b9e1"]]),Px={for:"vatCub",class:"button small",style:{"grid-area":"vat3"}},zx=j("span",null,[o0("Vat m"),j("sup",null,"3")],-1),bx=["true-value"],Mx={for:"vatSqr",class:"button small",style:{"grid-area":"vat2"}},vx=j("span",null,[o0("Vat m"),j("sup",null,"2")],-1),_x=["true-value"],Gx={for:"vatPcs",class:"button small",style:{"grid-area":"vat1"}},Hx=j("span",null,"Vat szt",-1),Dx=["true-value"],Ox={__name:"Browser__VatSetup",setup(a){const o=f0("vat"),i=f0("vatVal");return(l,e)=>(Q(),Y(w0,null,[j("label",Px,[zx,Sa(j("input",{type:"checkbox",name:"vatCub",id:"vatCub","onUpdate:modelValue":e[0]||(e[0]=t=>K(o).m3=t),"true-value":K(i),"false-value":1},null,8,bx),[[Ti,K(o).m3]])]),j("label",Mx,[vx,Sa(j("input",{type:"checkbox",name:"vatSqr",id:"vatSqr","onUpdate:modelValue":e[1]||(e[1]=t=>K(o).m2=t),"true-value":K(i),"false-value":1},null,8,_x),[[Ti,K(o).m2]])]),j("label",Gx,[Hx,Sa(j("input",{type:"checkbox",name:"vatPcs",id:"vatPcs","onUpdate:modelValue":e[2]||(e[2]=t=>K(o).szt=t),"true-value":K(i),"false-value":1},null,8,Dx),[[Ti,K(o).szt]])])],64))}};const Rx=["innerHTML"],Tx=["value"],Lx={__name:"Browser__Inventory_Field",props:["unit","code"],setup(a){const o=a,i=f0("unfilteredData_global"),l=s0(!1),e=i.value.findIndex(k=>k.code===o.code),t=s0(i.value[e][o.unit]||""),s=H0(()=>{let k=2;return o.unit==="iCub"&&(k=3),o.unit==="iSqr"&&(k=2),o.unit==="iPcs"&&(k=1),k}),n=H0(()=>{let k="";return o.unit==="iCub"&&(k="m<sup>3</sup>"),o.unit==="iSqr"&&(k="m<sup>2</sup>"),o.unit==="iPcs"&&(k="szt"),k});async function S(k){const r=k.target.value;await B0.products.update(o.code,{[o.unit]:r}),Object.assign(i.value[e],{[o.unit]:r})}return(k,r)=>(Q(),Y("div",{class:g0({expanded:l.value})},[l.value?(Q(),Y("input",{key:1,class:"inventory__edit",value:t.value,onInput:r[1]||(r[1]=x=>[t.value=x.target.value,S(x)]),onBlur:r[2]||(r[2]=x=>l.value=!1),onKeydown:r[3]||(r[3]=r2(x=>x.target.blur(),["esc"])),onVnodeMounted:r[4]||(r[4]=({el:x})=>x.focus())},null,40,Tx)):(Q(),Y("span",{key:0,class:"inventory__result",contenteditable:"true",onFocus:r[0]||(r[0]=x=>[l.value=!0])},[o0(a0(K(d1)(t.value).toFixed(K(s)))+" ",1),j("small",{innerHTML:K(n)},null,8,Rx)],32))],2))}},Ui=R0(Lx,[["__scopeId","data-v-4209783e"]]);const $1=a=>(Z0("data-v-fe00630d"),a=a(),J0(),a),Ax={class:"product__tCub"},Ix=$1(()=>j("small",null,[o0("m"),j("sup",null,"3")],-1)),Qx={class:"product__tSqr"},Kx=$1(()=>j("small",null,[o0("m"),j("sup",null,"2")],-1)),$x={class:"product__tPcs"},Nx=$1(()=>j("small",null,"szt",-1)),Ux={class:"product__sCub"},Vx=$1(()=>j("small",null,[o0("m"),j("sup",null,"3")],-1)),qx={class:"product__sSqr"},Xx=$1(()=>j("small",null,[o0("m"),j("sup",null,"2")],-1)),Yx={class:"product__sPcs"},Zx=$1(()=>j("small",null,"szt",-1)),Jx={__name:"Browser__Inventory",props:["total","size","code"],setup(a){const o=a,i=-1*o.total,l=-1*M0(o.size,o.total,"m3","m2"),e=-1*M0(o.size,o.total,"m3","szt"),t=f0("unfilteredData_global"),s=t.value.findIndex(c=>c.code===o.code),n=H0(()=>{let c=t.value[s].iCub||"",w=t.value[s].iSqr||"",F=t.value[s].iPcs||"",d=0;return c=d1(c),w=d1(w),F=d1(F),c=M0(o.size,c,"m3","m3"),w=M0(o.size,w,"m2","m3"),F=M0(o.size,F,"szt","m3"),d=c+w+F,d}),S=H0(()=>n.value-o.total),k=H0(()=>{const c=M0(o.size,o.total,"m3","m2");return M0(o.size,n.value,"m3","m2")-c}),r=H0(()=>{const c=M0(o.size,o.total,"m3","szt");return M0(o.size,n.value,"m3","szt")-c}),x=H0(()=>{let c="";return S.value>0&&(c="+"),c});return(c,w)=>(Q(),Y(w0,null,[j("div",Ax,[o0(a0(i.toFixed(3)),1),Ix]),j("div",Qx,[o0(a0(l.toFixed(2)),1),Kx]),j("div",$x,[o0(a0(e.toFixed(1)),1),Nx]),k0(Ui,{class:"product__iCub",code:o.code,unit:"iCub"},null,8,["code"]),k0(Ui,{class:"product__iSqr",code:o.code,unit:"iSqr"},null,8,["code"]),k0(Ui,{class:"product__iPcs",code:o.code,unit:"iPcs"},null,8,["code"]),j("div",Ux,[o0(a0(K(x))+a0(K(S).toFixed(3)),1),Vx]),j("div",qx,[o0(a0(K(x))+a0(K(k).toFixed(2)),1),Xx]),j("div",Yx,[o0(a0(K(x))+a0(K(r).toFixed(1)),1),Zx])],64))}},ar=R0(Jx,[["__scopeId","data-v-fe00630d"]]);const r5=a=>(Z0("data-v-89e942b4"),a=a(),J0(),a),or={class:"pagination",style:{"grid-area":"page"}},ir={key:0,class:"page-selector"},lr=r5(()=>j("i",{class:"bi bi-chevron-left"},null,-1)),er=[lr],tr=["value"],sr={class:"page-count"},nr=r5(()=>j("i",{class:"bi bi-chevron-right"},null,-1)),Sr=[nr],kr={__name:"Browser__Pagination",setup(a){const o=f0(["pagedData_global"]),i=f0(["sortedData_global"]),l=f0(["pageSize_global"]),e=f0(["pageCount_global"]),t=f0(["pageNumber_global"]);J2(()=>{let S=i.value;if(!S)return;const k=l.value,r=t.value,x=S.length,c=k<1?1:k,w=Math.ceil(x/c),F=r>w?w:r||1,d=F*c-c,u=F*c;S=S.slice(d,u),l.value=c,e.value=S.length>0?w:1,t.value=S.length>0?F:1,o.value=S});function s(){t.value-=1}function n(){t.value+=1}return(S,k)=>(Q(),Y("section",or,[K(e)>1?(Q(),Y("div",ir,[j("button",{class:"button small",onClick:k[0]||(k[0]=r=>[s(),K(to)("#results")])},er),Sa(j("select",{name:"pagenum",class:"select-pagenum","onUpdate:modelValue":k[1]||(k[1]=r=>z0(t)?t.value=r:null),onInput:k[2]||(k[2]=r=>K(to)("#results"))},[(Q(!0),Y(w0,null,$a(K(e),r=>(Q(),Y("option",{value:r||1},a0(r),9,tr))),256))],544),[[Kn,K(t)]]),j("span",sr,"\xA0z "+a0(K(e)),1),j("button",{class:"button small",onClick:k[3]||(k[3]=r=>[n(),K(to)("#results")])},Sr)])):Ta("",!0)]))}},Ce=R0(kr,[["__scopeId","data-v-89e942b4"]]);const N1=a=>(Z0("data-v-131523a0"),a=a(),J0(),a),xr={class:"product__tCub"},rr=N1(()=>j("small",null,[o0("m"),j("sup",null,"3")],-1)),cr={class:"product__tSqr"},Fr=N1(()=>j("small",null,[o0("m"),j("sup",null,"2")],-1)),dr={class:"product__tPcs"},wr=N1(()=>j("small",null,"szt",-1)),mr={class:"product__aCub"},jr=N1(()=>j("small",null,[o0("m"),j("sup",null,"3")],-1)),pr={class:"product__aSqr"},ur=N1(()=>j("small",null,[o0("m"),j("sup",null,"2")],-1)),fr={class:"product__aPcs"},Wr=N1(()=>j("small",null,"szt",-1)),gr={__name:"Browser__Quantities",props:["total","aviable","size"],setup(a){const o=a,i=o.total,l=M0(o.size,o.total,"m3","m2"),e=M0(o.size,o.total,"m3","szt"),t=o.aviable,s=M0(o.size,o.aviable,"m3","m2"),n=M0(o.size,o.aviable,"m3","szt");return(S,k)=>(Q(),Y(w0,null,[j("div",xr,[o0(a0(K(i).toFixed(3)),1),rr]),j("div",cr,[o0(a0(K(l).toFixed(2)),1),Fr]),j("div",dr,[o0(a0(K(e).toFixed(1)),1),wr]),j("div",mr,[o0(a0(K(t).toFixed(3)),1),jr]),j("div",pr,[o0(a0(K(s).toFixed(2)),1),ur]),j("div",fr,[o0(a0(K(n).toFixed(1)),1),Wr])],64))}},hr=R0(gr,[["__scopeId","data-v-131523a0"]]);const Br=j("h2",null,"Lista produkt\xF3w",-1),yr={id:"search"},Cr={class:"dataMode"},Er={class:"button",for:"dataMode__trade"},Pr=j("span",null,"Handel",-1),zr={class:"button",for:"dataMode__inventory"},br=j("span",null,"Inwenaryzacja",-1),Mr={class:"productList__header"},vr=j("div",{class:"productList__headerBackground"},null,-1),_r={key:0,class:"productList__ul"},Gr={class:"product__code"},Hr=["innerHTML"],Dr={key:0,class:"product__error"},Or={key:1,class:"productList__empty"},Rr={class:"productList__footer"},Tr=j("span",null,"Szukaj...",-1),Lr=j("i",{class:"bi bi-search"},null,-1),Ar=[Tr,Lr],Vi={__name:"Browser__",setup(a){const o=s0([]),i=s0([]),l=s0([]),e=s0([]);N0("unfilteredData_global",o),N0("filteredData_global",i),N0("sortedData_global",l),N0("pagedData_global",e);const t=s0(12),s=s0(1),n=s0(1);N0("pageSize_global",t),N0("pageCount_global",s),N0("pageNumber_global",n);const S=s0("dataset-total");N0("dataSet_global",S);const k=s0("dataMode__inventory"),r=1.23,x=go({m3:1,m2:1,szt:r});N0("vatVal",r),N0("vat",x);function c(w){return w.replace(/(\d+(,\d+)?x\d+x\d+)/gi,"<b>$1</b>")}return(w,F)=>(Q(),Y(w0,null,[Br,j("section",yr,[k0($k),k0(mx)]),j("section",{class:g0(["productList",k.value]),id:"results"},[j("div",Cr,[j("label",Er,[Pr,Sa(j("input",{type:"radio",name:"dataMode",value:"dataMode__trade","onUpdate:modelValue":F[0]||(F[0]=d=>k.value=d),id:"dataMode__trade"},null,512),[[x2,k.value]])]),j("label",zr,[br,Sa(j("input",{type:"radio",name:"dataMode",value:"dataMode__inventory","onUpdate:modelValue":F[1]||(F[1]=d=>k.value=d),checked:"true",id:"dataMode__inventory"},null,512),[[x2,k.value]])])]),j("header",Mr,[vr,k0(Ce),k0(Ex),k0(Ox)]),e.value&&e.value.length?(Q(),Y("ul",_r,[(Q(!0),Y(w0,null,$a(e.value,d=>(Q(),Y("li",{class:"productList__product",key:d.code},[j("div",Gr,[j("b",null,a0(d.code),1),o0(" - "+a0(d.group),1)]),j("div",{class:"product__name",innerHTML:c(d.name)},null,8,Hr),d.errors?(Q(),Y("div",Dr,[(Q(!0),Y(w0,null,$a(d.errors,u=>(Q(),Y("span",null,a0(u),1))),256))])):Ta("",!0),k.value=="dataMode__inventory"?(Q(),Ea(ar,{key:1,code:d.code,size:d.size,total:d.tCub},null,8,["code","size","total"])):Ta("",!0),k.value=="dataMode__trade"?(Q(),Ea(hr,{key:2,size:d.size,total:d.tCub,aviable:d.aCub},null,8,["size","total","aviable"])):Ta("",!0),k.value=="dataMode__trade"?(Q(),Ea(Lk,{key:3,plySize:d.size,buyPrice:d.pCub},null,8,["plySize","buyPrice"])):Ta("",!0)]))),128))])):(Q(),Y("p",Or,"Nie znaleziono produkt\xF3w.")),j("footer",Rr,[k0(Ce)]),j("button",{class:"scrollTo__search button accent",onClick:F[2]||(F[2]=d=>K(to)("#search"))},Ar)],2)],64))}};const U1=a=>(Z0("data-v-cd9c13b3"),a=a(),J0(),a),Ir={class:"dialog"},Qr={class:"center"},Kr=Ct('<h3 data-v-cd9c13b3>Wykryto dane inwentaryzacyjne</h3><p data-v-cd9c13b3> W danych, kt\xF3re importujesz istnieje spis z natury (inwentaryzacja).<br data-v-cd9c13b3> Wybierz, kt\xF3re dane zapisa\u0107 na urz\u0105dzeniu: </p><p data-v-cd9c13b3><b data-v-cd9c13b3>Lokalne</b> - pozostaw dane lokalne <i class="bi bi-database" data-v-cd9c13b3></i>, ignoruj dane z chmury <i class="bi bi-cloud-slash-fill" data-v-cd9c13b3></i></p><p data-v-cd9c13b3><b data-v-cd9c13b3>Chmura</b> - usu\u0144 dane lokalne <i class="bi bi-database-fill-slash" data-v-cd9c13b3></i>, zast\u0105p danymi z chmury <i class="bi bi-cloud" data-v-cd9c13b3></i></p><p data-v-cd9c13b3><b data-v-cd9c13b3>Sumuj</b> - sumuj dane lokalne <i class="bi bi-database" data-v-cd9c13b3></i> i dane z chmury <i class="bi bi-cloud" data-v-cd9c13b3></i></p>',5),$r=U1(()=>j("span",null,"Lokalne",-1)),Nr=U1(()=>j("span",null,[j("i",{class:"bi bi-database"})],-1)),Ur=[$r,Nr],Vr=U1(()=>j("span",null,"Chmura",-1)),qr=U1(()=>j("span",null,[j("i",{class:"bi bi-cloud"})],-1)),Xr=[Vr,qr],Yr=U1(()=>j("span",null,"Sumuj",-1)),Zr=U1(()=>j("span",null,[j("i",{class:"bi bi-database"}),o0(" + "),j("i",{class:"bi bi-cloud"})],-1)),Jr=[Yr,Zr],ac={__name:"Dialog_MergeFetchedData",setup(a){return(o,i)=>(Q(),Y("dialog",Ir,[j("div",Qr,[Kr,j("button",{onClick:i[0]||(i[0]=l=>K(No)("local")),class:"btn"},Ur),j("button",{onClick:i[1]||(i[1]=l=>K(No)("cloud")),class:"btn"},Xr),j("button",{onClick:i[2]||(i[2]=l=>K(No)("merge")),class:"btn"},Jr)])]))}},oc=R0(ac,[["__scopeId","data-v-cd9c13b3"]]);function c5(a){let o,i;a?(o=!1,i="Nie rozpoznano danych. \u274C"):(o=null,i="");const l=/Stany i rezerwacje towarów/i.test(a),e=/Kod towaru		nazwa towaru		jm		stan handlowy	rezerwacje R	rezerwacje A		stan  całkowity	/i.test(a);l&&e&&(o="stocks",i="\u{1F4E6} Rozpoznano stany i rezerwacje towar\xF3w.");const t=/Stany magazynowe towarów/i.test(a),s=/Kod towaru		nazwa towaru		jm		stan	cena	wartość		/i.test(a);return t&&s&&(o="prices",i="\u{1F4B5} Rozpoznano ceny zakupowe towar\xF3w."),/Kod	Nazwa/i.test(a),/\d+s\d+\/\d+/i.test(a),/^\d{4}$/i.test(a)&&(o="code",i="\u{1F522} Rozpoznano kod wymiany danych."),/^\d{1,3}$/i.test(a)&&(o=null,i=""),{data:o,message:i}}async function F5(a,o){const i={action:"request",pin:o},l={method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},body:new URLSearchParams(i).toString()};try{return await(await fetch(a,l)).json()}catch(e){return console.error(e),{message:"Problem z po\u0142\u0105czeniem \u274C"}}}function d5(a,o){return a=ic(a),a=lc(a,o),{data:a}}function ic(a){const o=a.match(/[^\r\n]+/g);let i=[];for(let l of o){const e=l.match(/[^\t]+/g);i.push(e)}return i}function lc(a,o){const i=/(kod|podsumowanie|dostawa|transport|usługa|zamówienie)/gi;let l=[];for(let e of a)!e.length||e.find(t=>t.match(i))||o==="prices"&&e.length!==6||o==="stocks"&&e.length!==7||o==="products"&&e.length!==2||l.push(e);return l}function w5(a,o){var l,e,t;let i=[];for(const s of a){let n={},S=[];const k=(s==null?void 0:s.code)||s[0],r=(s==null?void 0:s.name)||s[1],x=(s==null?void 0:s.size)||ec(r),c=s[2]||"m3",w=(s==null?void 0:s.tCub)||((l=s[6])==null?void 0:l.replace(",","."))*1,F=(s==null?void 0:s.aCub)||((e=s[3])==null?void 0:e.replace(",","."))*1,d=(s==null?void 0:s.pCub)||((t=s[4])==null?void 0:t.replace(",","."))*1,u=(s==null?void 0:s.iCub)||"",B=(s==null?void 0:s.iSqr)||"",W=(s==null?void 0:s.iPcs)||"";x===null&&S.push("B\u0142\u0105d: Brak prawid\u0142owego wymiaru w opisie. Obliczenia niemo\u017Cliwe.");const f=S.length?"error":"",h=tc(`${k} ${r} ${f}`);Object.assign(n,{code:k,name:r,size:x,group:h,iCub:u,iSqr:B,iPcs:W}),f&&Object.assign(n,{errors:S}),o.match(/stocks|code/i)&&Object.assign(n,{tCub:M0(x,w,c,"m3"),aCub:M0(x,F,c,"m3")}),o.match(/prices|code/i)&&Object.assign(n,{pCub:ha(x,d,c,"m3")}),i.push(n)}return i}function ec(a){const o=a.match(/\d+[,\.]?\d*x\d+x\d+/i);return o?o[0].replace(",","."):null}function tc(a){let o=[];return/error/i.test(a)&&o.push("ERROR"),/ppl/i.test(a)&&o.push("PPL"),/hpl/i.test(a)&&o.push("HPL"),/osb/i.test(a)&&o.push("OSB"),/topol/i.test(a)&&o.push("China"),/honey/i.test(a)&&o.push("Honey"),/PF|poli/i.test(a)&&o.push("Poliform"),/RP|radiata/i.test(a)&&o.push("RP"),/EUK|eukaliptus/i.test(a)&&o.push("EUK"),/wodo|wd|ext|\bE\b/i.test(a)&&o.push("WD"),/such|mr|int/i.test(a)&&o.push("MR"),/mel|\bM\/M\b/i.test(a)&&o.push("MM"),/heksa|F\/WH/i.test(a)&&o.push("Heksa"),/less|transpa/i.test(a)&&o.push("C.less"),/folio|\bF\/F\b/i.test(a)&&o.push("FF"),/anty|\bF\/W\b|\bW\/W\b/i.test(a)&&o.push("FW"),o.length||o.push("??"),o.sort(),o.reduce((l,e)=>`${l} ${e}`,"").trim()}async function m5(a,o){let i="Co\u015B posz\u0142o nie tak \u2757",l=!1,e=await B0.products.toArray();Sc(a)&&(l=await Jn(oc),l==="local"&&(a=await Ee(a)),l==="cloud"&&(e=await Ee(e))),o.match(/stocks|code/i)&&sc(e),o.match(/prices|code/i)&&nc(e);for(const s of a){const n=e.findIndex(w=>w.code===s.code),S=n<0,k=S?void 0:e[n],r=S?s:k;S===!1&&l==="merge"&&(s.iCub=`${k.iCub}+(${s.iCub})`,s.iSqr=`${k.iSqr}+(${s.iSqr})`,s.iPcs=`${k.iPcs}+(${s.iPcs})`),S===!1&&Object.assign(r,s);const x=S?e.length:n,c=S?0:1;e.splice(x,c,r)}try{await B0.products.clear(),await B0.products.bulkAdd(e),o==="products"&&(i="\u{1F4DC} Zaktualizowano produkty \u2714"),o==="stocks"&&(i="\u{1F4E6} Zaktualizowano ilo\u015Bci \u2714"),o==="prices"&&(i="\u{1F4B5} Zaktualizowano ceny \u2714"),o==="code"&&(i="\u{1F4DC} Pobrano dane z chmury \u2714")}catch(s){console.error(s)}return i}function sc(a){for(const o of a)o.tCub=0,o.aCub=0}function nc(a){for(const o of a)o.pCub=0}async function Ee(a){return new Promise((o,i)=>{for(const l of a)delete l.iCub,delete l.iSqr,delete l.iPcs;o(a)})}function Sc(a){if(!a)return;let o=!1;for(const i of a)if(!!(i!=null&&i.iCub)||!!(i!=null&&i.iSqr)||!!(i!=null&&i.iPcs)){o=!0;break}return o}const kc=`Stany i rezerwacje towar\xF3w: magazyn WA	
...
PODSUMOWANIE						99944,6402	0	127050,4505		226995,0907	`,xc=`Stany magazynowe towar\xF3w: na dzie\u0144 2021-05-27	
...
PODSUMOWANIE						226995,0907	32,19	7307449,82		`,rc=`Kod	Nazwa
...
`;const cc=a=>(Z0("data-v-59345ed7"),a=a(),J0(),a),Fc={class:"dev"},dc=cc(()=>j("h3",null,"Dev things",-1)),wc={class:"grid"},mc={__name:"DataCollector_ExampleData",setup(a){async function o(l){if((await navigator.permissions.query({name:"clipboard-read"})).state=="denied"){alert("Uprawnienia do schowka dla tej witryny zosta\u0142y wy\u0142\u0105czone. Ask Google for help.");return}let t="No data submitted";l==="raw_stocks"&&(t=kc),l==="raw_prices"&&(t=xc),l==="raw_products"&&(t=rc),navigator.clipboard.writeText(t).catch(s=>console.error(s))}async function i(){await B0.products.clear().then(l=>console.log(`Table 'products' dropped. Response: ${l}`)).catch(l=>console.log(l)),await B0.timestamps.clear().then(l=>console.log(`Table 'timestamps' dropped. Response: ${l}`)).catch(l=>console.log(l))}return(l,e)=>(Q(),Y("section",Fc,[dc,j("div",wc,[j("button",{class:"button",onClick:e[0]||(e[0]=t=>o("raw_stocks"))}," Do schowka: \u{1F4E6} Ilo\u015Bci "),j("button",{class:"button",onClick:e[1]||(e[1]=t=>o("raw_prices"))},"Do schowka: \u{1F4B5} Ceny"),j("button",{class:"button",onClick:e[2]||(e[2]=t=>i())},"Clear database")])]))}},jc=R0(mc,[["__scopeId","data-v-59345ed7"]]);const pa=a=>(Z0("data-v-efcb4b0a"),a=a(),J0(),a),pc={class:"data-collector",id:"data-collector"},uc=pa(()=>j("h2",null,"Wczytaj dane",-1)),fc={class:"buttons"},Wc=pa(()=>j("span",null,"Wyczy\u015B\u0107",-1)),gc=pa(()=>j("i",{class:"bi bi-backspace"},null,-1)),hc=[Wc,gc],Bc=pa(()=>j("span",null,"Wklej schowek",-1)),yc=pa(()=>j("i",{class:"bi bi-save"},null,-1)),Cc=[Bc,yc],Ec=pa(()=>j("span",null,"Zatwierd\u017A",-1)),Pc=pa(()=>j("i",{class:"bi bi-check2"},null,-1)),zc=[Ec,Pc],bc={class:"data-collector__manual"},Mc=pa(()=>j("h3",null,"Instrukcja wprowadzania danych magazynowych z Symfonii",-1)),vc=Ct('<li data-v-efcb4b0a> Wyszukaj kolejno: <b data-v-efcb4b0a>Kartoteki</b> &gt; <b data-v-efcb4b0a>Towary</b> &gt; <b data-v-efcb4b0a>Zestawienia</b><ul data-v-efcb4b0a><li data-v-efcb4b0a>Dla wczytania cen \u{1F4B5} towar\xF3w wybierz <b data-v-efcb4b0a>Stany magazynowe towar\xF3w...</b></li><li data-v-efcb4b0a> Dla wczytania stan\xF3w \u{1F4E6} towar\xF3w wybierz <b data-v-efcb4b0a>Stany i rezerwacje towar\xF3w...</b></li></ul></li><li data-v-efcb4b0a> Nale\u017Cy wybra\u0107 poni\u017Csze ustawienia: <ul data-v-efcb4b0a><li data-v-efcb4b0a><b data-v-efcb4b0a>Zestawienie dla magazynu: </b><i data-v-efcb4b0a>dowolny magazyn</i><br data-v-efcb4b0a> Uwaga. Je\u015Bli wybierzesz <i data-v-efcb4b0a>wszystkie</i> b\u0119dziesz widzia\u0142 stany wszystkich magazyn\xF3w, do kt\xF3rych masz uprawnienia. </li><li data-v-efcb4b0a><b data-v-efcb4b0a>Podsumowanie co: </b> <i data-v-efcb4b0a>brak</i></li><li data-v-efcb4b0a><b data-v-efcb4b0a>Zestawienie dla jednostki: </b><i data-v-efcb4b0a><u data-v-efcb4b0a>ewidencyjna</u>, dodatkowa1, dodatkowa2 lub domy\u015Blna</i></li><li data-v-efcb4b0a><b data-v-efcb4b0a>Prezentuj stany zerowe: </b><i data-v-efcb4b0a>zaznaczone \u{1F5F9}</i></li><li data-v-efcb4b0a>Niewymienione wy\u017Cej opcje: <i data-v-efcb4b0a>najbezpieczniej odznaczy\u0107 \u2610</i></li></ul></li><li data-v-efcb4b0a>Kliknij <b data-v-efcb4b0a>schowek</b></li><li data-v-efcb4b0a> Wklej dane ze schowka w <a href="#datainsert" data-v-efcb4b0a>pole tekstowe</a> na g\xF3rze strony </li><li data-v-efcb4b0a>Je\u015Bli wprowadzone dane s\u0105 poprawne pojawi si\u0119 przycisk <b data-v-efcb4b0a>Zatwierd\u017A</b></li>',5),_c=o0(" Przejd\u017A na stron\u0119 "),Gc=o0(", aby m\xF3c przegl\u0105da\u0107 stany magazynowe "),Hc=pa(()=>j("h3",null,"Instrukcja wymiany danych za pomoc\u0105 chmury",-1)),Dc=pa(()=>j("ul",null,[j("li",null,[o0("Wpisz 4-cyfrowy kod w "),j("a",{href:"#datainsert"},"pole tekstowe"),o0(".")]),j("li",null,' Wa\u017Cne! Wpolu tekstowym nie wpisuj przypadkowych spacji i innych znak\xF3w. Inaczej kod "nie wejdzie" '),j("li",null,"Kod jest jednorazowy i wa\u017Cny przez 2 minuty od wygenerowania.")],-1)),Oc={__name:"DataCollector_",setup(a){const o=s0(),i=s0(null),l=s0(""),e=f0("GlobalEvents");s0(!1);const t=f0("currentAppTab");function s(){const{message:x,data:c}=c5(o.value);l.value=x,i.value=c}function n(){o.value="",s()}async function S(x){if((await navigator.permissions.query({name:"clipboard-read"})).state=="denied"){alert("Uprawnienia do schowka dla tej witryny zosta\u0142y wy\u0142\u0105czone. Ask Google for help.");return}else{const w=await navigator.clipboard.readText().catch(F=>console.error(F));o.value=w,s()}}async function k(){console.time("importData()");const x=o.value,c=i.value;let w,F;l.value="Loading... \u23F3",c.match(/code/i)&&(w=await F5("https://bossman.hekko24.pl/stock_browser_server/index.php",x)),c.match(/stocks|prices/i)&&(w=d5(x,c));let{data:d,message:u}=w;u==="positive"&&(u="\u{1F4DC} Pobrano dane z chmury \u2714"),u==="negative"&&(u="Podany kod jest nieaktualny. \u274C"),d&&(d=w5(d,c),F=await m5(d,c),r(c)),l.value=u||F,console.timeEnd("importData()")}async function r(x){x.match(/stocks|code/i)&&(await B0.timestamps.put({id:"stocks",timestamp:new Date}),e.value="stocks updated"),x.match(/prices|code/i)&&(await B0.timestamps.put({id:"prices",timestamp:new Date}),e.value="prices updated")}return(x,c)=>(Q(),Y(w0,null,[j("section",pc,[uc,Sa(j("textarea",{id:"datainsert",name:"datainsert",rows:"10",placeholder:"Tutaj wklej dane ze schowka","onUpdate:modelValue":c[0]||(c[0]=w=>o.value=w),onInput:s},`\r
		`,544),[[yi,o.value]]),j("p",{class:g0(["messageBox",{visible:l.value,hidden:!l.value}])},a0(l.value),3),j("p",fc,[j("button",{class:"button",onClick:n},hc),j("button",{class:"button",onClick:S},Cc),i.value?(Q(),Y("button",{key:0,class:"button accent",onClick:k},zc)):Ta("",!0)])]),j("section",bc,[Mc,j("ol",null,[vc,j("li",null,[_c,j("a",{href:"#app",onClick:c[1]||(c[1]=w=>t.value="BrowserTab")},"Lista"),Gc])]),Hc,Dc])],64))}},Rc=R0(Oc,[["__scopeId","data-v-efcb4b0a"]]);const j5=a=>(Z0("data-v-4e874519"),a=a(),J0(),a),Tc={class:"share-tab",id:"share-tab"},Lc={class:"share-tab__wrapper"},Ac=j5(()=>j("h2",{class:"share-tab__header"},"Udost\u0119pnij",-1)),Ic={class:"share-tab__form",action:"javascript:void(0);"},Qc={class:"share-tab__share-code",id:"share-code"},Kc={class:"share-tab__message"},$c=j5(()=>j("section",{class:"share-tab__manual"},[j("h3",null,"Instrukcja udost\u0119pniania danych w chmurze"),j("ul",null,[j("li",null,"Kliknij [Generuj kod], aby wygenerowa\u0107 kod wymiany danych"),j("li",null,"Kod wymiany danych jest jednorazowy i wa\u017Cny przez dwie minuty od wygereowania"),j("li",null,"Podaj\u0105c tajne has\u0142o udost\u0119pnisz dane wra\u017Cliwe takie jak ceny zakupowe towar\xF3w"),j("li",null," Tajne has\u0142o znaj\u0105 nieliczni i tak pozostanie dop\xF3ki nie wymy\u015Bl\u0119 lepszego systemu ")])],-1)),Nc={__name:"DataShare_",setup(a){const o=s0(),i=s0(),l=s0();let e="";async function t(){l.value="Wysy\u0142anie danych...",o.value=Math.random().toString().substring(2,6);const s={action:"provide",pin:o.value,password:i.value,data:JSON.stringify(await B0.products.toArray())},n={method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},body:new URLSearchParams(s).toString()};e=(await(await fetch("https://bossman.hekko24.pl/stock_browser_server/index.php",n).catch(k=>console.error(k))).json()).message,e==="positive"&&(l.value="\u{1F511} Has\u0142o prawid\u0142owe. Udost\u0119pniasz wra\u017Cliwe dane."),e==="negative"&&(l.value="\u{1F512} B\u0142\u0119dne has\u0142o. Udost\u0119pniasz bezpieczne dane.")}return(s,n)=>(Q(),Y(w0,null,[j("section",Tc,[j("div",Lc,[Ac,j("form",Ic,[Sa(j("input",{id:"share-password",type:"password",placeholder:"Sekretne has\u0142o","onUpdate:modelValue":n[0]||(n[0]=S=>i.value=S)},null,512),[[yi,i.value]]),j("button",{class:"button small accent",onClick:t},"Generuj kod")]),j("p",Qc,a0(o.value),1),j("p",Kc,a0(l.value),1)])]),$c],64))}},Uc=R0(Nc,[["__scopeId","data-v-4e874519"]]);const Za=a=>(Z0("data-v-52e764eb"),a=a(),J0(),a),Vc=Za(()=>j("h1",null,"Test Tab",-1)),qc=Za(()=>j("h2",null,"Data collector v2",-1)),Xc={class:"data-collector"},Yc={class:"buttons"},Zc=Za(()=>j("span",null,"Wyczy\u015B\u0107",-1)),Jc=Za(()=>j("i",{class:"bi bi-backspace"},null,-1)),aF=[Zc,Jc],oF=Za(()=>j("span",null,"Schowek",-1)),iF=Za(()=>j("i",{class:"bi bi-save"},null,-1)),lF=[oF,iF],eF=Za(()=>j("span",null,"Zatwierd\u017A",-1)),tF=Za(()=>j("i",{class:"bi bi-check2"},null,-1)),sF=[eF,tF],nF={__name:"Test",setup(a){const o=s0(),i=s0(null),l=s0(""),e=f0("GlobalEvents");s0(!1);function t(){const{message:r,data:x}=c5(o.value);l.value=r,i.value=x}function s(){o.value="",t()}async function n(r){if((await navigator.permissions.query({name:"clipboard-read"})).state=="denied"){alert("Uprawnienia do schowka dla tej witryny zosta\u0142y wy\u0142\u0105czone. Ask Google for help.");return}else{const c=await navigator.clipboard.readText().catch(w=>console.error(w));o.value=c,t()}}async function S(){console.time("importData()");const r=o.value,x=i.value;let c,w;l.value="Loading... \u23F3",x.match(/code/i)&&(c=await F5("https://bossman.hekko24.pl/stock_browser_server/index.php",r)),x.match(/stocks|prices/i)&&(c=d5(r,x));let{data:F,message:d}=c;d==="positive"&&(d="\u{1F4DC} Pobrano dane z chmury \u2714"),d==="negative"&&(d="Podany kod jest nieaktualny. \u274C"),F&&(F=w5(F,x),w=await m5(F,x),k(x)),l.value=d||w,console.timeEnd("importData()")}async function k(r){r.match(/stocks|code/i)&&(await B0.timestamps.put({id:"stocks",timestamp:new Date}),e.value="stocks updated"),r.match(/prices|code/i)&&(await B0.timestamps.put({id:"prices",timestamp:new Date}),e.value="prices updated")}return(r,x)=>(Q(),Y(w0,null,[Vc,qc,j("section",Xc,[Sa(j("textarea",{id:"datainsert",name:"datainsert",rows:"10","onUpdate:modelValue":x[0]||(x[0]=c=>o.value=c),onInput:t},`\r
		`,544),[[yi,o.value]]),j("p",{class:g0(["messageBox",{visible:l.value,hidden:!l.value}])},a0(l.value),3),j("p",Yc,[j("button",{class:"button",onClick:s},aF),j("button",{class:"button",onClick:n},lF),i.value?(Q(),Y("button",{key:0,class:"button accent",onClick:S},sF)):Ta("",!0)])]),k0(jc)],64))}},SF=R0(nF,[["__scopeId","data-v-52e764eb"]]);const p5=a=>(Z0("data-v-c92a0388"),a=a(),J0(),a),kF={class:"lastModified"},xF=p5(()=>j("span",{class:"lastModified__label"},"Ceny:",-1)),rF={class:"lastModified__date"},cF={class:"lastModified__diff"},FF=p5(()=>j("span",{class:"lastModified__label"},"Stany:",-1)),dF={class:"lastModified__date"},wF={class:"lastModified__diff"},mF={__name:"LastModified",setup(a){const o=f0("GlobalEvents");s0();const i=s0({}),l=s0({});x1(o,async()=>{i.value=await e("stocks"),l.value=await e("prices")}),o.value="fake trigger";async function e(s){let n=new Date().toJSON().split("T")[0],S=await B0.timestamps.get(s);S=S==null?void 0:S.timestamp.toJSON().split("T")[0];let k=Math.abs(new Date(n)-new Date(S));return k=k/1e3/60/60/24,{date:S||"brak danych",diff:k}}function t(s){return s<0?"":s===0?"dzi\u015B":s===1?"wczoraj":s>1?`${s} dni`:"??"}return(s,n)=>(Q(),Y("aside",kF,[j("div",{class:g0(["lastModified__type",{red:l.value.diff>1}])},[xF,j("span",rF,a0(l.value.date),1),j("span",cF,a0(t(l.value.diff)),1)],2),j("div",{class:g0(["lastModified__type",{red:i.value.diff>1}])},[FF,j("span",dF,a0(i.value.date),1),j("span",wF,a0(t(i.value.diff)),1)],2)]))}},jF=R0(mF,[["__scopeId","data-v-c92a0388"]]);const pF=a=>(Z0("data-v-3d20782f"),a=a(),J0(),a),uF={class:"tab-switch"},fF=["onClick"],WF=o0("Loading..."),gF=pF(()=>j("footer",null,[j("p",null,"Wszelkie prawa zastrze\u017Cone - Pawe\u0142 Ryszkowski"),j("p",null,[o0(" Uwagi i pomoc techniczna - Pawe\u0142: "),j("a",{href:"mailto:pawrys.kontakt@gmail.com"},"pawrys.kontakt@gmail.com")])],-1)),hF={__name:"App",setup(a){const o=localStorage.StockBrowser_LastUsedPanel||Vi,i=s0(o);N0("currentAppTab",i);const l={BrowserTab:{id:Vi,name:"Lista",icon:"bi bi-list-ul"},DataCollectorTab:{id:Rc,name:"Za\u0142adauj",icon:"bi bi-download"},DataShareTab:{id:Uc,name:"Udost\u0119pnij",icon:"bi bi-cloud-arrow-up"},TestTab:{id:SF,name:"Test",icon:"bi bi-bug-fill"}};return J2(()=>{localStorage.StockBrowser_LastUsedPanel=i.value}),(e,t)=>(Q(),Y(w0,null,[j("nav",uF,[(Q(),Y(w0,null,$a(l,({name:s,icon:n},S)=>j("button",{key:S,class:g0(["button",{active:i.value===S}]),onClick:k=>i.value=S},[j("span",null,a0(s),1),j("i",{class:g0(n)},null,2)],10,fF)),64))]),(Q(),Ea(Rl,null,{default:ao(()=>[k0(jF)]),_:1})),j("main",null,[(Q(),Ea(Rl,null,{fallback:ao(()=>[WF]),default:ao(()=>{var s;return[(Q(),Ea(ct(((s=l[i.value])==null?void 0:s.id)||Vi)))]}),_:1}))]),gF,k0(K(eS))],64))}},BF=R0(hF,[["__scopeId","data-v-3d20782f"]]);const gl=Yn(BF);gl.provide("GlobalEvents",s0());gl.use(aS);gl.mount("#app");
