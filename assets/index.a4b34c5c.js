...
`;const er=a=>(U0("data-v-6c995692"),a=a(),V0(),a),tr={class:"dev"},sr=er(()=>j("h3",null,"Dev things",-1)),nr={class:"grid"},Sr={__name:"DataCollector__ExampleData",setup(a){async function o(l){if((await navigator.permissions.query({name:"clipboard-read"})).state=="denied"){alert("Uprawnienia do schowka dla tej witryny zosta\u0142y wy\u0142\u0105czone. Ask Google for help.");return}let t="No data submitted";l==="raw_stocks"&&(t=or),l==="raw_prices"&&(t=ir),l==="raw_products"&&(t=lr),navigator.clipboard.writeText(t).catch(s=>console.error(s))}async function i(){await h0.products.clear().then(l=>console.log(`Table 'products' dropped. Response: ${l}`)).catch(l=>console.log(l)),await h0.timestamps.clear().then(l=>console.log(`Table 'timestamps' dropped. Response: ${l}`)).catch(l=>console.log(l))}return(l,e)=>(L(),q("section",tr,[sr,j("div",nr,[j("button",{class:"button",onClick:e[0]||(e[0]=t=>o("raw_stocks"))}," Do schowka: \u{1F4E6} Ilo\u015Bci "),j("button",{class:"button",onClick:e[1]||(e[1]=t=>o("raw_prices"))},"Do schowka: \u{1F4B5} Ceny"),j("button",{class:"button",onClick:e[2]||(e[2]=t=>i())},"Clear database")])]))}},kr=R0(Sr,[["__scopeId","data-v-6c995692"]]);const pa=a=>(U0("data-v-2d29ffc6"),a=a(),V0(),a),rr={class:"data-collector",id:"data-collector"},xr=pa(()=>j("h2",null,"Wczytaj dane",-1)),cr={class:"buttons"},Fr=pa(()=>j("span",null,"Wyczy\u015B\u0107",-1)),dr=pa(()=>j("i",{class:"bi bi-backspace"},null,-1)),wr=[Fr,dr],mr=pa(()=>j("span",null,"Wklej schowek",-1)),jr=pa(()=>j("i",{class:"bi bi-save"},null,-1)),pr=[mr,jr],ur=pa(()=>j("span",null,"Zatwierd\u017A",-1)),fr=pa(()=>j("i",{class:"bi bi-check2"},null,-1)),Wr=[ur,fr],gr={class:"data-collector__manual"},hr=pa(()=>j("h3",null,"Instrukcja wprowadzania danych magazynowych z Symfonii",-1)),Br=Ct('<li data-v-2d29ffc6> Wyszukaj kolejno: <b data-v-2d29ffc6>Kartoteki</b> &gt; <b data-v-2d29ffc6>Towary</b> &gt; <b data-v-2d29ffc6>Zestawienia</b><ul data-v-2d29ffc6><li data-v-2d29ffc6>Dla wczytania cen \u{1F4B5} towar\xF3w wybierz <b data-v-2d29ffc6>Stany magazynowe towar\xF3w...</b></li><li data-v-2d29ffc6> Dla wczytania stan\xF3w \u{1F4E6} towar\xF3w wybierz <b data-v-2d29ffc6>Stany i rezerwacje towar\xF3w...</b></li></ul></li><li data-v-2d29ffc6> Nale\u017Cy wybra\u0107 poni\u017Csze ustawienia: <ul data-v-2d29ffc6><li data-v-2d29ffc6><b data-v-2d29ffc6>Zestawienie dla magazynu: </b><i data-v-2d29ffc6>dowolny magazyn</i><br data-v-2d29ffc6> Uwaga. Je\u015Bli wybierzesz <i data-v-2d29ffc6>wszystkie</i> b\u0119dziesz widzia\u0142 stany wszystkich magazyn\xF3w, do kt\xF3rych masz uprawnienia. </li><li data-v-2d29ffc6><b data-v-2d29ffc6>Podsumowanie co: </b> <i data-v-2d29ffc6>brak</i></li><li data-v-2d29ffc6><b data-v-2d29ffc6>Zestawienie dla jednostki: </b><i data-v-2d29ffc6><u data-v-2d29ffc6>ewidencyjna</u>, dodatkowa1, dodatkowa2 lub domy\u015Blna</i></li><li data-v-2d29ffc6><b data-v-2d29ffc6>Prezentuj stany zerowe: </b><i data-v-2d29ffc6>zaznaczone \u{1F5F9}</i></li><li data-v-2d29ffc6>Niewymienione wy\u017Cej opcje: <i data-v-2d29ffc6>najbezpieczniej odznaczy\u0107 \u2610</i></li></ul></li><li data-v-2d29ffc6>Kliknij <b data-v-2d29ffc6>schowek</b></li><li data-v-2d29ffc6> Wklej dane ze schowka w <a href="#datainsert" data-v-2d29ffc6>pole tekstowe</a> na g\xF3rze strony </li><li data-v-2d29ffc6>Je\u015Bli wprowadzone dane s\u0105 poprawne pojawi si\u0119 przycisk <b data-v-2d29ffc6>Zatwierd\u017A</b></li>',5),yr=s0(" Przejd\u017A na stron\u0119 "),Cr=s0(", aby m\xF3c przegl\u0105da\u0107 stany magazynowe "),Er=pa(()=>j("h3",null,"Instrukcja wymiany danych za pomoc\u0105 chmury",-1)),Pr=pa(()=>j("ul",null,[j("li",null,[s0("Wpisz 4-cyfrowy kod w "),j("a",{href:"#datainsert"},"pole tekstowe"),s0(".")]),j("li",null,' Wa\u017Cne! Wpolu tekstowym nie wpisuj przypadkowych spacji i innych znak\xF3w. Inaczej kod "nie wejdzie" '),j("li",null,"Kod jest jednorazowy i wa\u017Cny przez 2 minuty od wygenerowania.")],-1)),zr={__name:"DataCollector__",setup(a){const o=t0(),i=t0(null),l=t0(""),e=u0("GlobalEvents");t0(!1);const t=u0("currentAppTab");function s(){const{message:r,data:c}=c5(o.value);l.value=r,i.value=c}function n(){o.value="",s()}async function S(r){if((await navigator.permissions.query({name:"clipboard-read"})).state=="denied"){alert("Uprawnienia do schowka dla tej witryny zosta\u0142y wy\u0142\u0105czone. Ask Google for help.");return}else{const F=await navigator.clipboard.readText().catch(d=>console.error(d));o.value=F,s()}}async function k(){console.time("importData()");const r=o.value,c=i.value;let F,d;l.value="Loading... \u23F3",c.match(/code/i)&&(F=await F5("https://bossman.hekko24.pl/stock_browser_server/index.php",r)),c.match(/stocks|prices/i)&&(F=d5(r,c));let{data:w,message:p}=F;p==="positive"&&(p="\u{1F4DC} Pobrano dane z chmury \u2714"),p==="negative"&&(p="Podany kod jest nieaktualny. \u274C"),w&&(w=w5(w,c),d=await m5(w,c),x(c)),l.value=p||d,console.timeEnd("importData()")}async function x(r){r.match(/stocks|code/i)&&(await h0.timestamps.put({id:"stocks",timestamp:new Date}),e.value="stocks updated"),r.match(/prices|code/i)&&(await h0.timestamps.put({id:"prices",timestamp:new Date}),e.value="prices updated")}return(r,c)=>(L(),q(c0,null,[j("section",rr,[xr,Ma(j("textarea",{id:"datainsert",name:"datainsert",rows:"10",placeholder:"Tutaj wklej dane ze schowka","onUpdate:modelValue":c[0]||(c[0]=F=>o.value=F),onInput:s},`\r
		`,544),[[Ci,o.value]]),j("p",{class:p0(["messageBox",{visible:l.value,hidden:!l.value}])},a0(l.value),3),j("p",cr,[j("button",{class:"button",onClick:n},wr),j("button",{class:"button",onClick:S},pr),i.value?(L(),q("button",{key:0,class:"button accent",onClick:k},Wr)):Ca("",!0)])]),j("section",gr,[hr,j("ol",null,[Br,j("li",null,[yr,j("a",{href:"#app",onClick:c[1]||(c[1]=F=>t.value="BrowserTab")},"Lista"),Cr])]),Er,Pr])],64))}},br=R0(zr,[["__scopeId","data-v-2d29ffc6"]]);const Mr=["innerHTML"],_r=["value"],vr={__name:"Browser__Price_Field",props:["size","unit"],setup(a){const o=a,i=u0("priceRoot"),l=u0("buyPrice"),e=t0(!1),t=t0(),s=u0("vat");function n(F){const d=F.target.value.trim()*1;t.value=F.target.value.trim(),o.unit==="pCub"&&(i.value=ha(o.size,d,"m3","m3")/s.m3),o.unit==="pSqr"&&(i.value=ha(o.size,d,"m2","m3")/s.m2),o.unit==="pPcs"&&(i.value=ha(o.size,d,"szt","m3")/s.szt),o.unit==="marg"&&(i.value=l+d),o.unit==="perc"&&(i.value=l+l/100*d)}const S=_0(()=>{const F=i.value;let d=0;return o.unit==="pCub"&&(d=ha(o.size,F,"m3","m3")*s.m3),o.unit==="pSqr"&&(d=ha(o.size,F,"m3","m2")*s.m2),o.unit==="pPcs"&&(d=ha(o.size,F,"m3","szt")*s.szt),o.unit==="marg"&&(d=F-l),o.unit==="perc"&&(d=(F-l)/l*100),(isNaN(d)||!isFinite(d))&&(d=0),d}),k=_0(()=>{const F=i.value-l;return o.unit==="marg"&&F>=0?"+":""}),x=_0(()=>{let F=2;return o.unit==="pCub"&&(F=2),o.unit==="pSqr"&&(F=2),o.unit==="pPcs"&&(F=2),o.unit==="marg"&&(F=2),o.unit==="perc"&&(F=1),F}),r=_0(()=>{let F="";return o.unit==="pCub"&&(F="z\u0142/m<sup>3</sup>"),o.unit==="pSqr"&&(F="z\u0142/m<sup>2</sup>"),o.unit==="pPcs"&&(F="z\u0142/szt"),o.unit==="marg"&&(F="z\u0142/m<sup>3</sup>"),o.unit==="perc"&&(F="%"),F}),c=_0(()=>{let F="";return o.unit==="pCub"&&s.m3>1&&(F="vatApplied"),o.unit==="pSqr"&&s.m2>1&&(F="vatApplied"),o.unit==="pPcs"&&s.szt>1&&(F="vatApplied"),F});return(F,d)=>(L(),q("div",{class:p0($(c))},[e.value?(L(),q("input",{key:1,class:"price__edit",type:"number",value:t.value,onInput:d[1]||(d[1]=w=>n(w)),onBlur:d[2]||(d[2]=w=>e.value=!1),onFocus:d[3]||(d[3]=w=>w.target.select()),onKeydown:[d[4]||(d[4]=r2(w=>w.target.select(),["enter"])),d[5]||(d[5]=r2(w=>w.target.blur(),["esc"]))],onVnodeMounted:d[6]||(d[6]=({el:w})=>w.focus())},null,40,_r)):(L(),q("span",{key:0,class:"price__result",contenteditable:"true",onFocus:d[0]||(d[0]=w=>[e.value=!0,t.value=$(S).toFixed($(x))])},[s0(a0($(k))+a0($(S).toFixed($(x))),1),j("small",{innerHTML:$(r)},null,8,Mr)],32))],2))}},X1=R0(vr,[["__scopeId","data-v-3e8a6713"]]);const Gr=a=>(U0("data-v-d9afe0d0"),a=a(),V0(),a),Dr={class:"product__buyp"},Hr=Gr(()=>j("small",null,[s0("z\u0142/m"),j("sup",null,"3")],-1)),Or={__name:"Browser__Prices",props:["plySize","buyPrice"],setup(a){const o=a,i=t0(o.buyPrice);L0("priceRoot",i),L0("buyPrice",o.buyPrice);const l=_0(()=>{const e=i.value-o.buyPrice;return e>1?"green":e<-1?"red":""});return(e,t)=>(L(),q(c0,null,[j("div",Dr,[s0(a0(o.buyPrice.toFixed(2)),1),Hr]),n0(X1,{class:p0(["product__pCub",$(l)]),size:o.plySize,unit:"pCub"},null,8,["class","size"]),n0(X1,{class:p0(["product__pSqr",$(l)]),size:o.plySize,unit:"pSqr"},null,8,["class","size"]),n0(X1,{class:p0(["product__pPcs",$(l)]),size:o.plySize,unit:"pPcs"},null,8,["class","size"]),n0(X1,{class:p0(["product__marg",$(l)]),size:o.plySize,unit:"marg"},null,8,["class","size"]),n0(X1,{class:p0(["product__perc",$(l)]),size:o.plySize,unit:"perc"},null,8,["class","size"])],64))}},Rr=R0(Or,[["__scopeId","data-v-d9afe0d0"]]),Tr={group:"Grupa",thick:"Grubo\u015B\u0107",sizeA:"Wymiar A",sizeB:"Wymiar B",grade:"Klasa",words:"Opis"};function Lr(a){const o="KILO|BB|B|CP|CC|C|WGE|WG|PQF|PQ|PF|F|WH|W|M",i=`\\b(${o}){1}(/(${o})){0,1}(?!\\.)\\b`;return a.toUpperCase().match(new RegExp(i,"gi"))}function Ar(a,o){o.addEventListener(a,()=>{to("#results")},{once:!0})}function Ir(a){return a.split(" ").map(o=>{const i=/^\|+|\|+$/g,l=/\d*x[\d\|]*x\d*/i.test(o),e=/=/.test(o)?"\\b":"";let t="";return o=o.replace("=",""),o=o.replace(i,""),o=o.replace(/(\?)/g,"\\$1"),l&&(o=o.split("x").map(s=>(s=s.replace(i,""),s.length>0?`(${s})`:"(\\d+(,\\d+)?)")).join("x"),o=`(?<!,)${o}(mm)?`),t=`(?=.*${e}(${o})${e})`,t}).join("")}const K1=a=>(U0("data-v-42edc1fb"),a=a(),V0(),a),Qr={class:"filters",style:{"grid-area":"fltr"}},$r={class:"textFilter"},Kr=s0(" Szukaj:"),Nr={id:"tags-selector",class:"tags-selector",action:"javascript:void(0)"},Ur={class:"tags-selector__groupHeader"},Vr=["checked","name","id","value"],qr=["for","onClick"],Xr={class:"tags-selector__groupFooter"},Yr=K1(()=>j("span",null,"Filtruj",-1)),Zr=K1(()=>j("i",{class:"bi bi-funnel"},null,-1)),Jr=[Yr,Zr],ax=["onClick"],ox=K1(()=>j("span",null,"Usu\u0144",-1)),ix=K1(()=>j("i",{class:"bi bi-trash3"},null,-1)),lx=[ox,ix],ex={class:"filters__footer"},tx=K1(()=>j("span",null,"Usu\u0144 wszystkie",-1)),sx=K1(()=>j("i",{class:"bi bi-trash3"},null,-1)),nx=[tx,sx],Sx={__name:"Browser__Filters",setup(a){const o=u0("unfilteredData_global"),i=u0("filteredData_global"),l=t0(""),e=t0({group:[],thick:[],sizeA:[],sizeB:[],grade:[],words:[]}),t=_0(()=>{const c=i.value;let F=new Set,d=new Set,w=new Set,p=new Set,h=new Set,W=new Set;const f=(B,g)=>new Intl.Collator(void 0,{numeric:!0}).compare(B,g);for(const B of c){const g=`${B.code} ${B.name}`,E=g.split(/[ \/]/gi),O=Lr(g);if(B.group&&B.group.split(" ").map(y=>F.add(y)),B.size){const[y,_,H]=B.size.split("x");y&&d.add(y),_&&w.add(_),H&&p.add(H)}O&&O.map(y=>h.add(y));for(const y of E)/\d/.test(y)||y.length<3||W.add(y.toLowerCase().replace(/[\.,]$/gi,""))}return{group:Array.from(F).sort(f),thick:Array.from(d).sort(f),sizeA:Array.from(w).sort(f),sizeB:Array.from(p).sort(f),grade:Array.from(h).sort(f),words:Array.from(W).sort(f)}}),s=_0(()=>{const c=e.value,F=c.thick.length||c.sizeA.length||c.sizeB.length?"x":"";let d=c.group.join("|"),w=c.thick.join("|"),p=c.sizeA.join("|"),h=c.sizeB.join("|"),W="",f=c.grade.join("|"),B=c.words.join("|");return d&&(d=`${d} `),f&&(f=`=${f} `),F.length&&(W=`=${w}${F}${p}${F}${h} `),`${d}${W}${f}${B}`.trim()});r1([l,s,o],()=>{let c=o.value;if(!c)return;let F=`${l.value} ${s.value}`,d=Ir(F);console.log(d),c=c.filter(w=>`${w.code} ${w.group} ${w.name}`.match(new RegExp(d,"i"))),i.value=c});function n(c,F){const d=document.querySelector("#tags-selector"),w=new FormData(d);let p={group:w.getAll("group"),thick:w.getAll("thick"),sizeA:w.getAll("sizeA"),sizeB:w.getAll("sizeB"),grade:w.getAll("grade"),words:w.getAll("words")};c&&F&&p[c].push(F),Object.assign(e.value,p)}function S(c){const F=e.value;F[c]=[],e.value=F}function k(){l.value="",e.value={group:[],thick:[],sizeA:[],sizeB:[],grade:[],words:[]}}function x(c,F){return!(e.value[c].findIndex(p=>p===F)<0)}function r(c){return!e.value[c].length}return(c,F)=>(L(),q("section",Qr,[j("div",$r,[Kr,Ma(j("input",{class:"textFilter__input",type:"search",name:"filter","onUpdate:modelValue":F[0]||(F[0]=d=>l.value=d)},null,512),[[Ci,l.value]])]),j("form",Nr,[(L(!0),q(c0,null,ka($(t),(d,w)=>(L(),q("fieldset",{class:p0(["tags-selector__group",[w]]),key:w},[j("header",Ur,[j("h3",null,a0($(Tr)[w]),1)]),(L(!0),q(c0,null,ka(d,(p,h)=>(L(),q("div",{class:"tags-selector__tag",key:`${w}-${p}`},[j("input",{type:"checkbox",checked:x(w,p),name:w,id:`${w}-${h}`,value:p},null,8,Vr),j("label",{class:"button inline",for:`${w}-${h}`,onClick:Vn(W=>n(w,p),["prevent"])},a0(p),9,qr)]))),128)),j("footer",Xr,[j("button",{class:"button",onClick:n},Jr),j("button",{class:p0(["button delete",{disabled:r(w)}]),onClick:p=>S(w)},lx,10,ax)])],2))),128))]),j("footer",ex,[j("button",{class:p0(["button"]),onClick:F[1]||(F[1]=d=>k())},nx),j("button",{id:"show-results",class:"button accent",onVnodeUpdated:F[2]||(F[2]=d=>$(Ar)("click",d.el)),onClick:n},[j("span",null,"Poka\u017C wyniki ("+a0($(i).length)+")",1)],512)])]))}},kx=R0(Sx,[["__scopeId","data-v-42edc1fb"]]);const rx=["innerHTML"],xx=["value"],cx={__name:"Browser__Inventory_Field",props:["unit","code"],setup(a){const o=a,i=u0("unfilteredData_global"),l=t0(!1),e=i.value.findIndex(k=>k.code===o.code),t=t0(i.value[e][o.unit]||""),s=_0(()=>{let k=2;return o.unit==="iCub"&&(k=3),o.unit==="iSqr"&&(k=2),o.unit==="iPcs"&&(k=1),k}),n=_0(()=>{let k="";return o.unit==="iCub"&&(k="m<sup>3</sup>"),o.unit==="iSqr"&&(k="m<sup>2</sup>"),o.unit==="iPcs"&&(k="szt"),k});async function S(k){const x=k.target.value;await h0.products.update(o.code,{[o.unit]:x}),Object.assign(i.value[e],{[o.unit]:x})}return(k,x)=>(L(),q("div",{class:p0({expanded:l.value})},[l.value?(L(),q("input",{key:1,class:"inventory__edit",value:t.value,onInput:x[1]||(x[1]=r=>[t.value=r.target.value,S(r)]),onBlur:x[2]||(x[2]=r=>l.value=!1),onKeydown:x[3]||(x[3]=r2(r=>r.target.blur(),["esc"])),onVnodeMounted:x[4]||(x[4]=({el:r})=>r.focus())},null,40,xx)):(L(),q("span",{key:0,class:"inventory__result",contenteditable:"true",onFocus:x[0]||(x[0]=r=>[l.value=!0])},[s0(a0($(d1)(t.value).toFixed($(s)))+" ",1),j("small",{innerHTML:$(n)},null,8,rx)],32))],2))}},Ui=R0(cx,[["__scopeId","data-v-4209783e"]]);const N1=a=>(U0("data-v-04b058e2"),a=a(),V0(),a),Fx={class:"product__tCub"},dx=N1(()=>j("small",null,[s0("m"),j("sup",null,"3")],-1)),wx={class:"product__tSqr"},mx=N1(()=>j("small",null,[s0("m"),j("sup",null,"2")],-1)),jx={class:"product__tPcs"},px=N1(()=>j("small",null,"szt",-1)),ux=N1(()=>j("small",null,[s0("m"),j("sup",null,"3")],-1)),fx=N1(()=>j("small",null,[s0("m"),j("sup",null,"2")],-1)),Wx=N1(()=>j("small",null,"szt",-1)),gx={__name:"Browser__Inventory",props:["total","size","code"],setup(a){const o=a,i=-1*o.total,l=-1*M0(o.size,o.total,"m3","m2"),e=-1*M0(o.size,o.total,"m3","szt"),t=u0("unfilteredData_global"),s=t.value.findIndex(F=>F.code===o.code),n=_0(()=>{let F=t.value[s].iCub||"",d=t.value[s].iSqr||"",w=t.value[s].iPcs||"",p=0;return F=d1(F),d=d1(d),w=d1(w),F=M0(o.size,F,"m3","m3"),d=M0(o.size,d,"m2","m3"),w=M0(o.size,w,"szt","m3"),p=F+d+w,p}),S=_0(()=>n.value-o.total),k=_0(()=>{const F=M0(o.size,o.total,"m3","m2");return M0(o.size,n.value,"m3","m2")-F}),x=_0(()=>{const F=M0(o.size,o.total,"m3","szt");return M0(o.size,n.value,"m3","szt")-F}),r=_0(()=>{let F="";return S.value>0&&(F="+"),F}),c=_0(()=>{let F="blue";return x.value>=1&&(F="green"),x.value<=-1&&(F="red"),n.value===0&&(F=""),F});return(F,d)=>(L(),q(c0,null,[j("div",Fx,[s0(a0(i.toFixed(3)),1),dx]),j("div",wx,[s0(a0(l.toFixed(2)),1),mx]),j("div",jx,[s0(a0(e.toFixed(1)),1),px]),n0(Ui,{class:"product__iCub",code:o.code,unit:"iCub"},null,8,["code"]),n0(Ui,{class:"product__iSqr",code:o.code,unit:"iSqr"},null,8,["code"]),n0(Ui,{class:"product__iPcs",code:o.code,unit:"iPcs"},null,8,["code"]),j("div",{class:p0(["product__sCub",$(c)])},[s0(a0($(r))+a0($(S).toFixed(3)),1),ux],2),j("div",{class:p0(["product__sSqr",$(c)])},[s0(a0($(r))+a0($(k).toFixed(2)),1),fx],2),j("div",{class:p0(["product__sPcs",$(c)])},[s0(a0($(r))+a0($(x).toFixed(1)),1),Wx],2)],64))}},hx=R0(gx,[["__scopeId","data-v-04b058e2"]]);const fl=a=>(U0("data-v-cb703cec"),a=a(),V0(),a),Bx={class:"pagination"},yx={key:0,class:"page-selector"},Cx=fl(()=>j("span",null,"Poka\u017C:\xA0",-1)),Ex=["value"],Px=fl(()=>j("i",{class:"bi bi-chevron-left"},null,-1)),zx=[Px],bx=["value"],Mx={class:"page-count"},_x=fl(()=>j("i",{class:"bi bi-chevron-right"},null,-1)),vx=[_x],Gx={__name:"Browser__Pagination",setup(a){const o=u0(["pagedData_global"]),i=u0(["sortedData_global"]),l=u0(["pageSize_global"]),e=u0(["pageCount_global"]),t=u0(["pageNumber_global"]),s=[10,20,50];xo(()=>{let k=i.value;if(!k)return;const x=l.value,r=t.value,c=k.length,F=x<1?1:x,d=Math.ceil(c/F),w=r>d?d:r||1,p=w*F-F,h=w*F;k=k.slice(p,h),l.value=F,e.value=k.length>0?d:1,t.value=k.length>0?w:1,o.value=k});function n(){t.value-=1}function S(){t.value+=1}return(k,x)=>(L(),q("section",Bx,[$(e)>1?(L(),q("div",yx,[Cx,Ma(j("select",{name:"pageSize","onUpdate:modelValue":x[0]||(x[0]=r=>y0(l)?l.value=r:null)},[(L(),q(c0,null,ka(s,r=>j("option",{value:r},a0(r),9,Ex)),64))],512),[[ke,$(l)]]),j("button",{class:"button small",onClick:x[1]||(x[1]=r=>[n(),$(to)("#results")])},zx),Ma(j("select",{name:"pagenum",class:"select-pagenum","onUpdate:modelValue":x[2]||(x[2]=r=>y0(t)?t.value=r:null),onInput:x[3]||(x[3]=r=>$(to)("#results"))},[(L(!0),q(c0,null,ka($(e),r=>(L(),q("option",{value:r||1},a0(r),9,bx))),256))],544),[[ke,$(t)]]),j("span",Mx,"\xA0z "+a0($(e)),1),j("button",{class:"button small",onClick:x[4]||(x[4]=r=>[S(),$(to)("#results")])},vx)])):Ca("",!0)]))}},Ee=R0(Gx,[["__scopeId","data-v-cb703cec"]]);const U1=a=>(U0("data-v-131523a0"),a=a(),V0(),a),Dx={class:"product__tCub"},Hx=U1(()=>j("small",null,[s0("m"),j("sup",null,"3")],-1)),Ox={class:"product__tSqr"},Rx=U1(()=>j("small",null,[s0("m"),j("sup",null,"2")],-1)),Tx={class:"product__tPcs"},Lx=U1(()=>j("small",null,"szt",-1)),Ax={class:"product__aCub"},Ix=U1(()=>j("small",null,[s0("m"),j("sup",null,"3")],-1)),Qx={class:"product__aSqr"},$x=U1(()=>j("small",null,[s0("m"),j("sup",null,"2")],-1)),Kx={class:"product__aPcs"},Nx=U1(()=>j("small",null,"szt",-1)),Ux={__name:"Browser__Quantities",props:["total","aviable","size"],setup(a){const o=a,i=o.total,l=M0(o.size,o.total,"m3","m2"),e=M0(o.size,o.total,"m3","szt"),t=o.aviable,s=M0(o.size,o.aviable,"m3","m2"),n=M0(o.size,o.aviable,"m3","szt");return(S,k)=>(L(),q(c0,null,[j("div",Dx,[s0(a0($(i).toFixed(3)),1),Hx]),j("div",Ox,[s0(a0($(l).toFixed(2)),1),Rx]),j("div",Tx,[s0(a0($(e).toFixed(1)),1),Lx]),j("div",Ax,[s0(a0($(t).toFixed(3)),1),Ix]),j("div",Qx,[s0(a0($(s).toFixed(2)),1),$x]),j("div",Kx,[s0(a0($(n).toFixed(1)),1),Nx])],64))}},Vx=R0(Ux,[["__scopeId","data-v-131523a0"]]);const qx=a=>(U0("data-v-d4d8fc70"),a=a(),V0(),a),Xx={class:"dataSet"},Yx=qx(()=>j("h4",null,"Zestaw danych",-1)),Zx=["for"],Jx=["id","value"],ac={__name:"Browser__DataSet",async setup(a){let o,i;const l=u0("unfilteredData_global"),e=u0("dataSet_global");console.time("count-dataset");const t={"dataset-full":{label:"Stany zerowe",count:([o,i]=Oi(()=>h0.products.count()),o=await o,i(),o)},"dataset-total":{label:"Stany ca\u0142kowite",count:([o,i]=Oi(()=>h0.products.where("tCub").above(0).count()),o=await o,i(),o)},"dataset-aviable":{label:"Stany handlowe",count:([o,i]=Oi(()=>h0.products.where("aCub").above(0).count()),o=await o,i(),o)}};return console.timeEnd("count-dataset"),xo(async()=>{console.time("change-dataset"),e.value==="dataset-full"&&(l.value=await h0.products.toArray()),e.value==="dataset-total"&&(l.value=await h0.products.where("tCub").above(0).toArray()),e.value==="dataset-aviable"&&(l.value=await h0.products.where("aCub").above(0).toArray()),console.timeEnd("change-dataset")}),(s,n)=>(L(),q("section",Xx,[Yx,(L(),q(c0,null,ka(t,({label:S,count:k},x)=>j("label",{class:"button inline",for:x},[j("span",null,a0(S)+":",1),Ma(j("input",{type:"radio",name:"dataset",id:x,value:x,"onUpdate:modelValue":n[0]||(n[0]=r=>y0(e)?e.value=r:null)},null,8,Jx),[[vt,$(e)]]),j("span",null,"("+a0(k)+")",1)],8,Zx)),64))]))}},oc=R0(ac,[["__scopeId","data-v-d4d8fc70"]]);const ic={class:"dataMode"},lc=j("h4",null,"Tryb przegl\u0105dania",-1),ec=["for"],tc=["id","value"],sc={__name:"Browser__DataMode",setup(a){const o=u0("dataMode"),i={dataMode__trade:{label:"Handel"},dataMode__inventory:{label:"Inwenaryzacja"}};return(l,e)=>(L(),q("section",ic,[lc,(L(),q(c0,null,ka(i,({label:t},s)=>j("label",{class:"button inline",key:s,for:s},[j("span",null,a0(t)+": ",1),Ma(j("input",{type:"radio",name:"dataMode",id:s,value:s,"onUpdate:modelValue":e[0]||(e[0]=n=>y0(o)?o.value=n:null)},null,8,tc),[[vt,$(o)]])],8,ec)),64))]))}};const j5=a=>(U0("data-v-016d5607"),a=a(),V0(),a),nc={class:"sorting"},Sc=j5(()=>j("h4",null,"Sortowanie",-1)),kc=["id","onClick"],rc=["innerHTML"],xc={key:1},cc={key:0,class:"bi bi-sort-down-alt"},Fc={key:1,class:"bi bi-sort-down"},dc={key:2},wc=j5(()=>j("i",{class:"bi bi-arrow-down-short"},null,-1)),mc=[wc],jc={__name:"Browser__Sorting",setup(a){const o=u0("filteredData_global"),i=u0("sortedData_global"),l=t0(["code",1]),e=ho({code:[1,"bi bi-hash","Kod towaru"],pCub:[0,"bi bi-cash","Cena zakupu z\u0142/m<sup>3</sup>"],pSqr:[0,"bi bi-cash","Cena zakupu z\u0142/m<sup>2</sup>"],pPcs:[0,"bi bi-cash","Cena zakupu z\u0142/szt"],tCub:[0,"bi bi-cart4","Stan ca\u0142kowity m<sup>3</sup>"],tSqr:[0,"bi bi-cart4","Stan ca\u0142kowity m<sup>2</sup>"],tPcs:[0,"bi bi-cart4","Stan ca\u0142kowity szt"],aCub:[0,"bi bi-cart2","Stan handlowy m<sup>3</sup>"],aSqr:[0,"bi bi-cart2","Stan handlowy m<sup>2</sup>"],aPcs:[0,"bi bi-cart2","Stan handlowy szt"]});r1([l,o],()=>{const[s,n]=l.value;let S=$(o);!S||(S=S.sort((k,x)=>{const r=k.size,c=x.size,F=s.slice(0,1);let d=s.slice(-3);return d.match(/Sqr|Pcs/)?(d==="Sqr"&&(d="m2"),d==="Pcs"&&(d="szt"),F==="p"&&(k=ha(r,k[`${F}Cub`],"m3",d),x=ha(c,x[`${F}Cub`],"m3",d)),(F==="t"||F==="a")&&(k=M0(r,k[`${F}Cub`],"m3",d),x=M0(c,x[`${F}Cub`],"m3",d))):(k=k[s],x=x[s]),(k===x?0:k>x?1:-1)*n}),i.value=S)});function t(s){const[n]=l.value;s!==n&&(e[n][0]=0),e[s][0]=e[s][0]==0?1:e[s][0]*=-1,l.value=[s,e[s][0]]}return(s,n)=>(L(),q("section",nc,[Sc,(L(!0),q(c0,null,ka(e,([S,k,x],r)=>(L(),q("button",{key:r,id:r,class:p0(["button inline",{active:S!=0}]),style:Wo(`grid-area: ${r}`),onClick:c=>t(r)},[k?(L(),q("i",{key:0,class:p0(k)},null,2)):Ca("",!0),j("span",{innerHTML:`${x}`},null,8,rc),S!=0?(L(),q("span",xc,[S>0?(L(),q("i",cc)):(L(),q("i",Fc))])):(L(),q("span",dc,mc))],14,kc))),128))]))}},pc=R0(jc,[["__scopeId","data-v-016d5607"]]),uc={class:"vatSetup"},fc=j("h4",null,"Podatek VAT",-1),Wc=["for"],gc=["innerHTML"],hc=["name","id","onUpdate:modelValue","true-value"],Bc={__name:"Browser__VatSetup",setup(a){const o=u0("vat"),i=u0("vatVal"),l={m3:{label:"VAT m<sup>3</sup>"},m2:{label:"VAT m<sup>2</sup>"},szt:{label:"VAT szt"}};return(e,t)=>(L(),q("section",uc,[fc,(L(),q(c0,null,ka(l,({label:s},n)=>j("label",{class:"button inline",for:`vat${n}`},[j("span",{innerHTML:s},null,8,gc),Ma(j("input",{type:"checkbox",name:`vat${n}`,id:`vat${n}`,"onUpdate:modelValue":S=>$(o)[n]=S,"true-value":$(i),"false-value":1},null,8,hc),[[Kn,$(o)[n]]])],8,Wc)),64))]))}};const yc={class:"browser__settings"},Cc={class:"sticker"},Ec=j("span",null,"Zamknij",-1),Pc=j("i",{class:"bi bi-x-square"},null,-1),zc=[Ec,Pc],bc={__name:"Browser__ListSettings",setup(a){function o(){const i=document.querySelector(".browser__settings"),l=document.querySelector(".browser__settingsOverlay");i.classList.remove("browser__settings--opened"),l.classList.remove("browser__settingsOverlay--opened")}return(i,l)=>(L(),q(c0,null,[j("aside",yc,[j("div",Cc,[n0(oc),n0(sc),n0(Bc),n0(pc),j("footer",null,[j("button",{class:"button accent",id:"browser__settingsCloseBtn",onClick:o},zc)])])]),j("div",{class:"browser__settingsOverlay",onClick:o})],64))}};const Mc=j("h2",null,"Lista produkt\xF3w",-1),_c={id:"search"},vc={key:0,class:"browser__list"},Gc={class:"product__code"},Dc=["innerHTML"],Hc={key:0,class:"product__error"},Oc={key:1,class:"browser__empty"},Rc={class:"browser__stickyFooter"},Tc=j("span",null,"Szukaj...",-1),Lc=j("i",{class:"bi bi-search"},null,-1),Ac=[Tc,Lc],Ic=j("span",null,"Ustawienia",-1),Qc=j("i",{class:"bi bi-gear"},null,-1),$c=[Ic,Qc],Vi={__name:"Browser__",setup(a){const o=t0([]),i=t0([]),l=t0([]),e=t0([]);L0("unfilteredData_global",o),L0("filteredData_global",i),L0("sortedData_global",l),L0("pagedData_global",e);const t=t0(localStorage.StockBrowser_PageSize||20),s=t0(1),n=t0(1);L0("pageSize_global",t),L0("pageCount_global",s),L0("pageNumber_global",n),xo(()=>{localStorage.StockBrowser_PageSize=t.value});const S=t0("dataset-total");L0("dataSet_global",S);const k=t0(localStorage.StockBrowser_DataMode||"dataMode__trade");L0("dataMode",k),xo(()=>{localStorage.StockBrowser_DataMode=k.value});const x=1.23,r=ho({m3:1,m2:1,szt:x});L0("vatVal",x),L0("vat",r);function c(d){return d.replace(/(\d+(,\d+)?x\d+x\d+)/gi,"<b>$1</b>")}function F(){const d=document.querySelector(".browser__settings"),w=document.querySelector(".browser__settingsOverlay");d.classList.add("browser__settings--opened"),w.classList.add("browser__settingsOverlay--opened")}return(d,w)=>(L(),q(c0,null,[Mc,j("section",_c,[n0(kx)]),j("section",{class:p0(["browser",k.value]),id:"results"},[n0(bc,{class:"browser__settings"}),n0(Ee,{class:"browser__pagination-top"}),e.value&&e.value.length?(L(),q("ul",vc,[(L(!0),q(c0,null,ka(e.value,p=>{var h;return L(),q("li",{class:"browser__product",key:p.code},[j("div",Gc,[j("b",null,a0(p.code),1),s0(" - "+a0(p.group),1)]),j("div",{class:"product__name",innerHTML:c(p.name)},null,8,Dc),(h=p.errors)!=null&&h.length?(L(),q("div",Hc,[(L(!0),q(c0,null,ka(p.errors,W=>(L(),q("span",null,a0(W),1))),256))])):Ca("",!0),k.value==="dataMode__inventory"?(L(),Pa(hx,{key:1,code:p.code,size:p.size,total:p.tCub},null,8,["code","size","total"])):Ca("",!0),k.value==="dataMode__trade"?(L(),Pa(Vx,{key:2,size:p.size,total:p.tCub,aviable:p.aCub},null,8,["size","total","aviable"])):Ca("",!0),k.value==="dataMode__trade"?(L(),Pa(Rr,{key:3,plySize:p.size,buyPrice:p.pCub},null,8,["plySize","buyPrice"])):Ca("",!0)])}),128))])):(L(),q("p",Oc,"Nie znaleziono produkt\xF3w.")),n0(Ee,{class:"browser__pagination-bottom"}),j("footer",Rc,[j("button",{class:"button accent",onClick:w[0]||(w[0]=p=>$(to)("#search"))},Ac),j("button",{class:"button",id:"browser__settingsOpenBtn",onClick:F},$c)])],2)],64))}};const p5=a=>(U0("data-v-9586ea32"),a=a(),V0(),a),Kc={class:"share-tab",id:"share-tab"},Nc={class:"share-tab__wrapper"},Uc=p5(()=>j("h2",{class:"share-tab__header"},"Udost\u0119pnij",-1)),Vc={class:"share-tab__form",action:"javascript:void(0);"},qc={class:"share-tab__share-code",id:"share-code"},Xc={class:"share-tab__message"},Yc=p5(()=>j("section",{class:"share-tab__manual"},[j("h3",null,"Instrukcja udost\u0119pniania danych w chmurze"),j("ul",null,[j("li",null,"Kliknij [Generuj kod], aby wygenerowa\u0107 kod wymiany danych"),j("li",null,"Kod wymiany danych jest jednorazowy i wa\u017Cny przez dwie minuty od wygenerowania"),j("li",null,"Podaj\u0105c tajne has\u0142o udost\u0119pnisz dane wra\u017Cliwe takie jak ceny zakupowe towar\xF3w"),j("li",null," Tajne has\u0142o znaj\u0105 nieliczni i tak pozostanie dop\xF3ki nie wymy\u015Bl\u0119 lepszego systemu ")])],-1)),Zc={__name:"DataShare__",setup(a){const o=t0(),i=t0(),l=t0();let e="";async function t(){l.value="Wysy\u0142anie danych...",o.value=Math.random().toString().substring(2,6);const s={action:"provide",pin:o.value,password:i.value,data:JSON.stringify(await h0.products.toArray())},n={method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},body:new URLSearchParams(s).toString()};e=(await(await fetch("https://bossman.hekko24.pl/stock_browser_server/index.php",n).catch(k=>console.error(k))).json()).message,e==="positive"&&(l.value="\u{1F511} Has\u0142o prawid\u0142owe. Udost\u0119pniasz wra\u017Cliwe dane."),e==="negative"&&(l.value="\u{1F512} B\u0142\u0119dne has\u0142o. Udost\u0119pniasz bezpieczne dane.")}return(s,n)=>(L(),q(c0,null,[j("section",Kc,[j("div",Nc,[Uc,j("form",Vc,[Ma(j("input",{id:"share-password",type:"password",placeholder:"Sekretne has\u0142o","onUpdate:modelValue":n[0]||(n[0]=S=>i.value=S)},null,512),[[Ci,i.value]]),j("button",{class:"button small accent",onClick:t},"Generuj kod")]),j("p",qc,a0(o.value),1),j("p",Xc,a0(l.value),1)])]),Yc],64))}},Jc=R0(Zc,[["__scopeId","data-v-9586ea32"]]);const u5=a=>(U0("data-v-c92a0388"),a=a(),V0(),a),aF={class:"lastModified"},oF=u5(()=>j("span",{class:"lastModified__label"},"Ceny:",-1)),iF={class:"lastModified__date"},lF={class:"lastModified__diff"},eF=u5(()=>j("span",{class:"lastModified__label"},"Stany:",-1)),tF={class:"lastModified__date"},sF={class:"lastModified__diff"},nF={__name:"LastModified",setup(a){const o=u0("GlobalEvents");t0();const i=t0({}),l=t0({});r1(o,async()=>{i.value=await e("stocks"),l.value=await e("prices")}),o.value="fake trigger";async function e(s){let n=new Date().toJSON().split("T")[0],S=await h0.timestamps.get(s);S=S==null?void 0:S.timestamp.toJSON().split("T")[0];let k=Math.abs(new Date(n)-new Date(S));return k=k/1e3/60/60/24,{date:S||"brak danych",diff:k}}function t(s){return s<0?"":s===0?"dzi\u015B":s===1?"wczoraj":s>1?`${s} dni`:"??"}return(s,n)=>(L(),q("aside",aF,[j("div",{class:p0(["lastModified__type",{red:l.value.diff>1}])},[oF,j("span",iF,a0(l.value.date),1),j("span",lF,a0(t(l.value.diff)),1)],2),j("div",{class:p0(["lastModified__type",{red:i.value.diff>1}])},[eF,j("span",tF,a0(i.value.date),1),j("span",sF,a0(t(i.value.diff)),1)],2)]))}},SF=R0(nF,[["__scopeId","data-v-c92a0388"]]);const Za=a=>(U0("data-v-2ae8d77b"),a=a(),V0(),a),kF=Za(()=>j("h1",null,"Test Tab",-1)),rF=Za(()=>j("h2",null,"Data collector v2",-1)),xF={class:"data-collector"},cF={class:"buttons"},FF=Za(()=>j("span",null,"Wyczy\u015B\u0107",-1)),dF=Za(()=>j("i",{class:"bi bi-backspace"},null,-1)),wF=[FF,dF],mF=Za(()=>j("span",null,"Schowek",-1)),jF=Za(()=>j("i",{class:"bi bi-save"},null,-1)),pF=[mF,jF],uF=Za(()=>j("span",null,"Zatwierd\u017A",-1)),fF=Za(()=>j("i",{class:"bi bi-check2"},null,-1)),WF=[uF,fF],gF={__name:"Test",setup(a){const o=t0(),i=t0(null),l=t0(""),e=u0("GlobalEvents");t0(!1);function t(){const{message:x,data:r}=c5(o.value);l.value=x,i.value=r}function s(){o.value="",t()}async function n(x){if((await navigator.permissions.query({name:"clipboard-read"})).state=="denied"){alert("Uprawnienia do schowka dla tej witryny zosta\u0142y wy\u0142\u0105czone. Ask Google for help.");return}else{const c=await navigator.clipboard.readText().catch(F=>console.error(F));o.value=c,t()}}async function S(){console.time("importData()");const x=o.value,r=i.value;let c,F;l.value="Loading... \u23F3",r.match(/code/i)&&(c=await F5("https://bossman.hekko24.pl/stock_browser_server/index.php",x)),r.match(/stocks|prices/i)&&(c=d5(x,r));let{data:d,message:w}=c;w==="positive"&&(w="\u{1F4DC} Pobrano dane z chmury \u2714"),w==="negative"&&(w="Podany kod jest nieaktualny. \u274C"),d&&(d=w5(d,r),F=await m5(d,r),k(r)),l.value=w||F,console.timeEnd("importData()")}async function k(x){x.match(/stocks|code/i)&&(await h0.timestamps.put({id:"stocks",timestamp:new Date}),e.value="stocks updated"),x.match(/prices|code/i)&&(await h0.timestamps.put({id:"prices",timestamp:new Date}),e.value="prices updated")}return(x,r)=>(L(),q(c0,null,[kF,rF,j("section",xF,[Ma(j("textarea",{id:"datainsert",name:"datainsert",rows:"10","onUpdate:modelValue":r[0]||(r[0]=c=>o.value=c),onInput:t},`\r
		`,544),[[Ci,o.value]]),j("p",{class:p0(["messageBox",{visible:l.value,hidden:!l.value}])},a0(l.value),3),j("p",cF,[j("button",{class:"button",onClick:s},wF),j("button",{class:"button",onClick:n},pF),i.value?(L(),q("button",{key:0,class:"button accent",onClick:S},WF)):Ca("",!0)])]),n0(kr)],64))}},hF=R0(gF,[["__scopeId","data-v-2ae8d77b"]]);const BF=a=>(U0("data-v-5e9ce1df"),a=a(),V0(),a),yF={class:"tab-switch"},CF=["onClick"],EF=s0("Loading..."),PF=BF(()=>j("footer",null,[j("p",null,"Wszelkie prawa zastrze\u017Cone - Pawe\u0142 Ryszkowski"),j("p",null,[s0(" Uwagi i pomoc techniczna - Pawe\u0142: "),j("a",{href:"mailto:pawrys.kontakt@gmail.com"},"pawrys.kontakt@gmail.com")])],-1)),zF={__name:"App",setup(a){const o=localStorage.StockBrowser_LastUsedPanel||Vi,i=t0(o);L0("currentAppTab",i);const l={BrowserTab:{id:Vi,name:"Lista",icon:"bi bi-list-ul"},DataCollectorTab:{id:br,name:"Za\u0142adauj",icon:"bi bi-download"},DataShareTab:{id:Jc,name:"Udost\u0119pnij",icon:"bi bi-cloud-arrow-up"},TestTab:{id:hF,name:"Test",icon:"bi bi-bug-fill"}};return xo(async()=>{localStorage.StockBrowser_LastUsedPanel=i.value}),(e,t)=>(L(),q(c0,null,[j("nav",yF,[(L(),q(c0,null,ka(l,({name:s,icon:n},S)=>j("button",{key:S,class:p0(["button",{active:i.value===S}]),onClick:k=>i.value=S},[j("span",null,a0(s),1),j("i",{class:p0(n)},null,2)],10,CF)),64))]),(L(),Pa(Ol,null,{default:ao(()=>[n0(SF)]),_:1})),j("main",null,[(L(),Pa(Ol,null,{fallback:ao(()=>[EF]),default:ao(()=>{var s;return[(L(),Pa(ct(((s=l[i.value])==null?void 0:s.id)||Vi)))]}),_:1}))]),PF,n0($(tS))],64))}},bF=R0(zF,[["__scopeId","data-v-5e9ce1df"]]);const Wl=Zn(bF);Wl.provide("GlobalEvents",t0());Wl.use(oS);Wl.mount("#app");
